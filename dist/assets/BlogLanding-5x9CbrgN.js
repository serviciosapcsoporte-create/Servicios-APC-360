import{c as p,r as u,I as d,E as m,V as A}from"./index-CeHLpgGd.js";import{f as C}from"./marked.esm-DIAV4Xkr.js";/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],h=p("arrow-left",f);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const P=[["path",{d:"m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z",key:"1fy3hk"}]],S=p("bookmark",P);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I=[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]],E=p("share-2",I),R=`---
...
readTime: "12 min"
coverImage: "/blog-img/automatizacion-procesos.webp"
...
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)`,D=`---
...
coverImage: "/blog-img/eficiencia-empresarial.webp"
publishDate: "2026-07-24"
author: "Servicios APC"
...
**Servicios APC** — Bogotá, Cra. 52c #39b-22  
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)`,y=`---
...
coverImage: "/blog-img/dashboard-ejecutivo.webp"
publishDate: "2026-07-24"
author: "Servicios APC"
category: "IA & Seguridad"
...
coverImage: "/blog-img/servicios-apc.webp"
...
coverImage: "/blog-img/reels-poster.webp"
publishDate: "2026-07-25"
author: "Servicios APC"
...
coverImage: "/blog-img/equipo-apc.webp"
...
readTime: "10 min"
coverImage: "/blog-img/integracion-sistemas.webp"
...
readTime: "11 min"
coverImage: "/blog-img/hero-og.png"
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`,U={"guia-camaras-hikvision-ia-empresas-bogota-2026":R,"costo-camaras-seguridad-empresas-2026-hardware-vs-ia":D,"que-es-analitica-video-ia-empresas-bogota":y,"5-senales-camaras-no-protegen-empresa-bogota":O,"negocio-camaras-ia-vs-sin-ia-caso-visual-antes-despues":T,"analitica-video-ia-ferreterias-bogota-caso-real-suba":z,"analitica-video-ia-clinicas-bogota-cumplimiento-seguridad":V,"hikvision-colorvu-vs-acusense-vs-deepinview-ia-2026":L,"normativa-videovigilancia-colombia-2026-ley-1581-habeas-data":M,"automatizacion-n8n-cctv-alerta-whatsapp-crm-dashboard":q,"seo-local-google-maps-empresas-seguridad-bogota":N,"servidores-edge-gpu-para-ia-video-analitica-bogota":B,"hikvision-vs-dahua-vs-uniview-comparativa-ia-2026":$,"bot-whatsapp-ia-atencion-clientes-seguridad-bogota":j,"deteccion-ppe-ia-construccion-fabrica-bogota-cumplimiento":x,"cuanto-cuesta-camaras-seguridad-negocio-bogota-2026":G,"mejores-camaras-seguridad-local-comercial-bogota":w,"camaras-seguridad-bodega-bogota-monitoreo-inteligente":H,"instalacion-camaras-seguridad-negocio-pequeno-bogota-guia":k};function F(e){const i=e.replace(/^\uFEFF/,"").replace(/\r\n/g,`
`),r=i.match(/^---\n([\s\S]*?)\n---/);if(!r)return{fm:{},content:i};const n=r[1],a={};n.split(`
`).forEach(c=>{const s=c.indexOf(":");s>0&&(a[c.slice(0,s).trim()]=c.slice(s+1).trim().replace(/^["']|["']$/g,""))});const t=i.slice(r[0].length).trim();return{fm:a,content:t}}function W(){const e=new Date;return Object.entries(U).map(([i,r])=>{const{fm:n,content:a}=F(r),t=n.publishDate||n.date;return t&&new Date(t)>e?null:{slug:i,title:n.title||"Sin título",excerpt:n.excerpt||"",date:n.date||"",publishDate:t,author:n.author||"Servicios APC",category:n.category||"IA & Seguridad",tags:n.tags?n.tags.split(",").map(c=>c.trim()):[],readTime:n.readTime||"5 min",coverImage:n.coverImage,content:C.parse(a),cta:n.cta?JSON.parse(n.cta.replace(/\\"/g,'"')):void 0}}).filter(i=>i!==null).sort((i,r)=>new Date(r.date).getTime()-new Date(i.date).getTime())}const l=e=>{if(!e)return"Reciente";const i=new Date(e);return isNaN(i.getTime())?"Reciente":i.toLocaleDateString("es-ES",{day:"numeric",month:"short",year:"numeric"})};function Y({post:e,allPosts:i,onBack:r,onSelect:n}){return React.createElement("div",{className:"min-h-screen"},React.createElement("div",{className:"max-w-[728px] mx-auto px-5"},React.createElement("button",{onClick:r,className:"flex items-center gap-1.5 text-sm text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)] transition-colors py-8"},React.createElement(h,{size:14}),React.createElement("span",null,"Volver al blog")),React.createElement("article",null,React.createElement("div",{className:"flex items-center gap-3 mb-4"},React.createElement("span",{className:"text-sm font-medium text-[var(--color-accent)]"},e.category),React.createElement("span",{className:"text-[var(--color-border)]"},"·"),React.createElement("time",{className:"text-sm text-[var(--color-muted-foreground)]",dateTime:e.date},l(e.date))),React.createElement("h1",{className:"font-serif text-[2.5rem] md:text-[3rem] leading-[1.15] font-bold text-[var(--color-foreground)] mb-5"},e.title),React.createElement("p",{className:"text-xl text-[var(--color-muted-foreground)] leading-relaxed mb-8"},e.excerpt),React.createElement("div",{className:"flex items-center justify-between py-6 border-t border-b border-[var(--color-border)] mb-10"},React.createElement("div",{className:"flex items-center gap-3"},React.createElement("div",{className:"w-10 h-10 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-sm font-bold text-[var(--color-accent)]"},"SA"),React.createElement("div",null,React.createElement("p",{className:"text-sm font-medium text-[var(--color-foreground)]"},e.author),React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)]"},e.readTime," de lectura · ",l(e.date)))),React.createElement("div",{className:"flex items-center gap-3 text-[var(--color-muted-foreground)]"},React.createElement("button",{className:"hover:text-[var(--color-foreground)] transition-colors"},React.createElement(S,{size:18})),React.createElement("button",{className:"hover:text-[var(--color-foreground)] transition-colors"},React.createElement(E,{size:18})))),e.coverImage&&React.createElement("figure",{className:"mb-10"},React.createElement(d,{src:e.coverImage,alt:e.title,className:"w-full aspect-[16/9] object-cover",decoding:"async"})),React.createElement("div",{className:"blog-content max-w-none",dangerouslySetInnerHTML:{__html:e.content}}),React.createElement("div",{className:"flex flex-wrap gap-2 mt-12 mb-8"},e.tags.map(a=>React.createElement("span",{key:a,className:"px-3 py-1.5 text-xs bg-[var(--color-secondary)] text-[var(--color-muted-foreground)] rounded-full"},a))),e.cta&&React.createElement("div",{className:"my-12 p-8 bg-[var(--color-secondary)] rounded-2xl"},React.createElement("p",{className:"text-xs uppercase tracking-widest text-[var(--color-accent)] font-medium mb-3"},"¿Necesitas esto para tu empresa?"),React.createElement("h3",{className:"font-serif text-2xl font-bold text-[var(--color-foreground)] mb-5"},e.cta.primary.label),React.createElement("div",{className:"flex flex-wrap gap-3"},React.createElement("a",{href:e.cta.primary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-[var(--color-accent)] text-white px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity"},"Solicitar cotización",React.createElement(m,{size:14})),e.cta.secondary&&React.createElement("a",{href:e.cta.secondary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors"},e.cta.secondary.label,React.createElement(m,{size:14})),e.cta.tertiary&&React.createElement("a",{href:e.cta.tertiary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors"},e.cta.tertiary.label,React.createElement(m,{size:14})))),React.createElement("div",{className:"border-t border-[var(--color-border)] pt-10 pb-16"},React.createElement("h3",{className:"text-sm uppercase tracking-widest text-[var(--color-muted-foreground)] mb-6"},"Sigue leyendo"),React.createElement("div",{className:"space-y-8"},i.filter(a=>a.slug!==e.slug).slice(0,3).map(a=>React.createElement("button",{key:a.slug,onClick:()=>n(a.slug),className:"flex gap-6 text-left group w-full"},React.createElement("div",{className:"flex-1 min-w-0"},React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)] mb-1"},a.category),React.createElement("h4",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug mb-1"},a.title),React.createElement("p",{className:"text-sm text-[var(--color-muted-foreground)] line-clamp-2"},a.excerpt),React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)] mt-2"},a.readTime," · ",l(a.date))),a.coverImage&&React.createElement(d,{src:a.coverImage,alt:a.title,className:"w-[120px] h-[80px] object-cover rounded-lg flex-shrink-0"}))))))))}function v(){const e=window.location.hash.slice(1);return e.startsWith("blog/")?e.slice(5):null}function Q({initialSlug:e}){const[i,r]=u.useState(e??v()),n=W(),a=n.find(o=>o.slug===i);u.useEffect(()=>{a&&(document.title=`${a.title} | Servicios APC Bogotá`)},[a]),u.useEffect(()=>{const o=()=>{const g=v();r(g),g&&window.scrollTo({top:0})};return window.addEventListener("hashchange",o),()=>window.removeEventListener("hashchange",o)},[]);const t=o=>{r(o),window.location.hash=`blog/${o}`,window.scrollTo({top:0,behavior:"smooth"})},c=()=>{r(null),window.location.hash="blog",window.scrollTo({top:0,behavior:"smooth"})};if(a)return React.createElement(Y,{post:a,allPosts:n,onBack:c,onSelect:t});const s=n[0],b=n.slice(1);return React.createElement("div",{className:"min-h-screen"},React.createElement("div",{className:"max-w-[1200px] mx-auto px-5 pt-12 pb-16"},React.createElement("p",{className:"text-xs uppercase tracking-[0.2em] text-[var(--color-accent)] font-medium mb-4"},"Blog · Servicios APC"),React.createElement("h2",{className:"font-serif text-4xl md:text-5xl font-bold text-[var(--color-foreground)] leading-tight max-w-3xl"},"Cámaras Hikvision + IA para empresas"),React.createElement("p",{className:"text-lg text-[var(--color-muted-foreground)] mt-4 max-w-2xl leading-relaxed"},"Guías técnicas, comparativas y casos reales sobre CCTV con inteligencia artificial, automatización y seguridad empresarial en Bogotá.")),s&&React.createElement("div",{className:"max-w-[1200px] mx-auto px-5 mb-16"},React.createElement("button",{onClick:()=>t(s.slug),className:"group grid md:grid-cols-[1fr_1fr] gap-8 items-center text-left w-full"},s.coverImage&&React.createElement("div",{className:"overflow-hidden rounded-2xl"},React.createElement(d,{src:s.coverImage,alt:s.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700"})),React.createElement("div",{className:"space-y-4 py-4"},React.createElement("p",{className:"text-xs uppercase tracking-[0.15em] text-[var(--color-accent)] font-medium"},"Destacado"),React.createElement("h3",{className:"font-serif text-3xl md:text-4xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-[1.15]"},s.title),React.createElement("p",{className:"text-[var(--color-muted-foreground)] leading-relaxed text-lg"},s.excerpt),React.createElement("div",{className:"flex items-center gap-3 pt-2"},React.createElement("div",{className:"w-8 h-8 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-xs font-bold text-[var(--color-accent)]"},"SA"),React.createElement("div",null,React.createElement("p",{className:"text-sm font-medium text-[var(--color-foreground)]"},s.author),React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)]"},s.readTime," · ",l(s.date))))))),React.createElement("div",{className:"max-w-[1200px] mx-auto px-5"},React.createElement("div",{className:"border-t border-[var(--color-border)]"})),React.createElement("div",{className:"max-w-[1200px] mx-auto px-5 py-12"},React.createElement("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12"},b.map(o=>React.createElement("button",{key:o.slug,onClick:()=>t(o.slug),className:"group text-left"},o.coverImage&&React.createElement("div",{className:"overflow-hidden rounded-xl mb-4"},React.createElement(d,{src:o.coverImage,alt:o.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700",loading:"lazy",decoding:"async"})),React.createElement("div",{className:"space-y-2.5"},React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)]"},o.category),React.createElement("h3",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug"},o.title),React.createElement("p",{className:"text-sm text-[var(--color-muted-foreground)] leading-relaxed line-clamp-3"},o.excerpt),React.createElement("div",{className:"flex items-center gap-3 pt-1"},React.createElement("div",{className:"w-6 h-6 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-[9px] font-bold text-[var(--color-accent)]"},"SA"),React.createElement("p",{className:"text-xs text-[var(--color-muted-foreground)]"},o.readTime," · ",l(o.date))))))),n.length===0&&React.createElement("div",{className:"text-center py-20 text-[var(--color-muted-foreground)]"},React.createElement("p",{className:"text-lg"},"Próximamente más artículos..."))))}function X({slug:e}){return React.createElement("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"}},React.createElement(A,{title:"Blog de Cámaras IA y Automatización",subtitle:"Guías, casos reales y novedades sobre analítica de video con IA, CCTV Hikvision, bots WhatsApp y automatización de procesos para empresas en Bogotá.",ctaLabel:"Ver artículos",onCta:()=>{}}),React.createElement(Q,{initialSlug:e}))}export{X as BlogLanding};
