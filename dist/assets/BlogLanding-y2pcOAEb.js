import{c as g,r as m,j as e,I as u,E as p}from"./index-D2_DDSoo.js";import{f as C,V as h}from"./VideoHero-CO1Ovm8g.js";/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],P=g("arrow-left",f);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=[["path",{d:"m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z",key:"1fy3hk"}]],I=g("bookmark",S);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]],D=g("share-2",E),y=`---
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`,F={"guia-camaras-hikvision-ia-empresas-bogota-2026":y,"costo-camaras-seguridad-empresas-2026-hardware-vs-ia":R,"que-es-analitica-video-ia-empresas-bogota":O,"5-senales-camaras-no-protegen-empresa-bogota":T,"negocio-camaras-ia-vs-sin-ia-caso-visual-antes-despues":z,"analitica-video-ia-ferreterias-bogota-caso-real-suba":V,"analitica-video-ia-clinicas-bogota-cumplimiento-seguridad":L,"hikvision-colorvu-vs-acusense-vs-deepinview-ia-2026":j,"normativa-videovigilancia-colombia-2026-ley-1581-habeas-data":M,"automatizacion-n8n-cctv-alerta-whatsapp-crm-dashboard":x,"seo-local-google-maps-empresas-seguridad-bogota":q,"servidores-edge-gpu-para-ia-video-analitica-bogota":N,"hikvision-vs-dahua-vs-uniview-comparativa-ia-2026":B,"bot-whatsapp-ia-atencion-clientes-seguridad-bogota":$,"deteccion-ppe-ia-construccion-fabrica-bogota-cumplimiento":G,"cuanto-cuesta-camaras-seguridad-negocio-bogota-2026":w,"mejores-camaras-seguridad-local-comercial-bogota":H,"camaras-seguridad-bodega-bogota-monitoreo-inteligente":k,"instalacion-camaras-seguridad-negocio-pequeno-bogota-guia":U};function W(a){const s=a.replace(/^\uFEFF/,"").replace(/\r\n/g,`
`),t=s.match(/^---\n([\s\S]*?)\n---/);if(!t)return{fm:{},content:s};const o=t[1],n={};o.split(`
`).forEach(l=>{const r=l.indexOf(":");r>0&&(n[l.slice(0,r).trim()]=l.slice(r+1).trim().replace(/^["']|["']$/g,""))});const c=s.slice(t[0].length).trim();return{fm:n,content:c}}function Y(){const a=new Date;return Object.entries(F).map(([s,t])=>{const{fm:o,content:n}=W(t),c=o.publishDate||o.date;return c&&new Date(c)>a?null:{slug:s,title:o.title||"Sin título",excerpt:o.excerpt||"",date:o.date||"",publishDate:c,author:o.author||"Servicios APC",category:o.category||"IA & Seguridad",tags:o.tags?o.tags.split(",").map(l=>l.trim()):[],readTime:o.readTime||"5 min",coverImage:o.coverImage,content:C.parse(n),cta:o.cta?JSON.parse(o.cta.replace(/\\"/g,'"')):void 0}}).filter(s=>s!==null).sort((s,t)=>new Date(t.date).getTime()-new Date(s.date).getTime())}const d=a=>{if(!a)return"Reciente";const s=new Date(a);return isNaN(s.getTime())?"Reciente":s.toLocaleDateString("es-ES",{day:"numeric",month:"short",year:"numeric"})};function Q({post:a,allPosts:s,onBack:t,onSelect:o}){return e.jsx("div",{className:"min-h-screen",children:e.jsxs("div",{className:"max-w-[728px] mx-auto px-5",children:[e.jsxs("button",{onClick:t,className:"flex items-center gap-1.5 text-sm text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)] transition-colors py-8",children:[e.jsx(P,{size:14}),e.jsx("span",{children:"Volver al blog"})]}),e.jsxs("article",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("span",{className:"text-sm font-medium text-[var(--color-accent)]",children:a.category}),e.jsx("span",{className:"text-[var(--color-border)]",children:"·"}),e.jsx("time",{className:"text-sm text-[var(--color-muted-foreground)]",dateTime:a.date,children:d(a.date)})]}),e.jsx("h1",{className:"font-serif text-[2.5rem] md:text-[3rem] leading-[1.15] font-bold text-[var(--color-foreground)] mb-5",children:a.title}),e.jsx("p",{className:"text-xl text-[var(--color-muted-foreground)] leading-relaxed mb-8",children:a.excerpt}),e.jsxs("div",{className:"flex items-center justify-between py-6 border-t border-b border-[var(--color-border)] mb-10",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-sm font-bold text-[var(--color-accent)]",children:"SA"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:a.author}),e.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[a.readTime," de lectura · ",d(a.date)]})]})]}),e.jsxs("div",{className:"flex items-center gap-3 text-[var(--color-muted-foreground)]",children:[e.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:e.jsx(I,{size:18})}),e.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:e.jsx(D,{size:18})})]})]}),a.coverImage&&e.jsx("figure",{className:"mb-10",children:e.jsx(u,{src:a.coverImage,alt:a.title,className:"w-full aspect-[16/9] object-cover"})}),e.jsx("div",{className:"blog-content max-w-none",dangerouslySetInnerHTML:{__html:a.content}}),e.jsx("div",{className:"flex flex-wrap gap-2 mt-12 mb-8",children:a.tags.map(n=>e.jsx("span",{className:"px-3 py-1.5 text-xs bg-[var(--color-secondary)] text-[var(--color-muted-foreground)] rounded-full",children:n},n))}),a.cta&&e.jsxs("div",{className:"my-12 p-8 bg-[var(--color-secondary)] rounded-2xl",children:[e.jsx("p",{className:"text-xs uppercase tracking-widest text-[var(--color-accent)] font-medium mb-3",children:"¿Necesitas esto para tu empresa?"}),e.jsx("h3",{className:"font-serif text-2xl font-bold text-[var(--color-foreground)] mb-5",children:a.cta.primary.label}),e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsxs("a",{href:a.cta.primary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-[var(--color-accent)] text-white px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity",children:["Solicitar cotización",e.jsx(p,{size:14})]}),a.cta.secondary&&e.jsxs("a",{href:a.cta.secondary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[a.cta.secondary.label,e.jsx(p,{size:14})]}),a.cta.tertiary&&e.jsxs("a",{href:a.cta.tertiary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[a.cta.tertiary.label,e.jsx(p,{size:14})]})]})]}),e.jsxs("div",{className:"border-t border-[var(--color-border)] pt-10 pb-16",children:[e.jsx("h3",{className:"text-sm uppercase tracking-widest text-[var(--color-muted-foreground)] mb-6",children:"Sigue leyendo"}),e.jsx("div",{className:"space-y-8",children:s.filter(n=>n.slug!==a.slug).slice(0,3).map(n=>e.jsxs("button",{onClick:()=>o(n.slug),className:"flex gap-6 text-left group w-full",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)] mb-1",children:n.category}),e.jsx("h4",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug mb-1",children:n.title}),e.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] line-clamp-2",children:n.excerpt}),e.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)] mt-2",children:[n.readTime," · ",d(n.date)]})]}),n.coverImage&&e.jsx(u,{src:n.coverImage,alt:n.title,className:"w-[120px] h-[80px] object-cover rounded-lg flex-shrink-0"})]},n.slug))})]})]})]})})}function b(){const a=window.location.hash.slice(1);return a.startsWith("blog/")?a.slice(5):null}function K({initialSlug:a}){const[s,t]=m.useState(a??b()),o=Y(),n=o.find(i=>i.slug===s);m.useEffect(()=>{n&&(document.title=`${n.title} | Servicios APC Bogotá`)},[n]),m.useEffect(()=>{const i=()=>{const v=b();t(v),v&&window.scrollTo({top:0})};return window.addEventListener("hashchange",i),()=>window.removeEventListener("hashchange",i)},[]);const c=i=>{t(i),window.location.hash=`blog/${i}`,window.scrollTo({top:0,behavior:"smooth"})},l=()=>{t(null),window.location.hash="blog",window.scrollTo({top:0,behavior:"smooth"})};if(n)return e.jsx(Q,{post:n,allPosts:o,onBack:l,onSelect:c});const r=o[0],A=o.slice(1);return e.jsxs("div",{className:"min-h-screen",children:[e.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 pt-12 pb-16",children:[e.jsx("p",{className:"text-xs uppercase tracking-[0.2em] text-[var(--color-accent)] font-medium mb-4",children:"Blog · Servicios APC"}),e.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold text-[var(--color-foreground)] leading-tight max-w-3xl",children:"Cámaras Hikvision + IA para empresas"}),e.jsx("p",{className:"text-lg text-[var(--color-muted-foreground)] mt-4 max-w-2xl leading-relaxed",children:"Guías técnicas, comparativas y casos reales sobre CCTV con inteligencia artificial, automatización y seguridad empresarial en Bogotá."})]}),r&&e.jsx("div",{className:"max-w-[1200px] mx-auto px-5 mb-16",children:e.jsxs("button",{onClick:()=>c(r.slug),className:"group grid md:grid-cols-[1fr_1fr] gap-8 items-center text-left w-full",children:[r.coverImage&&e.jsx("div",{className:"overflow-hidden rounded-2xl",children:e.jsx(u,{src:r.coverImage,alt:r.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700"})}),e.jsxs("div",{className:"space-y-4 py-4",children:[e.jsx("p",{className:"text-xs uppercase tracking-[0.15em] text-[var(--color-accent)] font-medium",children:"Destacado"}),e.jsx("h3",{className:"font-serif text-3xl md:text-4xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-[1.15]",children:r.title}),e.jsx("p",{className:"text-[var(--color-muted-foreground)] leading-relaxed text-lg",children:r.excerpt}),e.jsxs("div",{className:"flex items-center gap-3 pt-2",children:[e.jsx("div",{className:"w-8 h-8 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-xs font-bold text-[var(--color-accent)]",children:"SA"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:r.author}),e.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[r.readTime," · ",d(r.date)]})]})]})]})]})}),e.jsx("div",{className:"max-w-[1200px] mx-auto px-5",children:e.jsx("div",{className:"border-t border-[var(--color-border)]"})}),e.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 py-12",children:[e.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12",children:A.map(i=>e.jsxs("button",{onClick:()=>c(i.slug),className:"group text-left",children:[i.coverImage&&e.jsx("div",{className:"overflow-hidden rounded-xl mb-4",children:e.jsx(u,{src:i.coverImage,alt:i.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700",loading:"lazy"})}),e.jsxs("div",{className:"space-y-2.5",children:[e.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:i.category}),e.jsx("h3",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug",children:i.title}),e.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] leading-relaxed line-clamp-3",children:i.excerpt}),e.jsxs("div",{className:"flex items-center gap-3 pt-1",children:[e.jsx("div",{className:"w-6 h-6 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-[9px] font-bold text-[var(--color-accent)]",children:"SA"}),e.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[i.readTime," · ",d(i.date)]})]})]})]},i.slug))}),o.length===0&&e.jsx("div",{className:"text-center py-20 text-[var(--color-muted-foreground)]",children:e.jsx("p",{className:"text-lg",children:"Próximamente más artículos..."})})]})]})}function J({slug:a}){return e.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[e.jsx(h,{title:"Blog de Cámaras IA y Automatización",subtitle:"Guías, casos reales y novedades sobre analítica de video con IA, CCTV Hikvision, bots WhatsApp y automatización de procesos para empresas en Bogotá.",ctaLabel:"Ver artículos",onCta:()=>{}}),e.jsx(K,{initialSlug:a})]})}export{J as BlogLanding};
