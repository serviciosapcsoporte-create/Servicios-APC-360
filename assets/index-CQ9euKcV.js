var Pd={exports:{}},Fo={},jd={exports:{}},Q={};/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var Ed;function Ap(){if(Ed)return Fo;Ed=1;var i=vi(),l=Symbol.for("react.element"),c=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,u=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function g(b,S,k){var T,z={},V=null,ae=null;k!==void 0&&(V=""+k),S.key!==void 0&&(V=""+S.key),S.ref!==void 0&&(ae=S.ref);for(T in S)m.call(S,T)&&!f.hasOwnProperty(T)&&(z[T]=S[T]);if(b&&b.defaultProps)for(T in S=b.defaultProps,S)z[T]===void 0&&(z[T]=S[T]);return{$$typeof:l,type:b,key:V,ref:ae,props:z,_owner:u.current}}return Fo.Fragment=c,Fo.jsx=g,Fo.jsxs=g,Fo}var Id;function kp(){return Id||(Id=1,Pd.exports=Ap()),Pd.exports}var o=kp(),sn={},mi={exports:{}},Ze={},zd={exports:{}},Dd={};/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var Rd;function Sp(){return Rd||(Rd=1,(function(i){function l(D,U){var O=D.length;D.push(U);e:for(;0<O;){var x=O-1>>>1,N=D[x];if(0<u(N,U))D[x]=U,D[O]=N,O=x;else break e}}function c(D){return D.length===0?null:D[0]}function m(D){if(D.length===0)return null;var U=D[0],O=D.pop();if(O!==U){D[0]=O;e:for(var x=0,N=D.length,Y=N>>>1;x<Y;){var Z=2*(x+1)-1,oe=D[Z],te=Z+1,ce=D[te];if(0>u(oe,O))te<N&&0>u(ce,oe)?(D[x]=ce,D[te]=O,x=te):(D[x]=oe,D[Z]=O,x=Z);else if(te<N&&0>u(ce,O))D[x]=ce,D[te]=O,x=te;else break e}}return U}function u(D,U){var O=D.sortIndex-U.sortIndex;return O!==0?O:D.id-U.id}if(typeof performance=="object"&&typeof performance.now=="function"){var f=performance;i.unstable_now=function(){return f.now()}}else{var g=Date,b=g.now();i.unstable_now=function(){return g.now()-b}}var S=[],k=[],T=1,z=null,V=3,ae=!1,K=!1,X=!1,J=typeof setTimeout=="function"?setTimeout:null,_e=typeof clearTimeout=="function"?clearTimeout:null,Be=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function $e(D){for(var U=c(k);U!==null;){if(U.callback===null)m(k);else if(U.startTime<=D)m(k),U.sortIndex=U.expirationTime,l(S,U);else break;U=c(k)}}function be(D){if(X=!1,$e(D),!K)if(c(S)!==null)K=!0,Ue(we);else{var U=c(k);U!==null&&ve(be,U.startTime-D)}}function we(D,U){K=!1,X&&(X=!1,_e(P),P=-1),ae=!0;var O=V;try{for($e(U),z=c(S);z!==null&&(!(z.expirationTime>U)||D&&!ia());){var x=z.callback;if(typeof x=="function"){z.callback=null,V=z.priorityLevel;var N=x(z.expirationTime<=U);U=i.unstable_now(),typeof N=="function"?z.callback=N:z===c(S)&&m(S),$e(U)}else m(S);z=c(S)}if(z!==null)var Y=!0;else{var Z=c(k);Z!==null&&ve(be,Z.startTime-U),Y=!1}return Y}finally{z=null,V=O,ae=!1}}var se=!1,Te=null,P=-1,W=5,Se=-1;function ia(){return!(i.unstable_now()-Se<W)}function Xe(){if(Te!==null){var D=i.unstable_now();Se=D;var U=!0;try{U=Te(!0,D)}finally{U?Je():(se=!1,Te=null)}}else se=!1}var Je;if(typeof Be=="function")Je=function(){Be(Xe)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,ja=ha.port2;ha.port1.onmessage=Xe,Je=function(){ja.postMessage(null)}}else Je=function(){J(Xe,0)};function Ue(D){Te=D,se||(se=!0,Je())}function ve(D,U){P=J(function(){D(i.unstable_now())},U)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(D){D.callback=null},i.unstable_continueExecution=function(){K||ae||(K=!0,Ue(we))},i.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<D?Math.floor(1e3/D):5},i.unstable_getCurrentPriorityLevel=function(){return V},i.unstable_getFirstCallbackNode=function(){return c(S)},i.unstable_next=function(D){switch(V){case 1:case 2:case 3:var U=3;break;default:U=V}var O=V;V=U;try{return D()}finally{V=O}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(D,U){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var O=V;V=D;try{return U()}finally{V=O}},i.unstable_scheduleCallback=function(D,U,O){var x=i.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?x+O:x):O=x,D){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=O+N,D={id:T++,callback:U,priorityLevel:D,startTime:O,expirationTime:N,sortIndex:-1},O>x?(D.sortIndex=O,l(k,D),c(S)===null&&D===c(k)&&(X?(_e(P),P=-1):X=!0,ve(be,O-x))):(D.sortIndex=N,l(S,D),K||ae||(K=!0,Ue(we))),D},i.unstable_shouldYield=ia,i.unstable_wrapCallback=function(D){var U=V;return function(){var O=V;V=U;try{return D.apply(this,arguments)}finally{V=O}}}})(Dd)),Dd}var Td;function Pp(){return Td||(Td=1,zd.exports=Sp()),zd.exports}/**
* @license React
...
${k}`:k,u=u?`${u}
${T}`:T;let z=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(T,f,!0),this.lexer.state.top=z,c.length===0)break;let V=f.at(-1);if(V?.type==="code")break;if(V?.type==="blockquote"){let ae=V,K=ae.raw+`
`+c.join(`
...
`);continue}}return{type:"blockquote",raw:m,tokens:f,text:u}}}list(i){let l=this.rules.block.list.exec(i);if(l){let c=l[1].trim(),m=c.length>1,u={type:"list",raw:"",ordered:m,start:m?+c.slice(0,-1):"",loose:!1,items:[]};c=m?`\\d{1,9}\\${c.slice(-1)}`:`\\${c}`,this.options.pedantic&&(c=m?c:"[*+-]");let f=this.rules.other.listItemRegex(c),g=!1;for(;i;){let S=!1,k="",T="";if(!(l=f.exec(i))||this.rules.block.hr.test(i))break;k=l[0],i=i.substring(k.length);let z=bf(l[2].split(`
`,1)[0],l[1].length),V=i.split(`
`,1)[0],ae=!z.trim(),K=0;if(this.options.pedantic?(K=2,T=z.trimStart()):ae?K=l[1].length+1:(K=z.search(this.rules.other.nonSpaceChar),K=K>4?1:K,T=z.slice(K),K+=l[1].length),ae&&this.rules.other.blankLine.test(V)&&(k+=V+`
`,i=i.substring(V.length+1),S=!0),!S){let X=this.rules.other.nextBulletRegex(K),J=this.rules.other.hrRegex(K),_e=this.rules.other.fencesBeginRegex(K),Be=this.rules.other.headingBeginRegex(K),$e=this.rules.other.htmlBeginRegex(K),be=this.rules.other.blockquoteBeginRegex(K);for(;i;){let we=i.split(`
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const kf=ke.forwardRef(({color:i="currentColor",size:l=24,strokeWidth:c=2,absoluteStrokeWidth:m,className:u="",children:f,iconNode:g,...b},S)=>ke.createElement("svg",{ref:S,...Af,width:l,height:l,stroke:i,strokeWidth:m?Number(c)*24/Number(l):c,className:xu("lucide",u),...b},[...g.map(([k,T])=>ke.createElement(k,T)),...Array.isArray(f)?f:[f]]));/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Hf=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]],Qo=$("clock",Hf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
