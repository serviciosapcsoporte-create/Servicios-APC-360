var Pd={exports:{}},Ho={},Nd={exports:{}},Y={};/**
* @license React
...
*/var jd;function Cp(){if(jd)return Y;jd=1;var i=Symbol.for("react.element"),l=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),u=Symbol.for("react.profiler"),f=Symbol.for("react.provider"),g=Symbol.for("react.context"),b=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),A=Symbol.for("react.memo"),R=Symbol.for("react.lazy"),E=Symbol.iterator;function V(x){return x===null||typeof x!="object"?null:(x=E&&x[E]||x["@@iterator"],typeof x=="function"?x:null)}var ae={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,X={};function J(x,j,Q){this.props=x,this.context=j,this.refs=X,this.updater=Q||ae}J.prototype.isReactComponent={},J.prototype.setState=function(x,j){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,j,"setState")},J.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function Ue(){}Ue.prototype=J.prototype;function Be(x,j,Q){this.props=x,this.context=j,this.refs=X,this.updater=Q||ae}var $e=Be.prototype=new Ue;$e.constructor=Be,K($e,J.prototype),$e.isPureReactComponent=!0;var be=Array.isArray,we=Object.prototype.hasOwnProperty,se={current:null},Re={key:!0,ref:!0,__self:!0,__source:!0};function P(x,j,Q){var Z,oe={},te=null,ce=null;if(j!=null)for(Z in j.ref!==void 0&&(ce=j.ref),j.key!==void 0&&(te=""+j.key),j)we.call(j,Z)&&!Re.hasOwnProperty(Z)&&(oe[Z]=j[Z]);var ie=arguments.length-2;if(ie===1)oe.children=Q;else if(1<ie){for(var pe=Array(ie),ea=0;ea<ie;ea++)pe[ea]=arguments[ea+2];oe.children=pe}if(x&&x.defaultProps)for(Z in ie=x.defaultProps,ie)oe[Z]===void 0&&(oe[Z]=ie[Z]);return{$$typeof:i,type:x,key:te,ref:ce,props:oe,_owner:se.current}}function W(x,j){return{$$typeof:i,type:x.type,key:j,ref:x.ref,props:x.props,_owner:x._owner}}function ke(x){return typeof x=="object"&&x!==null&&x.$$typeof===i}function ia(x){var j={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(Q){return j[Q]})}var Xe=/\/+/g;function Je(x,j){return typeof x=="object"&&x!==null&&x.key!=null?ia(""+x.key):j.toString(36)}function ha(x,j,Q,Z,oe){var te=typeof x;(te==="undefined"||te==="boolean")&&(x=null);var ce=!1;if(x===null)ce=!0;else switch(te){case"string":case"number":ce=!0;break;case"object":switch(x.$$typeof){case i:case l:ce=!0}}if(ce)return ce=x,oe=oe(ce),x=Z===""?"."+Je(ce,0):Z,be(oe)?(Q="",x!=null&&(Q=x.replace(Xe,"$&/")+"/"),ha(oe,j,Q,"",function(ea){return ea})):oe!=null&&(ke(oe)&&(oe=W(oe,Q+(!oe.key||ce&&ce.key===oe.key?"":(""+oe.key).replace(Xe,"$&/")+"/")+x)),j.push(oe)),1;if(ce=0,Z=Z===""?".":Z+":",be(x))for(var ie=0;ie<x.length;ie++){te=x[ie];var pe=Z+Je(te,ie);ce+=ha(te,j,Q,pe,oe)}else if(pe=V(x),typeof pe=="function")for(x=pe.call(x),ie=0;!(te=x.next()).done;)te=te.value,pe=Z+Je(te,ie++),ce+=ha(te,j,Q,pe,oe);else if(te==="object")throw j=String(x),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.");return ce}function Na(x,j,Q){if(x==null)return x;var Z=[],oe=0;return ha(x,Z,"","",function(te){return j.call(Q,te,oe++)}),Z}function Fe(x){if(x._status===-1){var j=x._result;j=j(),j.then(function(Q){(x._status===0||x._status===-1)&&(x._status=1,x._result=Q)},function(Q){(x._status===0||x._status===-1)&&(x._status=2,x._result=Q)}),x._status===-1&&(x._status=0,x._result=j)}if(x._status===1)return x._result.default;throw x._result}var ve={current:null},T={transition:null},F={ReactCurrentDispatcher:ve,ReactCurrentBatchConfig:T,ReactCurrentOwner:se};function O(){throw Error("act(...) is not supported in production builds of React.")}return Y.Children={map:Na,forEach:function(x,j,Q){Na(x,function(){j.apply(this,arguments)},Q)},count:function(x){var j=0;return Na(x,function(){j++}),j},toArray:function(x){return Na(x,function(j){return j})||[]},only:function(x){if(!ke(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},Y.Component=J,Y.Fragment=c,Y.Profiler=u,Y.PureComponent=Be,Y.StrictMode=m,Y.Suspense=k,Y.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=F,Y.act=O,Y.cloneElement=function(x,j,Q){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var Z=K({},x.props),oe=x.key,te=x.ref,ce=x._owner;if(j!=null){if(j.ref!==void 0&&(te=j.ref,ce=se.current),j.key!==void 0&&(oe=""+j.key),x.type&&x.type.defaultProps)var ie=x.type.defaultProps;for(pe in j)we.call(j,pe)&&!Re.hasOwnProperty(pe)&&(Z[pe]=j[pe]===void 0&&ie!==void 0?ie[pe]:j[pe])}var pe=arguments.length-2;if(pe===1)Z.children=Q;else if(1<pe){ie=Array(pe);for(var ea=0;ea<pe;ea++)ie[ea]=arguments[ea+2];Z.children=ie}return{$$typeof:i,type:x.type,key:oe,ref:te,props:Z,_owner:ce}},Y.createContext=function(x){return x={$$typeof:g,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:f,_context:x},x.Consumer=x},Y.createElement=P,Y.createFactory=function(x){var j=P.bind(null,x);return j.type=x,j},Y.createRef=function(){return{current:null}},Y.forwardRef=function(x){return{$$typeof:b,render:x}},Y.isValidElement=ke,Y.lazy=function(x){return{$$typeof:R,_payload:{_status:-1,_result:x},_init:Fe}},Y.memo=function(x,j){return{$$typeof:A,type:x,compare:j===void 0?null:j}},Y.startTransition=function(x){var j=T.transition;T.transition={};try{x()}finally{T.transition=j}},Y.unstable_act=O,Y.useCallback=function(x,j){return ve.current.useCallback(x,j)},Y.useContext=function(x){return ve.current.useContext(x)},Y.useDebugValue=function(){},Y.useDeferredValue=function(x){return ve.current.useDeferredValue(x)},Y.useEffect=function(x,j){return ve.current.useEffect(x,j)},Y.useId=function(){return ve.current.useId()},Y.useImperativeHandle=function(x,j,Q){return ve.current.useImperativeHandle(x,j,Q)},Y.useInsertionEffect=function(x,j){return ve.current.useInsertionEffect(x,j)},Y.useLayoutEffect=function(x,j){return ve.current.useLayoutEffect(x,j)},Y.useMemo=function(x,j){return ve.current.useMemo(x,j)},Y.useReducer=function(x,j,Q){return ve.current.useReducer(x,j,Q)},Y.useRef=function(x){return ve.current.useRef(x)},Y.useState=function(x){return ve.current.useState(x)},Y.useSyncExternalStore=function(x,j,Q){return ve.current.useSyncExternalStore(x,j,Q)},Y.useTransition=function(){return ve.current.useTransition()},Y.version="18.3.1",Y}var wd;function vi(){return wd||(wd=1,Nd.exports=Cp()),Nd.exports}/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var zd;function Sp(){if(zd)return Ho;zd=1;var i=vi(),l=Symbol.for("react.element"),c=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,u=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function g(b,k,A){var R,E={},V=null,ae=null;A!==void 0&&(V=""+A),k.key!==void 0&&(V=""+k.key),k.ref!==void 0&&(ae=k.ref);for(R in k)m.call(k,R)&&!f.hasOwnProperty(R)&&(E[R]=k[R]);if(b&&b.defaultProps)for(R in k=b.defaultProps,k)E[R]===void 0&&(E[R]=k[R]);return{$$typeof:l,type:b,key:V,ref:ae,props:E,_owner:u.current}}return Ho.Fragment=c,Ho.jsx=g,Ho.jsxs=g,Ho}var Id;function Ap(){return Id||(Id=1,Pd.exports=Sp()),Pd.exports}var o=Ap(),sn={},mi={exports:{}},Ze={},Ed={exports:{}},Td={};/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var Dd;function kp(){return Dd||(Dd=1,(function(i){function l(T,F){var O=T.length;T.push(F);e:for(;0<O;){var x=O-1>>>1,j=T[x];if(0<u(j,F))T[x]=F,T[O]=j,O=x;else break e}}function c(T){return T.length===0?null:T[0]}function m(T){if(T.length===0)return null;var F=T[0],O=T.pop();if(O!==F){T[0]=O;e:for(var x=0,j=T.length,Q=j>>>1;x<Q;){var Z=2*(x+1)-1,oe=T[Z],te=Z+1,ce=T[te];if(0>u(oe,O))te<j&&0>u(ce,oe)?(T[x]=ce,T[te]=O,x=te):(T[x]=oe,T[Z]=O,x=Z);else if(te<j&&0>u(ce,O))T[x]=ce,T[te]=O,x=te;else break e}}return F}function u(T,F){var O=T.sortIndex-F.sortIndex;return O!==0?O:T.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var f=performance;i.unstable_now=function(){return f.now()}}else{var g=Date,b=g.now();i.unstable_now=function(){return g.now()-b}}var k=[],A=[],R=1,E=null,V=3,ae=!1,K=!1,X=!1,J=typeof setTimeout=="function"?setTimeout:null,Ue=typeof clearTimeout=="function"?clearTimeout:null,Be=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function $e(T){for(var F=c(A);F!==null;){if(F.callback===null)m(A);else if(F.startTime<=T)m(A),F.sortIndex=F.expirationTime,l(k,F);else break;F=c(A)}}function be(T){if(X=!1,$e(T),!K)if(c(k)!==null)K=!0,Fe(we);else{var F=c(A);F!==null&&ve(be,F.startTime-T)}}function we(T,F){K=!1,X&&(X=!1,Ue(P),P=-1),ae=!0;var O=V;try{for($e(F),E=c(k);E!==null&&(!(E.expirationTime>F)||T&&!ia());){var x=E.callback;if(typeof x=="function"){E.callback=null,V=E.priorityLevel;var j=x(E.expirationTime<=F);F=i.unstable_now(),typeof j=="function"?E.callback=j:E===c(k)&&m(k),$e(F)}else m(k);E=c(k)}if(E!==null)var Q=!0;else{var Z=c(A);Z!==null&&ve(be,Z.startTime-F),Q=!1}return Q}finally{E=null,V=O,ae=!1}}var se=!1,Re=null,P=-1,W=5,ke=-1;function ia(){return!(i.unstable_now()-ke<W)}function Xe(){if(Re!==null){var T=i.unstable_now();ke=T;var F=!0;try{F=Re(!0,T)}finally{F?Je():(se=!1,Re=null)}}else se=!1}var Je;if(typeof Be=="function")Je=function(){Be(Xe)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,Na=ha.port2;ha.port1.onmessage=Xe,Je=function(){Na.postMessage(null)}}else Je=function(){J(Xe,0)};function Fe(T){Re=T,se||(se=!0,Je())}function ve(T,F){P=J(function(){T(i.unstable_now())},F)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(T){T.callback=null},i.unstable_continueExecution=function(){K||ae||(K=!0,Fe(we))},i.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<T?Math.floor(1e3/T):5},i.unstable_getCurrentPriorityLevel=function(){return V},i.unstable_getFirstCallbackNode=function(){return c(k)},i.unstable_next=function(T){switch(V){case 1:case 2:case 3:var F=3;break;default:F=V}var O=V;V=F;try{return T()}finally{V=O}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(T,F){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var O=V;V=T;try{return F()}finally{V=O}},i.unstable_scheduleCallback=function(T,F,O){var x=i.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?x+O:x):O=x,T){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=O+j,T={id:R++,callback:F,priorityLevel:T,startTime:O,expirationTime:j,sortIndex:-1},O>x?(T.sortIndex=O,l(A,T),c(k)===null&&T===c(A)&&(X?(Ue(P),P=-1):X=!0,ve(be,O-x))):(T.sortIndex=j,l(k,T),K||ae||(K=!0,Fe(we))),T},i.unstable_shouldYield=ia,i.unstable_wrapCallback=function(T){var F=V;return function(){var O=V;V=F;try{return T.apply(this,arguments)}finally{V=O}}}})(Td)),Td}var Rd;function Pp(){return Rd||(Rd=1,Ed.exports=kp()),Ed.exports}/**
* @license React
...
* This source code is licensed under the MIT license found in the
* LICENSE file in the root directory of this source tree.
*/var Ld;function Np(){if(Ld)return Ze;Ld=1;var i=vi(),l=Pp();function c(e){for(var a="https://reactjs.org/docs/error-decoder.html?invariant="+e,r=1;r<arguments.length;r++)a+="&args[]="+encodeURIComponent(arguments[r]);return"Minified React error #"+e+"; visit "+a+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var m=new Set,u={};function f(e,a){g(e,a),g(e+"Capture",a)}function g(e,a){for(u[e]=a,e=0;e<a.length;e++)m.add(a[e])}var b=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),k=Object.prototype.hasOwnProperty,A=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,R={},E={};function V(e){return k.call(E,e)?!0:k.call(R,e)?!1:A.test(e)?E[e]=!0:(R[e]=!0,!1)}function ae(e,a,r,t){if(r!==null&&r.type===0)return!1;switch(typeof a){case"function":case"symbol":return!0;case"boolean":return t?!1:r!==null?!r.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function K(e,a,r,t){if(a===null||typeof a>"u"||ae(e,a,r,t))return!0;if(t)return!1;if(r!==null)switch(r.type){case 3:return!a;case 4:return a===!1;case 5:return isNaN(a);case 6:return isNaN(a)||1>a}return!1}function X(e,a,r,t,n,s,d){this.acceptsBooleans=a===2||a===3||a===4,this.attributeName=t,this.attributeNamespace=n,this.mustUseProperty=r,this.propertyName=e,this.type=a,this.sanitizeURL=s,this.removeEmptyString=d}var J={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){J[e]=new X(e,0,!1,e,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var a=e[0];J[a]=new X(a,1,!1,e[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){J[e]=new X(e,2,!1,e.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){J[e]=new X(e,2,!1,e,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){J[e]=new X(e,3,!1,e.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(e){J[e]=new X(e,3,!0,e,null,!1,!1)}),["capture","download"].forEach(function(e){J[e]=new X(e,4,!1,e,null,!1,!1)}),["cols","rows","size","span"].forEach(function(e){J[e]=new X(e,6,!1,e,null,!1,!1)}),["rowSpan","start"].forEach(function(e){J[e]=new X(e,5,!1,e.toLowerCase(),null,!1,!1)});var Ue=/[\-:]([a-z])/g;function Be(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var a=e.replace(Ue,Be);J[a]=new X(a,1,!1,e,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var a=e.replace(Ue,Be);J[a]=new X(a,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(e){var a=e.replace(Ue,Be);J[a]=new X(a,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(e){J[e]=new X(e,1,!1,e.toLowerCase(),null,!1,!1)}),J.xlinkHref=new X("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(e){J[e]=new X(e,1,!1,e.toLowerCase(),null,!0,!0)});function $e(e,a,r,t){var n=J.hasOwnProperty(a)?J[a]:null;(n!==null?n.type!==0:t||!(2<a.length)||a[0]!=="o"&&a[0]!=="O"||a[1]!=="n"&&a[1]!=="N")&&(K(a,r,n,t)&&(r=null),t||n===null?V(a)&&(r===null?e.removeAttribute(a):e.setAttribute(a,""+r)):n.mustUseProperty?e[n.propertyName]=r===null?n.type===3?!1:"":r:(a=n.attributeName,t=n.attributeNamespace,r===null?e.removeAttribute(a):(n=n.type,r=n===3||n===4&&r===!0?"":""+r,t?e.setAttributeNS(t,a,r):e.setAttribute(a,r))))}var be=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,we=Symbol.for("react.element"),se=Symbol.for("react.portal"),Re=Symbol.for("react.fragment"),P=Symbol.for("react.strict_mode"),W=Symbol.for("react.profiler"),ke=Symbol.for("react.provider"),ia=Symbol.for("react.context"),Xe=Symbol.for("react.forward_ref"),Je=Symbol.for("react.suspense"),ha=Symbol.for("react.suspense_list"),Na=Symbol.for("react.memo"),Fe=Symbol.for("react.lazy"),ve=Symbol.for("react.offscreen"),T=Symbol.iterator;function F(e){return e===null||typeof e!="object"?null:(e=T&&e[T]||e["@@iterator"],typeof e=="function"?e:null)}var O=Object.assign,x;function j(e){if(x===void 0)try{throw Error()}catch(r){var a=r.stack.trim().match(/\n( *(at )?)/);x=a&&a[1]||""}return`
`+x+e}var Q=!1;function Z(e,a){if(!e||Q)return"";Q=!0;var r=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(a)if(a=function(){throw Error()},Object.defineProperty(a.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(a,[])}catch(S){var t=S}Reflect.construct(e,[],a)}else{try{a.call()}catch(S){t=S}e.call(a.prototype)}else{try{throw Error()}catch(S){t=S}e()}}catch(S){if(S&&t&&typeof S.stack=="string"){for(var n=S.stack.split(`
`),s=t.stack.split(`
`),d=n.length-1,p=s.length-1;1<=d&&0<=p&&n[d]!==s[p];)p--;for(;1<=d&&0<=p;d--,p--)if(n[d]!==s[p]){if(d!==1||p!==1)do if(d--,p--,0>p||n[d]!==s[p]){var h=`
`+n[d].replace(" at new "," at ");return e.displayName&&h.includes("<anonymous>")&&(h=h.replace("<anonymous>",e.displayName)),h}while(1<=d&&0<=p);break}}}finally{Q=!1,Error.prepareStackTrace=r}return(e=e?e.displayName||e.name:"")?j(e):""}function oe(e){switch(e.tag){case 5:return j(e.type);case 16:return j("Lazy");case 13:return j("Suspense");case 19:return j("SuspenseList");case 0:case 2:case 15:return e=Z(e.type,!1),e;case 11:return e=Z(e.type.render,!1),e;case 1:return e=Z(e.type,!0),e;default:return""}}function te(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Re:return"Fragment";case se:return"Portal";case W:return"Profiler";case P:return"StrictMode";case Je:return"Suspense";case ha:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case ia:return(e.displayName||"Context")+".Consumer";case ke:return(e._context.displayName||"Context")+".Provider";case Xe:var a=e.render;return e=e.displayName,e||(e=a.displayName||a.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case Na:return a=e.displayName||null,a!==null?a:te(e.type)||"Memo";case Fe:a=e._payload,e=e._init;try{return te(e(a))}catch{}}return null}function ce(e){var a=e.type;switch(e.tag){case 24:return"Cache";case 9:return(a.displayName||"Context")+".Consumer";case 10:return(a._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return e=a.render,e=e.displayName||e.name||"",a.displayName||(e!==""?"ForwardRef("+e+")":"ForwardRef");case 7:return"Fragment";case 5:return a;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return te(a);case 8:return a===P?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof a=="function")return a.displayName||a.name||null;if(typeof a=="string")return a}return null}function ie(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function pe(e){var a=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(a==="checkbox"||a==="radio")}function ea(e){var a=pe(e)?"checked":"value",r=Object.getOwnPropertyDescriptor(e.constructor.prototype,a),t=""+e[a];if(!e.hasOwnProperty(a)&&typeof r<"u"&&typeof r.get=="function"&&typeof r.set=="function"){var n=r.get,s=r.set;return Object.defineProperty(e,a,{configurable:!0,get:function(){return n.call(this)},set:function(d){t=""+d,s.call(this,d)}}),Object.defineProperty(e,a,{enumerable:r.enumerable}),{getValue:function(){return t},setValue:function(d){t=""+d},stopTracking:function(){e._valueTracker=null,delete e[a]}}}}function Ko(e){e._valueTracker||(e._valueTracker=ea(e))}function Ii(e){if(!e)return!1;var a=e._valueTracker;if(!a)return!0;var r=a.getValue(),t="";return e&&(t=pe(e)?e.checked?"true":"false":e.value),e=t,e!==r?(a.setValue(e),!0):!1}function Zo(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function yn(e,a){var r=a.checked;return O({},a,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:r??e._wrapperState.initialChecked})}function Ei(e,a){var r=a.defaultValue==null?"":a.defaultValue,t=a.checked!=null?a.checked:a.defaultChecked;r=ie(a.value!=null?a.value:r),e._wrapperState={initialChecked:t,initialValue:r,controlled:a.type==="checkbox"||a.type==="radio"?a.checked!=null:a.value!=null}}function Ti(e,a){a=a.checked,a!=null&&$e(e,"checked",a,!1)}function Cn(e,a){Ti(e,a);var r=ie(a.value),t=a.type;if(r!=null)t==="number"?(r===0&&e.value===""||e.value!=r)&&(e.value=""+r):e.value!==""+r&&(e.value=""+r);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}a.hasOwnProperty("value")?Sn(e,a.type,r):a.hasOwnProperty("defaultValue")&&Sn(e,a.type,ie(a.defaultValue)),a.checked==null&&a.defaultChecked!=null&&(e.defaultChecked=!!a.defaultChecked)}function Di(e,a,r){if(a.hasOwnProperty("value")||a.hasOwnProperty("defaultValue")){var t=a.type;if(!(t!=="submit"&&t!=="reset"||a.value!==void 0&&a.value!==null))return;a=""+e._wrapperState.initialValue,r||a===e.value||(e.value=a),e.defaultValue=a}r=e.name,r!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,r!==""&&(e.name=r)}function Sn(e,a,r){(a!=="number"||Zo(e.ownerDocument)!==e)&&(r==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+r&&(e.defaultValue=""+r))}var ro=Array.isArray;function jr(e,a,r,t){if(e=e.options,a){a={};for(var n=0;n<r.length;n++)a["$"+r[n]]=!0;for(r=0;r<e.length;r++)n=a.hasOwnProperty("$"+e[r].value),e[r].selected!==n&&(e[r].selected=n),n&&t&&(e[r].defaultSelected=!0)}else{for(r=""+ie(r),a=null,n=0;n<e.length;n++){if(e[n].value===r){e[n].selected=!0,t&&(e[n].defaultSelected=!0);return}a!==null||e[n].disabled||(a=e[n])}a!==null&&(a.selected=!0)}}function An(e,a){if(a.dangerouslySetInnerHTML!=null)throw Error(c(91));return O({},a,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function Ri(e,a){var r=a.value;if(r==null){if(r=a.children,a=a.defaultValue,r!=null){if(a!=null)throw Error(c(92));if(ro(r)){if(1<r.length)throw Error(c(93));r=r[0]}a=r}a==null&&(a=""),r=a}e._wrapperState={initialValue:ie(r)}}function Li(e,a){var r=ie(a.value),t=ie(a.defaultValue);r!=null&&(r=""+r,r!==e.value&&(e.value=r),a.defaultValue==null&&e.defaultValue!==r&&(e.defaultValue=r)),t!=null&&(e.defaultValue=""+t)}function Oi(e){var a=e.textContent;a===e._wrapperState.initialValue&&a!==""&&a!==null&&(e.value=a)}function qi(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function kn(e,a){return e==null||e==="http://www.w3.org/1999/xhtml"?qi(a):e==="http://www.w3.org/2000/svg"&&a==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Xo,Mi=(function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(a,r,t,n){MSApp.execUnsafeLocalFunction(function(){return e(a,r,t,n)})}:e})(function(e,a){if(e.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in e)e.innerHTML=a;else{for(Xo=Xo||document.createElement("div"),Xo.innerHTML="<svg>"+a.valueOf().toString()+"</svg>",a=Xo.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;a.firstChild;)e.appendChild(a.firstChild)}});function oo(e,a){if(a){var r=e.firstChild;if(r&&r===e.lastChild&&r.nodeType===3){r.nodeValue=a;return}}e.textContent=a}var to={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Pu=["Webkit","ms","Moz","O"];Object.keys(to).forEach(function(e){Pu.forEach(function(a){a=a+e.charAt(0).toUpperCase()+e.substring(1),to[a]=to[e]})});function Vi(e,a,r){return a==null||typeof a=="boolean"||a===""?"":r||typeof a!="number"||a===0||to.hasOwnProperty(e)&&to[e]?(""+a).trim():a+"px"}function Bi(e,a){e=e.style;for(var r in a)if(a.hasOwnProperty(r)){var t=r.indexOf("--")===0,n=Vi(r,a[r],t);r==="float"&&(r="cssFloat"),t?e.setProperty(r,n):e[r]=n}}var Nu=O({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function Pn(e,a){if(a){if(Nu[e]&&(a.children!=null||a.dangerouslySetInnerHTML!=null))throw Error(c(137,e));if(a.dangerouslySetInnerHTML!=null){if(a.children!=null)throw Error(c(60));if(typeof a.dangerouslySetInnerHTML!="object"||!("__html"in a.dangerouslySetInnerHTML))throw Error(c(61))}if(a.style!=null&&typeof a.style!="object")throw Error(c(62))}}function Nn(e,a){if(e.indexOf("-")===-1)return typeof a.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var jn=null;function wn(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var zn=null,wr=null,zr=null;function $i(e){if(e=jo(e)){if(typeof zn!="function")throw Error(c(280));var a=e.stateNode;a&&(a=Ct(a),zn(e.stateNode,e.type,a))}}function Hi(e){wr?zr?zr.push(e):zr=[e]:wr=e}function _i(){if(wr){var e=wr,a=zr;if(zr=wr=null,$i(e),a)for(e=0;e<a.length;e++)$i(a[e])}}function Ui(e,a){return e(a)}function Fi(){}var In=!1;function Wi(e,a,r){if(In)return e(a,r);In=!0;try{return Ui(e,a,r)}finally{In=!1,(wr!==null||zr!==null)&&(Fi(),_i())}}function no(e,a){var r=e.stateNode;if(r===null)return null;var t=Ct(r);if(t===null)return null;r=t[a];e:switch(a){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(r&&typeof r!="function")throw Error(c(231,a,typeof r));return r}var En=!1;if(b)try{var so={};Object.defineProperty(so,"passive",{get:function(){En=!0}}),window.addEventListener("test",so,so),window.removeEventListener("test",so,so)}catch{En=!1}function ju(e,a,r,t,n,s,d,p,h){var S=Array.prototype.slice.call(arguments,3);try{a.apply(r,S)}catch(w){this.onError(w)}}var io=!1,Jo=null,et=!1,Tn=null,wu={onError:function(e){io=!0,Jo=e}};function zu(e,a,r,t,n,s,d,p,h){io=!1,Jo=null,ju.apply(wu,arguments)}function Iu(e,a,r,t,n,s,d,p,h){if(zu.apply(this,arguments),io){if(io){var S=Jo;io=!1,Jo=null}else throw Error(c(198));et||(et=!0,Tn=S)}}function lr(e){var a=e,r=e;if(e.alternate)for(;a.return;)a=a.return;else{e=a;do a=e,(a.flags&4098)!==0&&(r=a.return),e=a.return;while(e)}return a.tag===3?r:null}function Gi(e){if(e.tag===13){var a=e.memoizedState;if(a===null&&(e=e.alternate,e!==null&&(a=e.memoizedState)),a!==null)return a.dehydrated}return null}function Qi(e){if(lr(e)!==e)throw Error(c(188))}function Eu(e){var a=e.alternate;if(!a){if(a=lr(e),a===null)throw Error(c(188));return a!==e?null:e}for(var r=e,t=a;;){var n=r.return;if(n===null)break;var s=n.alternate;if(s===null){if(t=n.return,t!==null){r=t;continue}break}if(n.child===s.child){for(s=n.child;s;){if(s===r)return Qi(n),e;if(s===t)return Qi(n),a;s=s.sibling}throw Error(c(188))}if(r.return!==t.return)r=n,t=s;else{for(var d=!1,p=n.child;p;){if(p===r){d=!0,r=n,t=s;break}if(p===t){d=!0,t=n,r=s;break}p=p.sibling}if(!d){for(p=s.child;p;){if(p===r){d=!0,r=s,t=n;break}if(p===t){d=!0,t=s,r=n;break}p=p.sibling}if(!d)throw Error(c(189))}}if(r.alternate!==t)throw Error(c(190))}if(r.tag!==3)throw Error(c(188));return r.stateNode.current===r?e:a}function Yi(e){return e=Eu(e),e!==null?Ki(e):null}function Ki(e){if(e.tag===5||e.tag===6)return e;for(e=e.child;e!==null;){var a=Ki(e);if(a!==null)return a;e=e.sibling}return null}var Zi=l.unstable_scheduleCallback,Xi=l.unstable_cancelCallback,Tu=l.unstable_shouldYield,Du=l.unstable_requestPaint,ye=l.unstable_now,Ru=l.unstable_getCurrentPriorityLevel,Dn=l.unstable_ImmediatePriority,Ji=l.unstable_UserBlockingPriority,at=l.unstable_NormalPriority,Lu=l.unstable_LowPriority,el=l.unstable_IdlePriority,rt=null,ja=null;function Ou(e){if(ja&&typeof ja.onCommitFiberRoot=="function")try{ja.onCommitFiberRoot(rt,e,void 0,(e.current.flags&128)===128)}catch{}}var ba=Math.clz32?Math.clz32:Vu,qu=Math.log,Mu=Math.LN2;function Vu(e){return e>>>=0,e===0?32:31-(qu(e)/Mu|0)|0}var ot=64,tt=4194304;function lo(e){switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return e&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return e}}function nt(e,a){var r=e.pendingLanes;if(r===0)return 0;var t=0,n=e.suspendedLanes,s=e.pingedLanes,d=r&268435455;if(d!==0){var p=d&~n;p!==0?t=lo(p):(s&=d,s!==0&&(t=lo(s)))}else d=r&~n,d!==0?t=lo(d):s!==0&&(t=lo(s));if(t===0)return 0;if(a!==0&&a!==t&&(a&n)===0&&(n=t&-t,s=a&-a,n>=s||n===16&&(s&4194240)!==0))return a;if((t&4)!==0&&(t|=r&16),a=e.entangledLanes,a!==0)for(e=e.entanglements,a&=t;0<a;)r=31-ba(a),n=1<<r,t|=e[r],a&=~n;return t}function Bu(e,a){switch(e){case 1:case 2:case 4:return a+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return a+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function $u(e,a){for(var r=e.suspendedLanes,t=e.pingedLanes,n=e.expirationTimes,s=e.pendingLanes;0<s;){var d=31-ba(s),p=1<<d,h=n[d];h===-1?((p&r)===0||(p&t)!==0)&&(n[d]=Bu(p,a)):h<=a&&(e.expiredLanes|=p),s&=~p}}function Rn(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function al(){var e=ot;return ot<<=1,(ot&4194240)===0&&(ot=64),e}function Ln(e){for(var a=[],r=0;31>r;r++)a.push(e);return a}function co(e,a,r){e.pendingLanes|=a,a!==536870912&&(e.suspendedLanes=0,e.pingedLanes=0),e=e.eventTimes,a=31-ba(a),e[a]=r}function Hu(e,a){var r=e.pendingLanes&~a;e.pendingLanes=a,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=a,e.mutableReadLanes&=a,e.entangledLanes&=a,a=e.entanglements;var t=e.eventTimes;for(e=e.expirationTimes;0<r;){var n=31-ba(r),s=1<<n;a[n]=0,t[n]=-1,e[n]=-1,r&=~s}}function On(e,a){var r=e.entangledLanes|=a;for(e=e.entanglements;r;){var t=31-ba(r),n=1<<t;n&a|e[t]&a&&(e[t]|=a),r&=~n}}var le=0;function rl(e){return e&=-e,1<e?4<e?(e&268435455)!==0?16:536870912:4:1}var ol,qn,tl,nl,sl,Mn=!1,st=[],$a=null,Ha=null,_a=null,uo=new Map,mo=new Map,Ua=[],_u="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function il(e,a){switch(e){case"focusin":case"focusout":$a=null;break;case"dragenter":case"dragleave":Ha=null;break;case"mouseover":case"mouseout":_a=null;break;case"pointerover":case"pointerout":uo.delete(a.pointerId);break;case"gotpointercapture":case"lostpointercapture":mo.delete(a.pointerId)}}function po(e,a,r,t,n,s){return e===null||e.nativeEvent!==s?(e={blockedOn:a,domEventName:r,eventSystemFlags:t,nativeEvent:s,targetContainers:[n]},a!==null&&(a=jo(a),a!==null&&qn(a)),e):(e.eventSystemFlags|=t,a=e.targetContainers,n!==null&&a.indexOf(n)===-1&&a.push(n),e)}function Uu(e,a,r,t,n){switch(a){case"focusin":return $a=po($a,e,a,r,t,n),!0;case"dragenter":return Ha=po(Ha,e,a,r,t,n),!0;case"mouseover":return _a=po(_a,e,a,r,t,n),!0;case"pointerover":var s=n.pointerId;return uo.set(s,po(uo.get(s)||null,e,a,r,t,n)),!0;case"gotpointercapture":return s=n.pointerId,mo.set(s,po(mo.get(s)||null,e,a,r,t,n)),!0}return!1}function ll(e){var a=cr(e.target);if(a!==null){var r=lr(a);if(r!==null){if(a=r.tag,a===13){if(a=Gi(r),a!==null){e.blockedOn=a,sl(e.priority,function(){tl(r)});return}}else if(a===3&&r.stateNode.current.memoizedState.isDehydrated){e.blockedOn=r.tag===3?r.stateNode.containerInfo:null;return}}}e.blockedOn=null}function it(e){if(e.blockedOn!==null)return!1;for(var a=e.targetContainers;0<a.length;){var r=Bn(e.domEventName,e.eventSystemFlags,a[0],e.nativeEvent);if(r===null){r=e.nativeEvent;var t=new r.constructor(r.type,r);jn=t,r.target.dispatchEvent(t),jn=null}else return a=jo(r),a!==null&&qn(a),e.blockedOn=r,!1;a.shift()}return!0}function cl(e,a,r){it(e)&&r.delete(a)}function Fu(){Mn=!1,$a!==null&&it($a)&&($a=null),Ha!==null&&it(Ha)&&(Ha=null),_a!==null&&it(_a)&&(_a=null),uo.forEach(cl),mo.forEach(cl)}function fo(e,a){e.blockedOn===a&&(e.blockedOn=null,Mn||(Mn=!0,l.unstable_scheduleCallback(l.unstable_NormalPriority,Fu)))}function go(e){function a(n){return fo(n,e)}if(0<st.length){fo(st[0],e);for(var r=1;r<st.length;r++){var t=st[r];t.blockedOn===e&&(t.blockedOn=null)}}for($a!==null&&fo($a,e),Ha!==null&&fo(Ha,e),_a!==null&&fo(_a,e),uo.forEach(a),mo.forEach(a),r=0;r<Ua.length;r++)t=Ua[r],t.blockedOn===e&&(t.blockedOn=null);for(;0<Ua.length&&(r=Ua[0],r.blockedOn===null);)ll(r),r.blockedOn===null&&Ua.shift()}var Ir=be.ReactCurrentBatchConfig,lt=!0;function Wu(e,a,r,t){var n=le,s=Ir.transition;Ir.transition=null;try{le=1,Vn(e,a,r,t)}finally{le=n,Ir.transition=s}}function Gu(e,a,r,t){var n=le,s=Ir.transition;Ir.transition=null;try{le=4,Vn(e,a,r,t)}finally{le=n,Ir.transition=s}}function Vn(e,a,r,t){if(lt){var n=Bn(e,a,r,t);if(n===null)os(e,a,t,ct,r),il(e,t);else if(Uu(n,e,a,r,t))t.stopPropagation();else if(il(e,t),a&4&&-1<_u.indexOf(e)){for(;n!==null;){var s=jo(n);if(s!==null&&ol(s),s=Bn(e,a,r,t),s===null&&os(e,a,t,ct,r),s===n)break;n=s}n!==null&&t.stopPropagation()}else os(e,a,t,null,r)}}var ct=null;function Bn(e,a,r,t){if(ct=null,e=wn(t),e=cr(e),e!==null)if(a=lr(e),a===null)e=null;else if(r=a.tag,r===13){if(e=Gi(a),e!==null)return e;e=null}else if(r===3){if(a.stateNode.current.memoizedState.isDehydrated)return a.tag===3?a.stateNode.containerInfo:null;e=null}else a!==e&&(e=null);return ct=e,null}function dl(e){switch(e){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(Ru()){case Dn:return 1;case Ji:return 4;case at:case Lu:return 16;case el:return 536870912;default:return 16}default:return 16}}var Fa=null,$n=null,dt=null;function ul(){if(dt)return dt;var e,a=$n,r=a.length,t,n="value"in Fa?Fa.value:Fa.textContent,s=n.length;for(e=0;e<r&&a[e]===n[e];e++);var d=r-e;for(t=1;t<=d&&a[r-t]===n[s-t];t++);return dt=n.slice(e,1<t?1-t:void 0)}function ut(e){var a=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&a===13&&(e=13)):e=a,e===10&&(e=13),32<=e||e===13?e:0}function mt(){return!0}function ml(){return!1}function aa(e){function a(r,t,n,s,d){this._reactName=r,this._targetInst=n,this.type=t,this.nativeEvent=s,this.target=d,this.currentTarget=null;for(var p in e)e.hasOwnProperty(p)&&(r=e[p],this[p]=r?r(s):s[p]);return this.isDefaultPrevented=(s.defaultPrevented!=null?s.defaultPrevented:s.returnValue===!1)?mt:ml,this.isPropagationStopped=ml,this}return O(a.prototype,{preventDefault:function(){this.defaultPrevented=!0;var r=this.nativeEvent;r&&(r.preventDefault?r.preventDefault():typeof r.returnValue!="unknown"&&(r.returnValue=!1),this.isDefaultPrevented=mt)},stopPropagation:function(){var r=this.nativeEvent;r&&(r.stopPropagation?r.stopPropagation():typeof r.cancelBubble!="unknown"&&(r.cancelBubble=!0),this.isPropagationStopped=mt)},persist:function(){},isPersistent:mt}),a}var Er={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Hn=aa(Er),ho=O({},Er,{view:0,detail:0}),Qu=aa(ho),_n,Un,bo,pt=O({},ho,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Wn,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==bo&&(bo&&e.type==="mousemove"?(_n=e.screenX-bo.screenX,Un=e.screenY-bo.screenY):Un=_n=0,bo=e),_n)},movementY:function(e){return"movementY"in e?e.movementY:Un}}),pl=aa(pt),Yu=O({},pt,{dataTransfer:0}),Ku=aa(Yu),Zu=O({},ho,{relatedTarget:0}),Fn=aa(Zu),Xu=O({},Er,{animationName:0,elapsedTime:0,pseudoElement:0}),Ju=aa(Xu),em=O({},Er,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),am=aa(em),rm=O({},Er,{data:0}),fl=aa(rm),om={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},tm={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},nm={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function sm(e){var a=this.nativeEvent;return a.getModifierState?a.getModifierState(e):(e=nm[e])?!!a[e]:!1}function Wn(){return sm}var im=O({},ho,{key:function(e){if(e.key){var a=om[e.key]||e.key;if(a!=="Unidentified")return a}return e.type==="keypress"?(e=ut(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?tm[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Wn,charCode:function(e){return e.type==="keypress"?ut(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?ut(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),lm=aa(im),cm=O({},pt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),gl=aa(cm),dm=O({},ho,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Wn}),um=aa(dm),mm=O({},Er,{propertyName:0,elapsedTime:0,pseudoElement:0}),pm=aa(mm),fm=O({},pt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),gm=aa(fm),hm=[9,13,27,32],Gn=b&&"CompositionEvent"in window,vo=null;b&&"documentMode"in document&&(vo=document.documentMode);var bm=b&&"TextEvent"in window&&!vo,hl=b&&(!Gn||vo&&8<vo&&11>=vo),bl=" ",vl=!1;function xl(e,a){switch(e){case"keyup":return hm.indexOf(a.keyCode)!==-1;case"keydown":return a.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function yl(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Tr=!1;function vm(e,a){switch(e){case"compositionend":return yl(a);case"keypress":return a.which!==32?null:(vl=!0,bl);case"textInput":return e=a.data,e===bl&&vl?null:e;default:return null}}function xm(e,a){if(Tr)return e==="compositionend"||!Gn&&xl(e,a)?(e=ul(),dt=$n=Fa=null,Tr=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(a.ctrlKey||a.altKey||a.metaKey)||a.ctrlKey&&a.altKey){if(a.char&&1<a.char.length)return a.char;if(a.which)return String.fromCharCode(a.which)}return null;case"compositionend":return hl&&a.locale!=="ko"?null:a.data;default:return null}}var ym={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Cl(e){var a=e&&e.nodeName&&e.nodeName.toLowerCase();return a==="input"?!!ym[e.type]:a==="textarea"}function Sl(e,a,r,t){Hi(t),a=vt(a,"onChange"),0<a.length&&(r=new Hn("onChange","change",null,r,t),e.push({event:r,listeners:a}))}var xo=null,yo=null;function Cm(e){Bl(e,0)}function ft(e){var a=qr(e);if(Ii(a))return e}function Sm(e,a){if(e==="change")return a}var Al=!1;if(b){var Qn;if(b){var Yn="oninput"in document;if(!Yn){var kl=document.createElement("div");kl.setAttribute("oninput","return;"),Yn=typeof kl.oninput=="function"}Qn=Yn}else Qn=!1;Al=Qn&&(!document.documentMode||9<document.documentMode)}function Pl(){xo&&(xo.detachEvent("onpropertychange",Nl),yo=xo=null)}function Nl(e){if(e.propertyName==="value"&&ft(yo)){var a=[];Sl(a,yo,e,wn(e)),Wi(Cm,a)}}function Am(e,a,r){e==="focusin"?(Pl(),xo=a,yo=r,xo.attachEvent("onpropertychange",Nl)):e==="focusout"&&Pl()}function km(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return ft(yo)}function Pm(e,a){if(e==="click")return ft(a)}function Nm(e,a){if(e==="input"||e==="change")return ft(a)}function jm(e,a){return e===a&&(e!==0||1/e===1/a)||e!==e&&a!==a}var va=typeof Object.is=="function"?Object.is:jm;function Co(e,a){if(va(e,a))return!0;if(typeof e!="object"||e===null||typeof a!="object"||a===null)return!1;var r=Object.keys(e),t=Object.keys(a);if(r.length!==t.length)return!1;for(t=0;t<r.length;t++){var n=r[t];if(!k.call(a,n)||!va(e[n],a[n]))return!1}return!0}function jl(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function wl(e,a){var r=jl(e);e=0;for(var t;r;){if(r.nodeType===3){if(t=e+r.textContent.length,e<=a&&t>=a)return{node:r,offset:a-e};e=t}e:{for(;r;){if(r.nextSibling){r=r.nextSibling;break e}r=r.parentNode}r=void 0}r=jl(r)}}function zl(e,a){return e&&a?e===a?!0:e&&e.nodeType===3?!1:a&&a.nodeType===3?zl(e,a.parentNode):"contains"in e?e.contains(a):e.compareDocumentPosition?!!(e.compareDocumentPosition(a)&16):!1:!1}function Il(){for(var e=window,a=Zo();a instanceof e.HTMLIFrameElement;){try{var r=typeof a.contentWindow.location.href=="string"}catch{r=!1}if(r)e=a.contentWindow;else break;a=Zo(e.document)}return a}function Kn(e){var a=e&&e.nodeName&&e.nodeName.toLowerCase();return a&&(a==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||a==="textarea"||e.contentEditable==="true")}function wm(e){var a=Il(),r=e.focusedElem,t=e.selectionRange;if(a!==r&&r&&r.ownerDocument&&zl(r.ownerDocument.documentElement,r)){if(t!==null&&Kn(r)){if(a=t.start,e=t.end,e===void 0&&(e=a),"selectionStart"in r)r.selectionStart=a,r.selectionEnd=Math.min(e,r.value.length);else if(e=(a=r.ownerDocument||document)&&a.defaultView||window,e.getSelection){e=e.getSelection();var n=r.textContent.length,s=Math.min(t.start,n);t=t.end===void 0?s:Math.min(t.end,n),!e.extend&&s>t&&(n=t,t=s,s=n),n=wl(r,s);var d=wl(r,t);n&&d&&(e.rangeCount!==1||e.anchorNode!==n.node||e.anchorOffset!==n.offset||e.focusNode!==d.node||e.focusOffset!==d.offset)&&(a=a.createRange(),a.setStart(n.node,n.offset),e.removeAllRanges(),s>t?(e.addRange(a),e.extend(d.node,d.offset)):(a.setEnd(d.node,d.offset),e.addRange(a)))}}for(a=[],e=r;e=e.parentNode;)e.nodeType===1&&a.push({element:e,left:e.scrollLeft,top:e.scrollTop});for(typeof r.focus=="function"&&r.focus(),r=0;r<a.length;r++)e=a[r],e.element.scrollLeft=e.left,e.element.scrollTop=e.top}}var zm=b&&"documentMode"in document&&11>=document.documentMode,Dr=null,Zn=null,So=null,Xn=!1;function El(e,a,r){var t=r.window===r?r.document:r.nodeType===9?r:r.ownerDocument;Xn||Dr==null||Dr!==Zo(t)||(t=Dr,"selectionStart"in t&&Kn(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),So&&Co(So,t)||(So=t,t=vt(Zn,"onSelect"),0<t.length&&(a=new Hn("onSelect","select",null,a,r),e.push({event:a,listeners:t}),a.target=Dr)))}function gt(e,a){var r={};return r[e.toLowerCase()]=a.toLowerCase(),r["Webkit"+e]="webkit"+a,r["Moz"+e]="moz"+a,r}var Rr={animationend:gt("Animation","AnimationEnd"),animationiteration:gt("Animation","AnimationIteration"),animationstart:gt("Animation","AnimationStart"),transitionend:gt("Transition","TransitionEnd")},Jn={},Tl={};b&&(Tl=document.createElement("div").style,"AnimationEvent"in window||(delete Rr.animationend.animation,delete Rr.animationiteration.animation,delete Rr.animationstart.animation),"TransitionEvent"in window||delete Rr.transitionend.transition);function ht(e){if(Jn[e])return Jn[e];if(!Rr[e])return e;var a=Rr[e],r;for(r in a)if(a.hasOwnProperty(r)&&r in Tl)return Jn[e]=a[r];return e}var Dl=ht("animationend"),Rl=ht("animationiteration"),Ll=ht("animationstart"),Ol=ht("transitionend"),ql=new Map,Ml="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function Wa(e,a){ql.set(e,a),f(a,[e])}for(var es=0;es<Ml.length;es++){var as=Ml[es],Im=as.toLowerCase(),Em=as[0].toUpperCase()+as.slice(1);Wa(Im,"on"+Em)}Wa(Dl,"onAnimationEnd"),Wa(Rl,"onAnimationIteration"),Wa(Ll,"onAnimationStart"),Wa("dblclick","onDoubleClick"),Wa("focusin","onFocus"),Wa("focusout","onBlur"),Wa(Ol,"onTransitionEnd"),g("onMouseEnter",["mouseout","mouseover"]),g("onMouseLeave",["mouseout","mouseover"]),g("onPointerEnter",["pointerout","pointerover"]),g("onPointerLeave",["pointerout","pointerover"]),f("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),f("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),f("onBeforeInput",["compositionend","keypress","textInput","paste"]),f("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),f("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),f("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Ao="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Tm=new Set("cancel close invalid load scroll toggle".split(" ").concat(Ao));function Vl(e,a,r){var t=e.type||"unknown-event";e.currentTarget=r,Iu(t,a,void 0,e),e.currentTarget=null}function Bl(e,a){a=(a&4)!==0;for(var r=0;r<e.length;r++){var t=e[r],n=t.event;t=t.listeners;e:{var s=void 0;if(a)for(var d=t.length-1;0<=d;d--){var p=t[d],h=p.instance,S=p.currentTarget;if(p=p.listener,h!==s&&n.isPropagationStopped())break e;Vl(n,p,S),s=h}else for(d=0;d<t.length;d++){if(p=t[d],h=p.instance,S=p.currentTarget,p=p.listener,h!==s&&n.isPropagationStopped())break e;Vl(n,p,S),s=h}}}if(et)throw e=Tn,et=!1,Tn=null,e}function ue(e,a){var r=a[cs];r===void 0&&(r=a[cs]=new Set);var t=e+"__bubble";r.has(t)||($l(a,e,2,!1),r.add(t))}function rs(e,a,r){var t=0;a&&(t|=4),$l(r,e,t,a)}var bt="_reactListening"+Math.random().toString(36).slice(2);function ko(e){if(!e[bt]){e[bt]=!0,m.forEach(function(r){r!=="selectionchange"&&(Tm.has(r)||rs(r,!1,e),rs(r,!0,e))});var a=e.nodeType===9?e:e.ownerDocument;a===null||a[bt]||(a[bt]=!0,rs("selectionchange",!1,a))}}function $l(e,a,r,t){switch(dl(a)){case 1:var n=Wu;break;case 4:n=Gu;break;default:n=Vn}r=n.bind(null,a,r,e),n=void 0,!En||a!=="touchstart"&&a!=="touchmove"&&a!=="wheel"||(n=!0),t?n!==void 0?e.addEventListener(a,r,{capture:!0,passive:n}):e.addEventListener(a,r,!0):n!==void 0?e.addEventListener(a,r,{passive:n}):e.addEventListener(a,r,!1)}function os(e,a,r,t,n){var s=t;if((a&1)===0&&(a&2)===0&&t!==null)e:for(;;){if(t===null)return;var d=t.tag;if(d===3||d===4){var p=t.stateNode.containerInfo;if(p===n||p.nodeType===8&&p.parentNode===n)break;if(d===4)for(d=t.return;d!==null;){var h=d.tag;if((h===3||h===4)&&(h=d.stateNode.containerInfo,h===n||h.nodeType===8&&h.parentNode===n))return;d=d.return}for(;p!==null;){if(d=cr(p),d===null)return;if(h=d.tag,h===5||h===6){t=s=d;continue e}p=p.parentNode}}t=t.return}Wi(function(){var S=s,w=wn(r),z=[];e:{var N=ql.get(e);if(N!==void 0){var D=Hn,q=e;switch(e){case"keypress":if(ut(r)===0)break e;case"keydown":case"keyup":D=lm;break;case"focusin":q="focus",D=Fn;break;case"focusout":q="blur",D=Fn;break;case"beforeblur":case"afterblur":D=Fn;break;case"click":if(r.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":D=pl;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":D=Ku;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":D=um;break;case Dl:case Rl:case Ll:D=Ju;break;case Ol:D=pm;break;case"scroll":D=Qu;break;case"wheel":D=gm;break;case"copy":case"cut":case"paste":D=am;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":D=gl}var M=(a&4)!==0,Ce=!M&&e==="scroll",y=M?N!==null?N+"Capture":null:N;M=[];for(var v=S,C;v!==null;){C=v;var I=C.stateNode;if(C.tag===5&&I!==null&&(C=I,y!==null&&(I=no(v,y),I!=null&&M.push(Po(v,I,C)))),Ce)break;v=v.return}0<M.length&&(N=new D(N,q,null,r,w),z.push({event:N,listeners:M}))}}if((a&7)===0){e:{if(N=e==="mouseover"||e==="pointerover",D=e==="mouseout"||e==="pointerout",N&&r!==jn&&(q=r.relatedTarget||r.fromElement)&&(cr(q)||q[Da]))break e;if((D||N)&&(N=w.window===w?w:(N=w.ownerDocument)?N.defaultView||N.parentWindow:window,D?(q=r.relatedTarget||r.toElement,D=S,q=q?cr(q):null,q!==null&&(Ce=lr(q),q!==Ce||q.tag!==5&&q.tag!==6)&&(q=null)):(D=null,q=S),D!==q)){if(M=pl,I="onMouseLeave",y="onMouseEnter",v="mouse",(e==="pointerout"||e==="pointerover")&&(M=gl,I="onPointerLeave",y="onPointerEnter",v="pointer"),Ce=D==null?N:qr(D),C=q==null?N:qr(q),N=new M(I,v+"leave",D,r,w),N.target=Ce,N.relatedTarget=C,I=null,cr(w)===S&&(M=new M(y,v+"enter",q,r,w),M.target=C,M.relatedTarget=Ce,I=M),Ce=I,D&&q)a:{for(M=D,y=q,v=0,C=M;C;C=Lr(C))v++;for(C=0,I=y;I;I=Lr(I))C++;for(;0<v-C;)M=Lr(M),v--;for(;0<C-v;)y=Lr(y),C--;for(;v--;){if(M===y||y!==null&&M===y.alternate)break a;M=Lr(M),y=Lr(y)}M=null}else M=null;D!==null&&Hl(z,N,D,M,!1),q!==null&&Ce!==null&&Hl(z,Ce,q,M,!0)}}e:{if(N=S?qr(S):window,D=N.nodeName&&N.nodeName.toLowerCase(),D==="select"||D==="input"&&N.type==="file")var B=Sm;else if(Cl(N))if(Al)B=Nm;else{B=km;var H=Am}else(D=N.nodeName)&&D.toLowerCase()==="input"&&(N.type==="checkbox"||N.type==="radio")&&(B=Pm);if(B&&(B=B(e,S))){Sl(z,B,r,w);break e}H&&H(e,N,S),e==="focusout"&&(H=N._wrapperState)&&H.controlled&&N.type==="number"&&Sn(N,"number",N.value)}switch(H=S?qr(S):window,e){case"focusin":(Cl(H)||H.contentEditable==="true")&&(Dr=H,Zn=S,So=null);break;case"focusout":So=Zn=Dr=null;break;case"mousedown":Xn=!0;break;case"contextmenu":case"mouseup":case"dragend":Xn=!1,El(z,r,w);break;case"selectionchange":if(zm)break;case"keydown":case"keyup":El(z,r,w)}var _;if(Gn)e:{switch(e){case"compositionstart":var G="onCompositionStart";break e;case"compositionend":G="onCompositionEnd";break e;case"compositionupdate":G="onCompositionUpdate";break e}G=void 0}else Tr?xl(e,r)&&(G="onCompositionEnd"):e==="keydown"&&r.keyCode===229&&(G="onCompositionStart");G&&(hl&&r.locale!=="ko"&&(Tr||G!=="onCompositionStart"?G==="onCompositionEnd"&&Tr&&(_=ul()):(Fa=w,$n="value"in Fa?Fa.value:Fa.textContent,Tr=!0)),H=vt(S,G),0<H.length&&(G=new fl(G,e,null,r,w),z.push({event:G,listeners:H}),_?G.data=_:(_=yl(r),_!==null&&(G.data=_)))),(_=bm?vm(e,r):xm(e,r))&&(S=vt(S,"onBeforeInput"),0<S.length&&(w=new fl("onBeforeInput","beforeinput",null,r,w),z.push({event:w,listeners:S}),w.data=_))}Bl(z,a)})}function Po(e,a,r){return{instance:e,listener:a,currentTarget:r}}function vt(e,a){for(var r=a+"Capture",t=[];e!==null;){var n=e,s=n.stateNode;n.tag===5&&s!==null&&(n=s,s=no(e,r),s!=null&&t.unshift(Po(e,s,n)),s=no(e,a),s!=null&&t.push(Po(e,s,n))),e=e.return}return t}function Lr(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Hl(e,a,r,t,n){for(var s=a._reactName,d=[];r!==null&&r!==t;){var p=r,h=p.alternate,S=p.stateNode;if(h!==null&&h===t)break;p.tag===5&&S!==null&&(p=S,n?(h=no(r,s),h!=null&&d.unshift(Po(r,h,p))):n||(h=no(r,s),h!=null&&d.push(Po(r,h,p)))),r=r.return}d.length!==0&&e.push({event:a,listeners:d})}var Dm=/\r\n?/g,Rm=/\u0000|\uFFFD/g;function _l(e){return(typeof e=="string"?e:""+e).replace(Dm,`
`).replace(Rm,"")}function xt(e,a,r){if(a=_l(a),_l(e)!==a&&r)throw Error(c(425))}function yt(){}var ts=null,ns=null;function ss(e,a){return e==="textarea"||e==="noscript"||typeof a.children=="string"||typeof a.children=="number"||typeof a.dangerouslySetInnerHTML=="object"&&a.dangerouslySetInnerHTML!==null&&a.dangerouslySetInnerHTML.__html!=null}var is=typeof setTimeout=="function"?setTimeout:void 0,Lm=typeof clearTimeout=="function"?clearTimeout:void 0,Ul=typeof Promise=="function"?Promise:void 0,Om=typeof queueMicrotask=="function"?queueMicrotask:typeof Ul<"u"?function(e){return Ul.resolve(null).then(e).catch(qm)}:is;function qm(e){setTimeout(function(){throw e})}function ls(e,a){var r=a,t=0;do{var n=r.nextSibling;if(e.removeChild(r),n&&n.nodeType===8)if(r=n.data,r==="/$"){if(t===0){e.removeChild(n),go(a);return}t--}else r!=="$"&&r!=="$?"&&r!=="$!"||t++;r=n}while(r);go(a)}function Ga(e){for(;e!=null;e=e.nextSibling){var a=e.nodeType;if(a===1||a===3)break;if(a===8){if(a=e.data,a==="$"||a==="$!"||a==="$?")break;if(a==="/$")return null}}return e}function Fl(e){e=e.previousSibling;for(var a=0;e;){if(e.nodeType===8){var r=e.data;if(r==="$"||r==="$!"||r==="$?"){if(a===0)return e;a--}else r==="/$"&&a++}e=e.previousSibling}return null}var Or=Math.random().toString(36).slice(2),wa="__reactFiber$"+Or,No="__reactProps$"+Or,Da="__reactContainer$"+Or,cs="__reactEvents$"+Or,Mm="__reactListeners$"+Or,Vm="__reactHandles$"+Or;function cr(e){var a=e[wa];if(a)return a;for(var r=e.parentNode;r;){if(a=r[Da]||r[wa]){if(r=a.alternate,a.child!==null||r!==null&&r.child!==null)for(e=Fl(e);e!==null;){if(r=e[wa])return r;e=Fl(e)}return a}e=r,r=e.parentNode}return null}function jo(e){return e=e[wa]||e[Da],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function qr(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(c(33))}function Ct(e){return e[No]||null}var ds=[],Mr=-1;function Qa(e){return{current:e}}function me(e){0>Mr||(e.current=ds[Mr],ds[Mr]=null,Mr--)}function de(e,a){Mr++,ds[Mr]=e.current,e.current=a}var Ya={},Le=Qa(Ya),We=Qa(!1),dr=Ya;function Vr(e,a){var r=e.type.contextTypes;if(!r)return Ya;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===a)return t.__reactInternalMemoizedMaskedChildContext;var n={},s;for(s in r)n[s]=a[s];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=a,e.__reactInternalMemoizedMaskedChildContext=n),n}function Ge(e){return e=e.childContextTypes,e!=null}function St(){me(We),me(Le)}function Wl(e,a,r){if(Le.current!==Ya)throw Error(c(168));de(Le,a),de(We,r)}function Gl(e,a,r){var t=e.stateNode;if(a=a.childContextTypes,typeof t.getChildContext!="function")return r;t=t.getChildContext();for(var n in t)if(!(n in a))throw Error(c(108,ce(e)||"Unknown",n));return O({},r,t)}function At(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||Ya,dr=Le.current,de(Le,e),de(We,We.current),!0}function Ql(e,a,r){var t=e.stateNode;if(!t)throw Error(c(169));r?(e=Gl(e,a,dr),t.__reactInternalMemoizedMergedChildContext=e,me(We),me(Le),de(Le,e)):me(We),de(We,r)}var Ra=null,kt=!1,us=!1;function Yl(e){Ra===null?Ra=[e]:Ra.push(e)}function Bm(e){kt=!0,Yl(e)}function Ka(){if(!us&&Ra!==null){us=!0;var e=0,a=le;try{var r=Ra;for(le=1;e<r.length;e++){var t=r[e];do t=t(!0);while(t!==null)}Ra=null,kt=!1}catch(n){throw Ra!==null&&(Ra=Ra.slice(e+1)),Zi(Dn,Ka),n}finally{le=a,us=!1}}return null}var Br=[],$r=0,Pt=null,Nt=0,la=[],ca=0,ur=null,La=1,Oa="";function mr(e,a){Br[$r++]=Nt,Br[$r++]=Pt,Pt=e,Nt=a}function Kl(e,a,r){la[ca++]=La,la[ca++]=Oa,la[ca++]=ur,ur=e;var t=La;e=Oa;var n=32-ba(t)-1;t&=~(1<<n),r+=1;var s=32-ba(a)+n;if(30<s){var d=n-n%5;s=(t&(1<<d)-1).toString(32),t>>=d,n-=d,La=1<<32-ba(a)+n|r<<n|t,Oa=s+e}else La=1<<s|r<<n|t,Oa=e}function ms(e){e.return!==null&&(mr(e,1),Kl(e,1,0))}function ps(e){for(;e===Pt;)Pt=Br[--$r],Br[$r]=null,Nt=Br[--$r],Br[$r]=null;for(;e===ur;)ur=la[--ca],la[ca]=null,Oa=la[--ca],la[ca]=null,La=la[--ca],la[ca]=null}var ra=null,oa=null,fe=!1,xa=null;function Zl(e,a){var r=pa(5,null,null,0);r.elementType="DELETED",r.stateNode=a,r.return=e,a=e.deletions,a===null?(e.deletions=[r],e.flags|=16):a.push(r)}function Xl(e,a){switch(e.tag){case 5:var r=e.type;return a=a.nodeType!==1||r.toLowerCase()!==a.nodeName.toLowerCase()?null:a,a!==null?(e.stateNode=a,ra=e,oa=Ga(a.firstChild),!0):!1;case 6:return a=e.pendingProps===""||a.nodeType!==3?null:a,a!==null?(e.stateNode=a,ra=e,oa=null,!0):!1;case 13:return a=a.nodeType!==8?null:a,a!==null?(r=ur!==null?{id:La,overflow:Oa}:null,e.memoizedState={dehydrated:a,treeContext:r,retryLane:1073741824},r=pa(18,null,null,0),r.stateNode=a,r.return=e,e.child=r,ra=e,oa=null,!0):!1;default:return!1}}function fs(e){return(e.mode&1)!==0&&(e.flags&128)===0}function gs(e){if(fe){var a=oa;if(a){var r=a;if(!Xl(e,a)){if(fs(e))throw Error(c(418));a=Ga(r.nextSibling);var t=ra;a&&Xl(e,a)?Zl(t,r):(e.flags=e.flags&-4097|2,fe=!1,ra=e)}}else{if(fs(e))throw Error(c(418));e.flags=e.flags&-4097|2,fe=!1,ra=e}}}function Jl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;ra=e}function jt(e){if(e!==ra)return!1;if(!fe)return Jl(e),fe=!0,!1;var a;if((a=e.tag!==3)&&!(a=e.tag!==5)&&(a=e.type,a=a!=="head"&&a!=="body"&&!ss(e.type,e.memoizedProps)),a&&(a=oa)){if(fs(e))throw ec(),Error(c(418));for(;a;)Zl(e,a),a=Ga(a.nextSibling)}if(Jl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(c(317));e:{for(e=e.nextSibling,a=0;e;){if(e.nodeType===8){var r=e.data;if(r==="/$"){if(a===0){oa=Ga(e.nextSibling);break e}a--}else r!=="$"&&r!=="$!"&&r!=="$?"||a++}e=e.nextSibling}oa=null}}else oa=ra?Ga(e.stateNode.nextSibling):null;return!0}function ec(){for(var e=oa;e;)e=Ga(e.nextSibling)}function Hr(){oa=ra=null,fe=!1}function hs(e){xa===null?xa=[e]:xa.push(e)}var $m=be.ReactCurrentBatchConfig;function wo(e,a,r){if(e=r.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(r._owner){if(r=r._owner,r){if(r.tag!==1)throw Error(c(309));var t=r.stateNode}if(!t)throw Error(c(147,e));var n=t,s=""+e;return a!==null&&a.ref!==null&&typeof a.ref=="function"&&a.ref._stringRef===s?a.ref:(a=function(d){var p=n.refs;d===null?delete p[s]:p[s]=d},a._stringRef=s,a)}if(typeof e!="string")throw Error(c(284));if(!r._owner)throw Error(c(290,e))}return e}function wt(e,a){throw e=Object.prototype.toString.call(a),Error(c(31,e==="[object Object]"?"object with keys {"+Object.keys(a).join(", ")+"}":e))}function ac(e){var a=e._init;return a(e._payload)}function rc(e){function a(y,v){if(e){var C=y.deletions;C===null?(y.deletions=[v],y.flags|=16):C.push(v)}}function r(y,v){if(!e)return null;for(;v!==null;)a(y,v),v=v.sibling;return null}function t(y,v){for(y=new Map;v!==null;)v.key!==null?y.set(v.key,v):y.set(v.index,v),v=v.sibling;return y}function n(y,v){return y=tr(y,v),y.index=0,y.sibling=null,y}function s(y,v,C){return y.index=C,e?(C=y.alternate,C!==null?(C=C.index,C<v?(y.flags|=2,v):C):(y.flags|=2,v)):(y.flags|=1048576,v)}function d(y){return e&&y.alternate===null&&(y.flags|=2),y}function p(y,v,C,I){return v===null||v.tag!==6?(v=si(C,y.mode,I),v.return=y,v):(v=n(v,C),v.return=y,v)}function h(y,v,C,I){var B=C.type;return B===Re?w(y,v,C.props.children,I,C.key):v!==null&&(v.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===Fe&&ac(B)===v.type)?(I=n(v,C.props),I.ref=wo(y,v,C),I.return=y,I):(I=Xt(C.type,C.key,C.props,null,y.mode,I),I.ref=wo(y,v,C),I.return=y,I)}function S(y,v,C,I){return v===null||v.tag!==4||v.stateNode.containerInfo!==C.containerInfo||v.stateNode.implementation!==C.implementation?(v=ii(C,y.mode,I),v.return=y,v):(v=n(v,C.children||[]),v.return=y,v)}function w(y,v,C,I,B){return v===null||v.tag!==7?(v=yr(C,y.mode,I,B),v.return=y,v):(v=n(v,C),v.return=y,v)}function z(y,v,C){if(typeof v=="string"&&v!==""||typeof v=="number")return v=si(""+v,y.mode,C),v.return=y,v;if(typeof v=="object"&&v!==null){switch(v.$$typeof){case we:return C=Xt(v.type,v.key,v.props,null,y.mode,C),C.ref=wo(y,null,v),C.return=y,C;case se:return v=ii(v,y.mode,C),v.return=y,v;case Fe:var I=v._init;return z(y,I(v._payload),C)}if(ro(v)||F(v))return v=yr(v,y.mode,C,null),v.return=y,v;wt(y,v)}return null}function N(y,v,C,I){var B=v!==null?v.key:null;if(typeof C=="string"&&C!==""||typeof C=="number")return B!==null?null:p(y,v,""+C,I);if(typeof C=="object"&&C!==null){switch(C.$$typeof){case we:return C.key===B?h(y,v,C,I):null;case se:return C.key===B?S(y,v,C,I):null;case Fe:return B=C._init,N(y,v,B(C._payload),I)}if(ro(C)||F(C))return B!==null?null:w(y,v,C,I,null);wt(y,C)}return null}function D(y,v,C,I,B){if(typeof I=="string"&&I!==""||typeof I=="number")return y=y.get(C)||null,p(v,y,""+I,B);if(typeof I=="object"&&I!==null){switch(I.$$typeof){case we:return y=y.get(I.key===null?C:I.key)||null,h(v,y,I,B);case se:return y=y.get(I.key===null?C:I.key)||null,S(v,y,I,B);case Fe:var H=I._init;return D(y,v,C,H(I._payload),B)}if(ro(I)||F(I))return y=y.get(C)||null,w(v,y,I,B,null);wt(v,I)}return null}function q(y,v,C,I){for(var B=null,H=null,_=v,G=v=0,Ee=null;_!==null&&G<C.length;G++){_.index>G?(Ee=_,_=null):Ee=_.sibling;var ne=N(y,_,C[G],I);if(ne===null){_===null&&(_=Ee);break}e&&_&&ne.alternate===null&&a(y,_),v=s(ne,v,G),H===null?B=ne:H.sibling=ne,H=ne,_=Ee}if(G===C.length)return r(y,_),fe&&mr(y,G),B;if(_===null){for(;G<C.length;G++)_=z(y,C[G],I),_!==null&&(v=s(_,v,G),H===null?B=_:H.sibling=_,H=_);return fe&&mr(y,G),B}for(_=t(y,_);G<C.length;G++)Ee=D(_,y,G,C[G],I),Ee!==null&&(e&&Ee.alternate!==null&&_.delete(Ee.key===null?G:Ee.key),v=s(Ee,v,G),H===null?B=Ee:H.sibling=Ee,H=Ee);return e&&_.forEach(function(nr){return a(y,nr)}),fe&&mr(y,G),B}function M(y,v,C,I){var B=F(C);if(typeof B!="function")throw Error(c(150));if(C=B.call(C),C==null)throw Error(c(151));for(var H=B=null,_=v,G=v=0,Ee=null,ne=C.next();_!==null&&!ne.done;G++,ne=C.next()){_.index>G?(Ee=_,_=null):Ee=_.sibling;var nr=N(y,_,ne.value,I);if(nr===null){_===null&&(_=Ee);break}e&&_&&nr.alternate===null&&a(y,_),v=s(nr,v,G),H===null?B=nr:H.sibling=nr,H=nr,_=Ee}if(ne.done)return r(y,_),fe&&mr(y,G),B;if(_===null){for(;!ne.done;G++,ne=C.next())ne=z(y,ne.value,I),ne!==null&&(v=s(ne,v,G),H===null?B=ne:H.sibling=ne,H=ne);return fe&&mr(y,G),B}for(_=t(y,_);!ne.done;G++,ne=C.next())ne=D(_,y,G,ne.value,I),ne!==null&&(e&&ne.alternate!==null&&_.delete(ne.key===null?G:ne.key),v=s(ne,v,G),H===null?B=ne:H.sibling=ne,H=ne);return e&&_.forEach(function(yp){return a(y,yp)}),fe&&mr(y,G),B}function Ce(y,v,C,I){if(typeof C=="object"&&C!==null&&C.type===Re&&C.key===null&&(C=C.props.children),typeof C=="object"&&C!==null){switch(C.$$typeof){case we:e:{for(var B=C.key,H=v;H!==null;){if(H.key===B){if(B=C.type,B===Re){if(H.tag===7){r(y,H.sibling),v=n(H,C.props.children),v.return=y,y=v;break e}}else if(H.elementType===B||typeof B=="object"&&B!==null&&B.$$typeof===Fe&&ac(B)===H.type){r(y,H.sibling),v=n(H,C.props),v.ref=wo(y,H,C),v.return=y,y=v;break e}r(y,H);break}else a(y,H);H=H.sibling}C.type===Re?(v=yr(C.props.children,y.mode,I,C.key),v.return=y,y=v):(I=Xt(C.type,C.key,C.props,null,y.mode,I),I.ref=wo(y,v,C),I.return=y,y=I)}return d(y);case se:e:{for(H=C.key;v!==null;){if(v.key===H)if(v.tag===4&&v.stateNode.containerInfo===C.containerInfo&&v.stateNode.implementation===C.implementation){r(y,v.sibling),v=n(v,C.children||[]),v.return=y,y=v;break e}else{r(y,v);break}else a(y,v);v=v.sibling}v=ii(C,y.mode,I),v.return=y,y=v}return d(y);case Fe:return H=C._init,Ce(y,v,H(C._payload),I)}if(ro(C))return q(y,v,C,I);if(F(C))return M(y,v,C,I);wt(y,C)}return typeof C=="string"&&C!==""||typeof C=="number"?(C=""+C,v!==null&&v.tag===6?(r(y,v.sibling),v=n(v,C),v.return=y,y=v):(r(y,v),v=si(C,y.mode,I),v.return=y,y=v),d(y)):r(y,v)}return Ce}var _r=rc(!0),oc=rc(!1),zt=Qa(null),It=null,Ur=null,bs=null;function vs(){bs=Ur=It=null}function xs(e){var a=zt.current;me(zt),e._currentValue=a}function ys(e,a,r){for(;e!==null;){var t=e.alternate;if((e.childLanes&a)!==a?(e.childLanes|=a,t!==null&&(t.childLanes|=a)):t!==null&&(t.childLanes&a)!==a&&(t.childLanes|=a),e===r)break;e=e.return}}function Fr(e,a){It=e,bs=Ur=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&a)!==0&&(Qe=!0),e.firstContext=null)}function da(e){var a=e._currentValue;if(bs!==e)if(e={context:e,memoizedValue:a,next:null},Ur===null){if(It===null)throw Error(c(308));Ur=e,It.dependencies={lanes:0,firstContext:e}}else Ur=Ur.next=e;return a}var pr=null;function Cs(e){pr===null?pr=[e]:pr.push(e)}function tc(e,a,r,t){var n=a.interleaved;return n===null?(r.next=r,Cs(a)):(r.next=n.next,n.next=r),a.interleaved=r,qa(e,t)}function qa(e,a){e.lanes|=a;var r=e.alternate;for(r!==null&&(r.lanes|=a),r=e,e=e.return;e!==null;)e.childLanes|=a,r=e.alternate,r!==null&&(r.childLanes|=a),r=e,e=e.return;return r.tag===3?r.stateNode:null}var Za=!1;function Ss(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function nc(e,a){e=e.updateQueue,a.updateQueue===e&&(a.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function Ma(e,a){return{eventTime:e,lane:a,tag:0,payload:null,callback:null,next:null}}function Xa(e,a,r){var t=e.updateQueue;if(t===null)return null;if(t=t.shared,(re&2)!==0){var n=t.pending;return n===null?a.next=a:(a.next=n.next,n.next=a),t.pending=a,qa(e,r)}return n=t.interleaved,n===null?(a.next=a,Cs(t)):(a.next=n.next,n.next=a),t.interleaved=a,qa(e,r)}function Et(e,a,r){if(a=a.updateQueue,a!==null&&(a=a.shared,(r&4194240)!==0)){var t=a.lanes;t&=e.pendingLanes,r|=t,a.lanes=r,On(e,r)}}function sc(e,a){var r=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,r===t)){var n=null,s=null;if(r=r.firstBaseUpdate,r!==null){do{var d={eventTime:r.eventTime,lane:r.lane,tag:r.tag,payload:r.payload,callback:r.callback,next:null};s===null?n=s=d:s=s.next=d,r=r.next}while(r!==null);s===null?n=s=a:s=s.next=a}else n=s=a;r={baseState:t.baseState,firstBaseUpdate:n,lastBaseUpdate:s,shared:t.shared,effects:t.effects},e.updateQueue=r;return}e=r.lastBaseUpdate,e===null?r.firstBaseUpdate=a:e.next=a,r.lastBaseUpdate=a}function Tt(e,a,r,t){var n=e.updateQueue;Za=!1;var s=n.firstBaseUpdate,d=n.lastBaseUpdate,p=n.shared.pending;if(p!==null){n.shared.pending=null;var h=p,S=h.next;h.next=null,d===null?s=S:d.next=S,d=h;var w=e.alternate;w!==null&&(w=w.updateQueue,p=w.lastBaseUpdate,p!==d&&(p===null?w.firstBaseUpdate=S:p.next=S,w.lastBaseUpdate=h))}if(s!==null){var z=n.baseState;d=0,w=S=h=null,p=s;do{var N=p.lane,D=p.eventTime;if((t&N)===N){w!==null&&(w=w.next={eventTime:D,lane:0,tag:p.tag,payload:p.payload,callback:p.callback,next:null});e:{var q=e,M=p;switch(N=a,D=r,M.tag){case 1:if(q=M.payload,typeof q=="function"){z=q.call(D,z,N);break e}z=q;break e;case 3:q.flags=q.flags&-65537|128;case 0:if(q=M.payload,N=typeof q=="function"?q.call(D,z,N):q,N==null)break e;z=O({},z,N);break e;case 2:Za=!0}}p.callback!==null&&p.lane!==0&&(e.flags|=64,N=n.effects,N===null?n.effects=[p]:N.push(p))}else D={eventTime:D,lane:N,tag:p.tag,payload:p.payload,callback:p.callback,next:null},w===null?(S=w=D,h=z):w=w.next=D,d|=N;if(p=p.next,p===null){if(p=n.shared.pending,p===null)break;N=p,p=N.next,N.next=null,n.lastBaseUpdate=N,n.shared.pending=null}}while(!0);if(w===null&&(h=z),n.baseState=h,n.firstBaseUpdate=S,n.lastBaseUpdate=w,a=n.shared.interleaved,a!==null){n=a;do d|=n.lane,n=n.next;while(n!==a)}else s===null&&(n.shared.lanes=0);hr|=d,e.lanes=d,e.memoizedState=z}}function ic(e,a,r){if(e=a.effects,a.effects=null,e!==null)for(a=0;a<e.length;a++){var t=e[a],n=t.callback;if(n!==null){if(t.callback=null,t=r,typeof n!="function")throw Error(c(191,n));n.call(t)}}}var zo={},za=Qa(zo),Io=Qa(zo),Eo=Qa(zo);function fr(e){if(e===zo)throw Error(c(174));return e}function As(e,a){switch(de(Eo,a),de(Io,e),de(za,zo),e=a.nodeType,e){case 9:case 11:a=(a=a.documentElement)?a.namespaceURI:kn(null,"");break;default:e=e===8?a.parentNode:a,a=e.namespaceURI||null,e=e.tagName,a=kn(a,e)}me(za),de(za,a)}function Wr(){me(za),me(Io),me(Eo)}function lc(e){fr(Eo.current);var a=fr(za.current),r=kn(a,e.type);a!==r&&(de(Io,e),de(za,r))}function ks(e){Io.current===e&&(me(za),me(Io))}var ge=Qa(0);function Dt(e){for(var a=e;a!==null;){if(a.tag===13){var r=a.memoizedState;if(r!==null&&(r=r.dehydrated,r===null||r.data==="$?"||r.data==="$!"))return a}else if(a.tag===19&&a.memoizedProps.revealOrder!==void 0){if((a.flags&128)!==0)return a}else if(a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return null;a=a.return}a.sibling.return=a.return,a=a.sibling}return null}var Ps=[];function Ns(){for(var e=0;e<Ps.length;e++)Ps[e]._workInProgressVersionPrimary=null;Ps.length=0}var Rt=be.ReactCurrentDispatcher,js=be.ReactCurrentBatchConfig,gr=0,he=null,Ne=null,ze=null,Lt=!1,To=!1,Do=0,Hm=0;function Oe(){throw Error(c(321))}function ws(e,a){if(a===null)return!1;for(var r=0;r<a.length&&r<e.length;r++)if(!va(e[r],a[r]))return!1;return!0}function zs(e,a,r,t,n,s){if(gr=s,he=a,a.memoizedState=null,a.updateQueue=null,a.lanes=0,Rt.current=e===null||e.memoizedState===null?Wm:Gm,e=r(t,n),To){s=0;do{if(To=!1,Do=0,25<=s)throw Error(c(301));s+=1,ze=Ne=null,a.updateQueue=null,Rt.current=Qm,e=r(t,n)}while(To)}if(Rt.current=Mt,a=Ne!==null&&Ne.next!==null,gr=0,ze=Ne=he=null,Lt=!1,a)throw Error(c(300));return e}function Is(){var e=Do!==0;return Do=0,e}function Ia(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return ze===null?he.memoizedState=ze=e:ze=ze.next=e,ze}function ua(){if(Ne===null){var e=he.alternate;e=e!==null?e.memoizedState:null}else e=Ne.next;var a=ze===null?he.memoizedState:ze.next;if(a!==null)ze=a,Ne=e;else{if(e===null)throw Error(c(310));Ne=e,e={memoizedState:Ne.memoizedState,baseState:Ne.baseState,baseQueue:Ne.baseQueue,queue:Ne.queue,next:null},ze===null?he.memoizedState=ze=e:ze=ze.next=e}return ze}function Ro(e,a){return typeof a=="function"?a(e):a}function Es(e){var a=ua(),r=a.queue;if(r===null)throw Error(c(311));r.lastRenderedReducer=e;var t=Ne,n=t.baseQueue,s=r.pending;if(s!==null){if(n!==null){var d=n.next;n.next=s.next,s.next=d}t.baseQueue=n=s,r.pending=null}if(n!==null){s=n.next,t=t.baseState;var p=d=null,h=null,S=s;do{var w=S.lane;if((gr&w)===w)h!==null&&(h=h.next={lane:0,action:S.action,hasEagerState:S.hasEagerState,eagerState:S.eagerState,next:null}),t=S.hasEagerState?S.eagerState:e(t,S.action);else{var z={lane:w,action:S.action,hasEagerState:S.hasEagerState,eagerState:S.eagerState,next:null};h===null?(p=h=z,d=t):h=h.next=z,he.lanes|=w,hr|=w}S=S.next}while(S!==null&&S!==s);h===null?d=t:h.next=p,va(t,a.memoizedState)||(Qe=!0),a.memoizedState=t,a.baseState=d,a.baseQueue=h,r.lastRenderedState=t}if(e=r.interleaved,e!==null){n=e;do s=n.lane,he.lanes|=s,hr|=s,n=n.next;while(n!==e)}else n===null&&(r.lanes=0);return[a.memoizedState,r.dispatch]}function Ts(e){var a=ua(),r=a.queue;if(r===null)throw Error(c(311));r.lastRenderedReducer=e;var t=r.dispatch,n=r.pending,s=a.memoizedState;if(n!==null){r.pending=null;var d=n=n.next;do s=e(s,d.action),d=d.next;while(d!==n);va(s,a.memoizedState)||(Qe=!0),a.memoizedState=s,a.baseQueue===null&&(a.baseState=s),r.lastRenderedState=s}return[s,t]}function cc(){}function dc(e,a){var r=he,t=ua(),n=a(),s=!va(t.memoizedState,n);if(s&&(t.memoizedState=n,Qe=!0),t=t.queue,Ds(pc.bind(null,r,t,e),[e]),t.getSnapshot!==a||s||ze!==null&&ze.memoizedState.tag&1){if(r.flags|=2048,Lo(9,mc.bind(null,r,t,n,a),void 0,null),Ie===null)throw Error(c(349));(gr&30)!==0||uc(r,a,n)}return n}function uc(e,a,r){e.flags|=16384,e={getSnapshot:a,value:r},a=he.updateQueue,a===null?(a={lastEffect:null,stores:null},he.updateQueue=a,a.stores=[e]):(r=a.stores,r===null?a.stores=[e]:r.push(e))}function mc(e,a,r,t){a.value=r,a.getSnapshot=t,fc(a)&&gc(e)}function pc(e,a,r){return r(function(){fc(a)&&gc(e)})}function fc(e){var a=e.getSnapshot;e=e.value;try{var r=a();return!va(e,r)}catch{return!0}}function gc(e){var a=qa(e,1);a!==null&&Aa(a,e,1,-1)}function hc(e){var a=Ia();return typeof e=="function"&&(e=e()),a.memoizedState=a.baseState=e,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Ro,lastRenderedState:e},a.queue=e,e=e.dispatch=Fm.bind(null,he,e),[a.memoizedState,e]}function Lo(e,a,r,t){return e={tag:e,create:a,destroy:r,deps:t,next:null},a=he.updateQueue,a===null?(a={lastEffect:null,stores:null},he.updateQueue=a,a.lastEffect=e.next=e):(r=a.lastEffect,r===null?a.lastEffect=e.next=e:(t=r.next,r.next=e,e.next=t,a.lastEffect=e)),e}function bc(){return ua().memoizedState}function Ot(e,a,r,t){var n=Ia();he.flags|=e,n.memoizedState=Lo(1|a,r,void 0,t===void 0?null:t)}function qt(e,a,r,t){var n=ua();t=t===void 0?null:t;var s=void 0;if(Ne!==null){var d=Ne.memoizedState;if(s=d.destroy,t!==null&&ws(t,d.deps)){n.memoizedState=Lo(a,r,s,t);return}}he.flags|=e,n.memoizedState=Lo(1|a,r,s,t)}function vc(e,a){return Ot(8390656,8,e,a)}function Ds(e,a){return qt(2048,8,e,a)}function xc(e,a){return qt(4,2,e,a)}function yc(e,a){return qt(4,4,e,a)}function Cc(e,a){if(typeof a=="function")return e=e(),a(e),function(){a(null)};if(a!=null)return e=e(),a.current=e,function(){a.current=null}}function Sc(e,a,r){return r=r!=null?r.concat([e]):null,qt(4,4,Cc.bind(null,a,e),r)}function Rs(){}function Ac(e,a){var r=ua();a=a===void 0?null:a;var t=r.memoizedState;return t!==null&&a!==null&&ws(a,t[1])?t[0]:(r.memoizedState=[e,a],e)}function kc(e,a){var r=ua();a=a===void 0?null:a;var t=r.memoizedState;return t!==null&&a!==null&&ws(a,t[1])?t[0]:(e=e(),r.memoizedState=[e,a],e)}function Pc(e,a,r){return(gr&21)===0?(e.baseState&&(e.baseState=!1,Qe=!0),e.memoizedState=r):(va(r,a)||(r=al(),he.lanes|=r,hr|=r,e.baseState=!0),a)}function _m(e,a){var r=le;le=r!==0&&4>r?r:4,e(!0);var t=js.transition;js.transition={};try{e(!1),a()}finally{le=r,js.transition=t}}function Nc(){return ua().memoizedState}function Um(e,a,r){var t=rr(e);if(r={lane:t,action:r,hasEagerState:!1,eagerState:null,next:null},jc(e))wc(a,r);else if(r=tc(e,a,r,t),r!==null){var n=_e();Aa(r,e,t,n),zc(r,a,t)}}function Fm(e,a,r){var t=rr(e),n={lane:t,action:r,hasEagerState:!1,eagerState:null,next:null};if(jc(e))wc(a,n);else{var s=e.alternate;if(e.lanes===0&&(s===null||s.lanes===0)&&(s=a.lastRenderedReducer,s!==null))try{var d=a.lastRenderedState,p=s(d,r);if(n.hasEagerState=!0,n.eagerState=p,va(p,d)){var h=a.interleaved;h===null?(n.next=n,Cs(a)):(n.next=h.next,h.next=n),a.interleaved=n;return}}catch{}finally{}r=tc(e,a,n,t),r!==null&&(n=_e(),Aa(r,e,t,n),zc(r,a,t))}}function jc(e){var a=e.alternate;return e===he||a!==null&&a===he}function wc(e,a){To=Lt=!0;var r=e.pending;r===null?a.next=a:(a.next=r.next,r.next=a),e.pending=a}function zc(e,a,r){if((r&4194240)!==0){var t=a.lanes;t&=e.pendingLanes,r|=t,a.lanes=r,On(e,r)}}var Mt={readContext:da,useCallback:Oe,useContext:Oe,useEffect:Oe,useImperativeHandle:Oe,useInsertionEffect:Oe,useLayoutEffect:Oe,useMemo:Oe,useReducer:Oe,useRef:Oe,useState:Oe,useDebugValue:Oe,useDeferredValue:Oe,useTransition:Oe,useMutableSource:Oe,useSyncExternalStore:Oe,useId:Oe,unstable_isNewReconciler:!1},Wm={readContext:da,useCallback:function(e,a){return Ia().memoizedState=[e,a===void 0?null:a],e},useContext:da,useEffect:vc,useImperativeHandle:function(e,a,r){return r=r!=null?r.concat([e]):null,Ot(4194308,4,Cc.bind(null,a,e),r)},useLayoutEffect:function(e,a){return Ot(4194308,4,e,a)},useInsertionEffect:function(e,a){return Ot(4,2,e,a)},useMemo:function(e,a){var r=Ia();return a=a===void 0?null:a,e=e(),r.memoizedState=[e,a],e},useReducer:function(e,a,r){var t=Ia();return a=r!==void 0?r(a):a,t.memoizedState=t.baseState=a,e={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:a},t.queue=e,e=e.dispatch=Um.bind(null,he,e),[t.memoizedState,e]},useRef:function(e){var a=Ia();return e={current:e},a.memoizedState=e},useState:hc,useDebugValue:Rs,useDeferredValue:function(e){return Ia().memoizedState=e},useTransition:function(){var e=hc(!1),a=e[0];return e=_m.bind(null,e[1]),Ia().memoizedState=e,[a,e]},useMutableSource:function(){},useSyncExternalStore:function(e,a,r){var t=he,n=Ia();if(fe){if(r===void 0)throw Error(c(407));r=r()}else{if(r=a(),Ie===null)throw Error(c(349));(gr&30)!==0||uc(t,a,r)}n.memoizedState=r;var s={value:r,getSnapshot:a};return n.queue=s,vc(pc.bind(null,t,s,e),[e]),t.flags|=2048,Lo(9,mc.bind(null,t,s,r,a),void 0,null),r},useId:function(){var e=Ia(),a=Ie.identifierPrefix;if(fe){var r=Oa,t=La;r=(t&~(1<<32-ba(t)-1)).toString(32)+r,a=":"+a+"R"+r,r=Do++,0<r&&(a+="H"+r.toString(32)),a+=":"}else r=Hm++,a=":"+a+"r"+r.toString(32)+":";return e.memoizedState=a},unstable_isNewReconciler:!1},Gm={readContext:da,useCallback:Ac,useContext:da,useEffect:Ds,useImperativeHandle:Sc,useInsertionEffect:xc,useLayoutEffect:yc,useMemo:kc,useReducer:Es,useRef:bc,useState:function(){return Es(Ro)},useDebugValue:Rs,useDeferredValue:function(e){var a=ua();return Pc(a,Ne.memoizedState,e)},useTransition:function(){var e=Es(Ro)[0],a=ua().memoizedState;return[e,a]},useMutableSource:cc,useSyncExternalStore:dc,useId:Nc,unstable_isNewReconciler:!1},Qm={readContext:da,useCallback:Ac,useContext:da,useEffect:Ds,useImperativeHandle:Sc,useInsertionEffect:xc,useLayoutEffect:yc,useMemo:kc,useReducer:Ts,useRef:bc,useState:function(){return Ts(Ro)},useDebugValue:Rs,useDeferredValue:function(e){var a=ua();return Ne===null?a.memoizedState=e:Pc(a,Ne.memoizedState,e)},useTransition:function(){var e=Ts(Ro)[0],a=ua().memoizedState;return[e,a]},useMutableSource:cc,useSyncExternalStore:dc,useId:Nc,unstable_isNewReconciler:!1};function ya(e,a){if(e&&e.defaultProps){a=O({},a),e=e.defaultProps;for(var r in e)a[r]===void 0&&(a[r]=e[r]);return a}return a}function Ls(e,a,r,t){a=e.memoizedState,r=r(t,a),r=r==null?a:O({},a,r),e.memoizedState=r,e.lanes===0&&(e.updateQueue.baseState=r)}var Vt={isMounted:function(e){return(e=e._reactInternals)?lr(e)===e:!1},enqueueSetState:function(e,a,r){e=e._reactInternals;var t=_e(),n=rr(e),s=Ma(t,n);s.payload=a,r!=null&&(s.callback=r),a=Xa(e,s,n),a!==null&&(Aa(a,e,n,t),Et(a,e,n))},enqueueReplaceState:function(e,a,r){e=e._reactInternals;var t=_e(),n=rr(e),s=Ma(t,n);s.tag=1,s.payload=a,r!=null&&(s.callback=r),a=Xa(e,s,n),a!==null&&(Aa(a,e,n,t),Et(a,e,n))},enqueueForceUpdate:function(e,a){e=e._reactInternals;var r=_e(),t=rr(e),n=Ma(r,t);n.tag=2,a!=null&&(n.callback=a),a=Xa(e,n,t),a!==null&&(Aa(a,e,t,r),Et(a,e,t))}};function Ic(e,a,r,t,n,s,d){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,s,d):a.prototype&&a.prototype.isPureReactComponent?!Co(r,t)||!Co(n,s):!0}function Ec(e,a,r){var t=!1,n=Ya,s=a.contextType;return typeof s=="object"&&s!==null?s=da(s):(n=Ge(a)?dr:Le.current,t=a.contextTypes,s=(t=t!=null)?Vr(e,n):Ya),a=new a(r,s),e.memoizedState=a.state!==null&&a.state!==void 0?a.state:null,a.updater=Vt,e.stateNode=a,a._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=s),a}function Tc(e,a,r,t){e=a.state,typeof a.componentWillReceiveProps=="function"&&a.componentWillReceiveProps(r,t),typeof a.UNSAFE_componentWillReceiveProps=="function"&&a.UNSAFE_componentWillReceiveProps(r,t),a.state!==e&&Vt.enqueueReplaceState(a,a.state,null)}function Os(e,a,r,t){var n=e.stateNode;n.props=r,n.state=e.memoizedState,n.refs={},Ss(e);var s=a.contextType;typeof s=="object"&&s!==null?n.context=da(s):(s=Ge(a)?dr:Le.current,n.context=Vr(e,s)),n.state=e.memoizedState,s=a.getDerivedStateFromProps,typeof s=="function"&&(Ls(e,a,s,r),n.state=e.memoizedState),typeof a.getDerivedStateFromProps=="function"||typeof n.getSnapshotBeforeUpdate=="function"||typeof n.UNSAFE_componentWillMount!="function"&&typeof n.componentWillMount!="function"||(a=n.state,typeof n.componentWillMount=="function"&&n.componentWillMount(),typeof n.UNSAFE_componentWillMount=="function"&&n.UNSAFE_componentWillMount(),a!==n.state&&Vt.enqueueReplaceState(n,n.state,null),Tt(e,r,n,t),n.state=e.memoizedState),typeof n.componentDidMount=="function"&&(e.flags|=4194308)}function Gr(e,a){try{var r="",t=a;do r+=oe(t),t=t.return;while(t);var n=r}catch(s){n=`
Error generating stack: `+s.message+`
`+s.stack}return{value:e,source:a,stack:n,digest:null}}function qs(e,a,r){return{value:e,source:null,stack:r??null,digest:a??null}}function Ms(e,a){try{console.error(a.value)}catch(r){setTimeout(function(){throw r})}}var Ym=typeof WeakMap=="function"?WeakMap:Map;function Dc(e,a,r){r=Ma(-1,r),r.tag=3,r.payload={element:null};var t=a.value;return r.callback=function(){Wt||(Wt=!0,Xs=t),Ms(e,a)},r}function Rc(e,a,r){r=Ma(-1,r),r.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var n=a.value;r.payload=function(){return t(n)},r.callback=function(){Ms(e,a)}}var s=e.stateNode;return s!==null&&typeof s.componentDidCatch=="function"&&(r.callback=function(){Ms(e,a),typeof t!="function"&&(er===null?er=new Set([this]):er.add(this));var d=a.stack;this.componentDidCatch(a.value,{componentStack:d!==null?d:""})}),r}function Lc(e,a,r){var t=e.pingCache;if(t===null){t=e.pingCache=new Ym;var n=new Set;t.set(a,n)}else n=t.get(a),n===void 0&&(n=new Set,t.set(a,n));n.has(r)||(n.add(r),e=cp.bind(null,e,a,r),a.then(e,e))}function Oc(e){do{var a;if((a=e.tag===13)&&(a=e.memoizedState,a=a!==null?a.dehydrated!==null:!0),a)return e;e=e.return}while(e!==null);return null}function qc(e,a,r,t,n){return(e.mode&1)===0?(e===a?e.flags|=65536:(e.flags|=128,r.flags|=131072,r.flags&=-52805,r.tag===1&&(r.alternate===null?r.tag=17:(a=Ma(-1,1),a.tag=2,Xa(r,a,1))),r.lanes|=1),e):(e.flags|=65536,e.lanes=n,e)}var Km=be.ReactCurrentOwner,Qe=!1;function He(e,a,r,t){a.child=e===null?oc(a,null,r,t):_r(a,e.child,r,t)}function Mc(e,a,r,t,n){r=r.render;var s=a.ref;return Fr(a,n),t=zs(e,a,r,t,s,n),r=Is(),e!==null&&!Qe?(a.updateQueue=e.updateQueue,a.flags&=-2053,e.lanes&=~n,Va(e,a,n)):(fe&&r&&ms(a),a.flags|=1,He(e,a,t,n),a.child)}function Vc(e,a,r,t,n){if(e===null){var s=r.type;return typeof s=="function"&&!ni(s)&&s.defaultProps===void 0&&r.compare===null&&r.defaultProps===void 0?(a.tag=15,a.type=s,Bc(e,a,s,t,n)):(e=Xt(r.type,null,t,a,a.mode,n),e.ref=a.ref,e.return=a,a.child=e)}if(s=e.child,(e.lanes&n)===0){var d=s.memoizedProps;if(r=r.compare,r=r!==null?r:Co,r(d,t)&&e.ref===a.ref)return Va(e,a,n)}return a.flags|=1,e=tr(s,t),e.ref=a.ref,e.return=a,a.child=e}function Bc(e,a,r,t,n){if(e!==null){var s=e.memoizedProps;if(Co(s,t)&&e.ref===a.ref)if(Qe=!1,a.pendingProps=t=s,(e.lanes&n)!==0)(e.flags&131072)!==0&&(Qe=!0);else return a.lanes=e.lanes,Va(e,a,n)}return Vs(e,a,r,t,n)}function $c(e,a,r){var t=a.pendingProps,n=t.children,s=e!==null?e.memoizedState:null;if(t.mode==="hidden")if((a.mode&1)===0)a.memoizedState={baseLanes:0,cachePool:null,transitions:null},de(Yr,ta),ta|=r;else{if((r&1073741824)===0)return e=s!==null?s.baseLanes|r:r,a.lanes=a.childLanes=1073741824,a.memoizedState={baseLanes:e,cachePool:null,transitions:null},a.updateQueue=null,de(Yr,ta),ta|=e,null;a.memoizedState={baseLanes:0,cachePool:null,transitions:null},t=s!==null?s.baseLanes:r,de(Yr,ta),ta|=t}else s!==null?(t=s.baseLanes|r,a.memoizedState=null):t=r,de(Yr,ta),ta|=t;return He(e,a,n,r),a.child}function Hc(e,a){var r=a.ref;(e===null&&r!==null||e!==null&&e.ref!==r)&&(a.flags|=512,a.flags|=2097152)}function Vs(e,a,r,t,n){var s=Ge(r)?dr:Le.current;return s=Vr(a,s),Fr(a,n),r=zs(e,a,r,t,s,n),t=Is(),e!==null&&!Qe?(a.updateQueue=e.updateQueue,a.flags&=-2053,e.lanes&=~n,Va(e,a,n)):(fe&&t&&ms(a),a.flags|=1,He(e,a,r,n),a.child)}function _c(e,a,r,t,n){if(Ge(r)){var s=!0;At(a)}else s=!1;if(Fr(a,n),a.stateNode===null)$t(e,a),Ec(a,r,t),Os(a,r,t,n),t=!0;else if(e===null){var d=a.stateNode,p=a.memoizedProps;d.props=p;var h=d.context,S=r.contextType;typeof S=="object"&&S!==null?S=da(S):(S=Ge(r)?dr:Le.current,S=Vr(a,S));var w=r.getDerivedStateFromProps,z=typeof w=="function"||typeof d.getSnapshotBeforeUpdate=="function";z||typeof d.UNSAFE_componentWillReceiveProps!="function"&&typeof d.componentWillReceiveProps!="function"||(p!==t||h!==S)&&Tc(a,d,t,S),Za=!1;var N=a.memoizedState;d.state=N,Tt(a,t,d,n),h=a.memoizedState,p!==t||N!==h||We.current||Za?(typeof w=="function"&&(Ls(a,r,w,t),h=a.memoizedState),(p=Za||Ic(a,r,p,t,N,h,S))?(z||typeof d.UNSAFE_componentWillMount!="function"&&typeof d.componentWillMount!="function"||(typeof d.componentWillMount=="function"&&d.componentWillMount(),typeof d.UNSAFE_componentWillMount=="function"&&d.UNSAFE_componentWillMount()),typeof d.componentDidMount=="function"&&(a.flags|=4194308)):(typeof d.componentDidMount=="function"&&(a.flags|=4194308),a.memoizedProps=t,a.memoizedState=h),d.props=t,d.state=h,d.context=S,t=p):(typeof d.componentDidMount=="function"&&(a.flags|=4194308),t=!1)}else{d=a.stateNode,nc(e,a),p=a.memoizedProps,S=a.type===a.elementType?p:ya(a.type,p),d.props=S,z=a.pendingProps,N=d.context,h=r.contextType,typeof h=="object"&&h!==null?h=da(h):(h=Ge(r)?dr:Le.current,h=Vr(a,h));var D=r.getDerivedStateFromProps;(w=typeof D=="function"||typeof d.getSnapshotBeforeUpdate=="function")||typeof d.UNSAFE_componentWillReceiveProps!="function"&&typeof d.componentWillReceiveProps!="function"||(p!==z||N!==h)&&Tc(a,d,t,h),Za=!1,N=a.memoizedState,d.state=N,Tt(a,t,d,n);var q=a.memoizedState;p!==z||N!==q||We.current||Za?(typeof D=="function"&&(Ls(a,r,D,t),q=a.memoizedState),(S=Za||Ic(a,r,S,t,N,q,h)||!1)?(w||typeof d.UNSAFE_componentWillUpdate!="function"&&typeof d.componentWillUpdate!="function"||(typeof d.componentWillUpdate=="function"&&d.componentWillUpdate(t,q,h),typeof d.UNSAFE_componentWillUpdate=="function"&&d.UNSAFE_componentWillUpdate(t,q,h)),typeof d.componentDidUpdate=="function"&&(a.flags|=4),typeof d.getSnapshotBeforeUpdate=="function"&&(a.flags|=1024)):(typeof d.componentDidUpdate!="function"||p===e.memoizedProps&&N===e.memoizedState||(a.flags|=4),typeof d.getSnapshotBeforeUpdate!="function"||p===e.memoizedProps&&N===e.memoizedState||(a.flags|=1024),a.memoizedProps=t,a.memoizedState=q),d.props=t,d.state=q,d.context=h,t=S):(typeof d.componentDidUpdate!="function"||p===e.memoizedProps&&N===e.memoizedState||(a.flags|=4),typeof d.getSnapshotBeforeUpdate!="function"||p===e.memoizedProps&&N===e.memoizedState||(a.flags|=1024),t=!1)}return Bs(e,a,r,t,s,n)}function Bs(e,a,r,t,n,s){Hc(e,a);var d=(a.flags&128)!==0;if(!t&&!d)return n&&Ql(a,r,!1),Va(e,a,s);t=a.stateNode,Km.current=a;var p=d&&typeof r.getDerivedStateFromError!="function"?null:t.render();return a.flags|=1,e!==null&&d?(a.child=_r(a,e.child,null,s),a.child=_r(a,null,p,s)):He(e,a,p,s),a.memoizedState=t.state,n&&Ql(a,r,!0),a.child}function Uc(e){var a=e.stateNode;a.pendingContext?Wl(e,a.pendingContext,a.pendingContext!==a.context):a.context&&Wl(e,a.context,!1),As(e,a.containerInfo)}function Fc(e,a,r,t,n){return Hr(),hs(n),a.flags|=256,He(e,a,r,t),a.child}var $s={dehydrated:null,treeContext:null,retryLane:0};function Hs(e){return{baseLanes:e,cachePool:null,transitions:null}}function Wc(e,a,r){var t=a.pendingProps,n=ge.current,s=!1,d=(a.flags&128)!==0,p;if((p=d)||(p=e!==null&&e.memoizedState===null?!1:(n&2)!==0),p?(s=!0,a.flags&=-129):(e===null||e.memoizedState!==null)&&(n|=1),de(ge,n&1),e===null)return gs(a),e=a.memoizedState,e!==null&&(e=e.dehydrated,e!==null)?((a.mode&1)===0?a.lanes=1:e.data==="$!"?a.lanes=8:a.lanes=1073741824,null):(d=t.children,e=t.fallback,s?(t=a.mode,s=a.child,d={mode:"hidden",children:d},(t&1)===0&&s!==null?(s.childLanes=0,s.pendingProps=d):s=Jt(d,t,0,null),e=yr(e,t,r,null),s.return=a,e.return=a,s.sibling=e,a.child=s,a.child.memoizedState=Hs(r),a.memoizedState=$s,e):_s(a,d));if(n=e.memoizedState,n!==null&&(p=n.dehydrated,p!==null))return Zm(e,a,d,t,p,n,r);if(s){s=t.fallback,d=a.mode,n=e.child,p=n.sibling;var h={mode:"hidden",children:t.children};return(d&1)===0&&a.child!==n?(t=a.child,t.childLanes=0,t.pendingProps=h,a.deletions=null):(t=tr(n,h),t.subtreeFlags=n.subtreeFlags&14680064),p!==null?s=tr(p,s):(s=yr(s,d,r,null),s.flags|=2),s.return=a,t.return=a,t.sibling=s,a.child=t,t=s,s=a.child,d=e.child.memoizedState,d=d===null?Hs(r):{baseLanes:d.baseLanes|r,cachePool:null,transitions:d.transitions},s.memoizedState=d,s.childLanes=e.childLanes&~r,a.memoizedState=$s,t}return s=e.child,e=s.sibling,t=tr(s,{mode:"visible",children:t.children}),(a.mode&1)===0&&(t.lanes=r),t.return=a,t.sibling=null,e!==null&&(r=a.deletions,r===null?(a.deletions=[e],a.flags|=16):r.push(e)),a.child=t,a.memoizedState=null,t}function _s(e,a){return a=Jt({mode:"visible",children:a},e.mode,0,null),a.return=e,e.child=a}function Bt(e,a,r,t){return t!==null&&hs(t),_r(a,e.child,null,r),e=_s(a,a.pendingProps.children),e.flags|=2,a.memoizedState=null,e}function Zm(e,a,r,t,n,s,d){if(r)return a.flags&256?(a.flags&=-257,t=qs(Error(c(422))),Bt(e,a,d,t)):a.memoizedState!==null?(a.child=e.child,a.flags|=128,null):(s=t.fallback,n=a.mode,t=Jt({mode:"visible",children:t.children},n,0,null),s=yr(s,n,d,null),s.flags|=2,t.return=a,s.return=a,t.sibling=s,a.child=t,(a.mode&1)!==0&&_r(a,e.child,null,d),a.child.memoizedState=Hs(d),a.memoizedState=$s,s);if((a.mode&1)===0)return Bt(e,a,d,null);if(n.data==="$!"){if(t=n.nextSibling&&n.nextSibling.dataset,t)var p=t.dgst;return t=p,s=Error(c(419)),t=qs(s,t,void 0),Bt(e,a,d,t)}if(p=(d&e.childLanes)!==0,Qe||p){if(t=Ie,t!==null){switch(d&-d){case 4:n=2;break;case 16:n=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:n=32;break;case 536870912:n=268435456;break;default:n=0}n=(n&(t.suspendedLanes|d))!==0?0:n,n!==0&&n!==s.retryLane&&(s.retryLane=n,qa(e,n),Aa(t,e,n,-1))}return ti(),t=qs(Error(c(421))),Bt(e,a,d,t)}return n.data==="$?"?(a.flags|=128,a.child=e.child,a=dp.bind(null,e),n._reactRetry=a,null):(e=s.treeContext,oa=Ga(n.nextSibling),ra=a,fe=!0,xa=null,e!==null&&(la[ca++]=La,la[ca++]=Oa,la[ca++]=ur,La=e.id,Oa=e.overflow,ur=a),a=_s(a,t.children),a.flags|=4096,a)}function Gc(e,a,r){e.lanes|=a;var t=e.alternate;t!==null&&(t.lanes|=a),ys(e.return,a,r)}function Us(e,a,r,t,n){var s=e.memoizedState;s===null?e.memoizedState={isBackwards:a,rendering:null,renderingStartTime:0,last:t,tail:r,tailMode:n}:(s.isBackwards=a,s.rendering=null,s.renderingStartTime=0,s.last=t,s.tail=r,s.tailMode=n)}function Qc(e,a,r){var t=a.pendingProps,n=t.revealOrder,s=t.tail;if(He(e,a,t.children,r),t=ge.current,(t&2)!==0)t=t&1|2,a.flags|=128;else{if(e!==null&&(e.flags&128)!==0)e:for(e=a.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Gc(e,r,a);else if(e.tag===19)Gc(e,r,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===a)break e;for(;e.sibling===null;){if(e.return===null||e.return===a)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(de(ge,t),(a.mode&1)===0)a.memoizedState=null;else switch(n){case"forwards":for(r=a.child,n=null;r!==null;)e=r.alternate,e!==null&&Dt(e)===null&&(n=r),r=r.sibling;r=n,r===null?(n=a.child,a.child=null):(n=r.sibling,r.sibling=null),Us(a,!1,n,r,s);break;case"backwards":for(r=null,n=a.child,a.child=null;n!==null;){if(e=n.alternate,e!==null&&Dt(e)===null){a.child=n;break}e=n.sibling,n.sibling=r,r=n,n=e}Us(a,!0,r,null,s);break;case"together":Us(a,!1,null,null,void 0);break;default:a.memoizedState=null}return a.child}function $t(e,a){(a.mode&1)===0&&e!==null&&(e.alternate=null,a.alternate=null,a.flags|=2)}function Va(e,a,r){if(e!==null&&(a.dependencies=e.dependencies),hr|=a.lanes,(r&a.childLanes)===0)return null;if(e!==null&&a.child!==e.child)throw Error(c(153));if(a.child!==null){for(e=a.child,r=tr(e,e.pendingProps),a.child=r,r.return=a;e.sibling!==null;)e=e.sibling,r=r.sibling=tr(e,e.pendingProps),r.return=a;r.sibling=null}return a.child}function Xm(e,a,r){switch(a.tag){case 3:Uc(a),Hr();break;case 5:lc(a);break;case 1:Ge(a.type)&&At(a);break;case 4:As(a,a.stateNode.containerInfo);break;case 10:var t=a.type._context,n=a.memoizedProps.value;de(zt,t._currentValue),t._currentValue=n;break;case 13:if(t=a.memoizedState,t!==null)return t.dehydrated!==null?(de(ge,ge.current&1),a.flags|=128,null):(r&a.child.childLanes)!==0?Wc(e,a,r):(de(ge,ge.current&1),e=Va(e,a,r),e!==null?e.sibling:null);de(ge,ge.current&1);break;case 19:if(t=(r&a.childLanes)!==0,(e.flags&128)!==0){if(t)return Qc(e,a,r);a.flags|=128}if(n=a.memoizedState,n!==null&&(n.rendering=null,n.tail=null,n.lastEffect=null),de(ge,ge.current),t)break;return null;case 22:case 23:return a.lanes=0,$c(e,a,r)}return Va(e,a,r)}var Yc,Fs,Kc,Zc;Yc=function(e,a){for(var r=a.child;r!==null;){if(r.tag===5||r.tag===6)e.appendChild(r.stateNode);else if(r.tag!==4&&r.child!==null){r.child.return=r,r=r.child;continue}if(r===a)break;for(;r.sibling===null;){if(r.return===null||r.return===a)return;r=r.return}r.sibling.return=r.return,r=r.sibling}},Fs=function(){},Kc=function(e,a,r,t){var n=e.memoizedProps;if(n!==t){e=a.stateNode,fr(za.current);var s=null;switch(r){case"input":n=yn(e,n),t=yn(e,t),s=[];break;case"select":n=O({},n,{value:void 0}),t=O({},t,{value:void 0}),s=[];break;case"textarea":n=An(e,n),t=An(e,t),s=[];break;default:typeof n.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=yt)}Pn(r,t);var d;r=null;for(S in n)if(!t.hasOwnProperty(S)&&n.hasOwnProperty(S)&&n[S]!=null)if(S==="style"){var p=n[S];for(d in p)p.hasOwnProperty(d)&&(r||(r={}),r[d]="")}else S!=="dangerouslySetInnerHTML"&&S!=="children"&&S!=="suppressContentEditableWarning"&&S!=="suppressHydrationWarning"&&S!=="autoFocus"&&(u.hasOwnProperty(S)?s||(s=[]):(s=s||[]).push(S,null));for(S in t){var h=t[S];if(p=n?.[S],t.hasOwnProperty(S)&&h!==p&&(h!=null||p!=null))if(S==="style")if(p){for(d in p)!p.hasOwnProperty(d)||h&&h.hasOwnProperty(d)||(r||(r={}),r[d]="");for(d in h)h.hasOwnProperty(d)&&p[d]!==h[d]&&(r||(r={}),r[d]=h[d])}else r||(s||(s=[]),s.push(S,r)),r=h;else S==="dangerouslySetInnerHTML"?(h=h?h.__html:void 0,p=p?p.__html:void 0,h!=null&&p!==h&&(s=s||[]).push(S,h)):S==="children"?typeof h!="string"&&typeof h!="number"||(s=s||[]).push(S,""+h):S!=="suppressContentEditableWarning"&&S!=="suppressHydrationWarning"&&(u.hasOwnProperty(S)?(h!=null&&S==="onScroll"&&ue("scroll",e),s||p===h||(s=[])):(s=s||[]).push(S,h))}r&&(s=s||[]).push("style",r);var S=s;(a.updateQueue=S)&&(a.flags|=4)}},Zc=function(e,a,r,t){r!==t&&(a.flags|=4)};function Oo(e,a){if(!fe)switch(e.tailMode){case"hidden":a=e.tail;for(var r=null;a!==null;)a.alternate!==null&&(r=a),a=a.sibling;r===null?e.tail=null:r.sibling=null;break;case"collapsed":r=e.tail;for(var t=null;r!==null;)r.alternate!==null&&(t=r),r=r.sibling;t===null?a||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function qe(e){var a=e.alternate!==null&&e.alternate.child===e.child,r=0,t=0;if(a)for(var n=e.child;n!==null;)r|=n.lanes|n.childLanes,t|=n.subtreeFlags&14680064,t|=n.flags&14680064,n.return=e,n=n.sibling;else for(n=e.child;n!==null;)r|=n.lanes|n.childLanes,t|=n.subtreeFlags,t|=n.flags,n.return=e,n=n.sibling;return e.subtreeFlags|=t,e.childLanes=r,a}function Jm(e,a,r){var t=a.pendingProps;switch(ps(a),a.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return qe(a),null;case 1:return Ge(a.type)&&St(),qe(a),null;case 3:return t=a.stateNode,Wr(),me(We),me(Le),Ns(),t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(jt(a)?a.flags|=4:e===null||e.memoizedState.isDehydrated&&(a.flags&256)===0||(a.flags|=1024,xa!==null&&(ai(xa),xa=null))),Fs(e,a),qe(a),null;case 5:ks(a);var n=fr(Eo.current);if(r=a.type,e!==null&&a.stateNode!=null)Kc(e,a,r,t,n),e.ref!==a.ref&&(a.flags|=512,a.flags|=2097152);else{if(!t){if(a.stateNode===null)throw Error(c(166));return qe(a),null}if(e=fr(za.current),jt(a)){t=a.stateNode,r=a.type;var s=a.memoizedProps;switch(t[wa]=a,t[No]=s,e=(a.mode&1)!==0,r){case"dialog":ue("cancel",t),ue("close",t);break;case"iframe":case"object":case"embed":ue("load",t);break;case"video":case"audio":for(n=0;n<Ao.length;n++)ue(Ao[n],t);break;case"source":ue("error",t);break;case"img":case"image":case"link":ue("error",t),ue("load",t);break;case"details":ue("toggle",t);break;case"input":Ei(t,s),ue("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!s.multiple},ue("invalid",t);break;case"textarea":Ri(t,s),ue("invalid",t)}Pn(r,s),n=null;for(var d in s)if(s.hasOwnProperty(d)){var p=s[d];d==="children"?typeof p=="string"?t.textContent!==p&&(s.suppressHydrationWarning!==!0&&xt(t.textContent,p,e),n=["children",p]):typeof p=="number"&&t.textContent!==""+p&&(s.suppressHydrationWarning!==!0&&xt(t.textContent,p,e),n=["children",""+p]):u.hasOwnProperty(d)&&p!=null&&d==="onScroll"&&ue("scroll",t)}switch(r){case"input":Ko(t),Di(t,s,!0);break;case"textarea":Ko(t),Oi(t);break;case"select":case"option":break;default:typeof s.onClick=="function"&&(t.onclick=yt)}t=n,a.updateQueue=t,t!==null&&(a.flags|=4)}else{d=n.nodeType===9?n:n.ownerDocument,e==="http://www.w3.org/1999/xhtml"&&(e=qi(r)),e==="http://www.w3.org/1999/xhtml"?r==="script"?(e=d.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=d.createElement(r,{is:t.is}):(e=d.createElement(r),r==="select"&&(d=e,t.multiple?d.multiple=!0:t.size&&(d.size=t.size))):e=d.createElementNS(e,r),e[wa]=a,e[No]=t,Yc(e,a,!1,!1),a.stateNode=e;e:{switch(d=Nn(r,t),r){case"dialog":ue("cancel",e),ue("close",e),n=t;break;case"iframe":case"object":case"embed":ue("load",e),n=t;break;case"video":case"audio":for(n=0;n<Ao.length;n++)ue(Ao[n],e);n=t;break;case"source":ue("error",e),n=t;break;case"img":case"image":case"link":ue("error",e),ue("load",e),n=t;break;case"details":ue("toggle",e),n=t;break;case"input":Ei(e,t),n=yn(e,t),ue("invalid",e);break;case"option":n=t;break;case"select":e._wrapperState={wasMultiple:!!t.multiple},n=O({},t,{value:void 0}),ue("invalid",e);break;case"textarea":Ri(e,t),n=An(e,t),ue("invalid",e);break;default:n=t}Pn(r,n),p=n;for(s in p)if(p.hasOwnProperty(s)){var h=p[s];s==="style"?Bi(e,h):s==="dangerouslySetInnerHTML"?(h=h?h.__html:void 0,h!=null&&Mi(e,h)):s==="children"?typeof h=="string"?(r!=="textarea"||h!=="")&&oo(e,h):typeof h=="number"&&oo(e,""+h):s!=="suppressContentEditableWarning"&&s!=="suppressHydrationWarning"&&s!=="autoFocus"&&(u.hasOwnProperty(s)?h!=null&&s==="onScroll"&&ue("scroll",e):h!=null&&$e(e,s,h,d))}switch(r){case"input":Ko(e),Di(e,t,!1);break;case"textarea":Ko(e),Oi(e);break;case"option":t.value!=null&&e.setAttribute("value",""+ie(t.value));break;case"select":e.multiple=!!t.multiple,s=t.value,s!=null?jr(e,!!t.multiple,s,!1):t.defaultValue!=null&&jr(e,!!t.multiple,t.defaultValue,!0);break;default:typeof n.onClick=="function"&&(e.onclick=yt)}switch(r){case"button":case"input":case"select":case"textarea":t=!!t.autoFocus;break e;case"img":t=!0;break e;default:t=!1}}t&&(a.flags|=4)}a.ref!==null&&(a.flags|=512,a.flags|=2097152)}return qe(a),null;case 6:if(e&&a.stateNode!=null)Zc(e,a,e.memoizedProps,t);else{if(typeof t!="string"&&a.stateNode===null)throw Error(c(166));if(r=fr(Eo.current),fr(za.current),jt(a)){if(t=a.stateNode,r=a.memoizedProps,t[wa]=a,(s=t.nodeValue!==r)&&(e=ra,e!==null))switch(e.tag){case 3:xt(t.nodeValue,r,(e.mode&1)!==0);break;case 5:e.memoizedProps.suppressHydrationWarning!==!0&&xt(t.nodeValue,r,(e.mode&1)!==0)}s&&(a.flags|=4)}else t=(r.nodeType===9?r:r.ownerDocument).createTextNode(t),t[wa]=a,a.stateNode=t}return qe(a),null;case 13:if(me(ge),t=a.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(fe&&oa!==null&&(a.mode&1)!==0&&(a.flags&128)===0)ec(),Hr(),a.flags|=98560,s=!1;else if(s=jt(a),t!==null&&t.dehydrated!==null){if(e===null){if(!s)throw Error(c(318));if(s=a.memoizedState,s=s!==null?s.dehydrated:null,!s)throw Error(c(317));s[wa]=a}else Hr(),(a.flags&128)===0&&(a.memoizedState=null),a.flags|=4;qe(a),s=!1}else xa!==null&&(ai(xa),xa=null),s=!0;if(!s)return a.flags&65536?a:null}return(a.flags&128)!==0?(a.lanes=r,a):(t=t!==null,t!==(e!==null&&e.memoizedState!==null)&&t&&(a.child.flags|=8192,(a.mode&1)!==0&&(e===null||(ge.current&1)!==0?je===0&&(je=3):ti())),a.updateQueue!==null&&(a.flags|=4),qe(a),null);case 4:return Wr(),Fs(e,a),e===null&&ko(a.stateNode.containerInfo),qe(a),null;case 10:return xs(a.type._context),qe(a),null;case 17:return Ge(a.type)&&St(),qe(a),null;case 19:if(me(ge),s=a.memoizedState,s===null)return qe(a),null;if(t=(a.flags&128)!==0,d=s.rendering,d===null)if(t)Oo(s,!1);else{if(je!==0||e!==null&&(e.flags&128)!==0)for(e=a.child;e!==null;){if(d=Dt(e),d!==null){for(a.flags|=128,Oo(s,!1),t=d.updateQueue,t!==null&&(a.updateQueue=t,a.flags|=4),a.subtreeFlags=0,t=r,r=a.child;r!==null;)s=r,e=t,s.flags&=14680066,d=s.alternate,d===null?(s.childLanes=0,s.lanes=e,s.child=null,s.subtreeFlags=0,s.memoizedProps=null,s.memoizedState=null,s.updateQueue=null,s.dependencies=null,s.stateNode=null):(s.childLanes=d.childLanes,s.lanes=d.lanes,s.child=d.child,s.subtreeFlags=0,s.deletions=null,s.memoizedProps=d.memoizedProps,s.memoizedState=d.memoizedState,s.updateQueue=d.updateQueue,s.type=d.type,e=d.dependencies,s.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),r=r.sibling;return de(ge,ge.current&1|2),a.child}e=e.sibling}s.tail!==null&&ye()>Kr&&(a.flags|=128,t=!0,Oo(s,!1),a.lanes=4194304)}else{if(!t)if(e=Dt(d),e!==null){if(a.flags|=128,t=!0,r=e.updateQueue,r!==null&&(a.updateQueue=r,a.flags|=4),Oo(s,!0),s.tail===null&&s.tailMode==="hidden"&&!d.alternate&&!fe)return qe(a),null}else 2*ye()-s.renderingStartTime>Kr&&r!==1073741824&&(a.flags|=128,t=!0,Oo(s,!1),a.lanes=4194304);s.isBackwards?(d.sibling=a.child,a.child=d):(r=s.last,r!==null?r.sibling=d:a.child=d,s.last=d)}return s.tail!==null?(a=s.tail,s.rendering=a,s.tail=a.sibling,s.renderingStartTime=ye(),a.sibling=null,r=ge.current,de(ge,t?r&1|2:r&1),a):(qe(a),null);case 22:case 23:return oi(),t=a.memoizedState!==null,e!==null&&e.memoizedState!==null!==t&&(a.flags|=8192),t&&(a.mode&1)!==0?(ta&1073741824)!==0&&(qe(a),a.subtreeFlags&6&&(a.flags|=8192)):qe(a),null;case 24:return null;case 25:return null}throw Error(c(156,a.tag))}function ep(e,a){switch(ps(a),a.tag){case 1:return Ge(a.type)&&St(),e=a.flags,e&65536?(a.flags=e&-65537|128,a):null;case 3:return Wr(),me(We),me(Le),Ns(),e=a.flags,(e&65536)!==0&&(e&128)===0?(a.flags=e&-65537|128,a):null;case 5:return ks(a),null;case 13:if(me(ge),e=a.memoizedState,e!==null&&e.dehydrated!==null){if(a.alternate===null)throw Error(c(340));Hr()}return e=a.flags,e&65536?(a.flags=e&-65537|128,a):null;case 19:return me(ge),null;case 4:return Wr(),null;case 10:return xs(a.type._context),null;case 22:case 23:return oi(),null;case 24:return null;default:return null}}var Ht=!1,Me=!1,ap=typeof WeakSet=="function"?WeakSet:Set,L=null;function Qr(e,a){var r=e.ref;if(r!==null)if(typeof r=="function")try{r(null)}catch(t){xe(e,a,t)}else r.current=null}function Xc(e,a,r){try{r()}catch(t){xe(e,a,t)}}var Jc=!1;function rp(e,a){if(ts=lt,e=Il(),Kn(e)){if("selectionStart"in e)var r={start:e.selectionStart,end:e.selectionEnd};else e:{r=(r=e.ownerDocument)&&r.defaultView||window;var t=r.getSelection&&r.getSelection();if(t&&t.rangeCount!==0){r=t.anchorNode;var n=t.anchorOffset,s=t.focusNode;t=t.focusOffset;try{r.nodeType,s.nodeType}catch{r=null;break e}var d=0,p=-1,h=-1,S=0,w=0,z=e,N=null;a:for(;;){for(var D;z!==r||n!==0&&z.nodeType!==3||(p=d+n),z!==s||t!==0&&z.nodeType!==3||(h=d+t),z.nodeType===3&&(d+=z.nodeValue.length),(D=z.firstChild)!==null;)N=z,z=D;for(;;){if(z===e)break a;if(N===r&&++S===n&&(p=d),N===s&&++w===t&&(h=d),(D=z.nextSibling)!==null)break;z=N,N=z.parentNode}z=D}r=p===-1||h===-1?null:{start:p,end:h}}else r=null}r=r||{start:0,end:0}}else r=null;for(ns={focusedElem:e,selectionRange:r},lt=!1,L=a;L!==null;)if(a=L,e=a.child,(a.subtreeFlags&1028)!==0&&e!==null)e.return=a,L=e;else for(;L!==null;){a=L;try{var q=a.alternate;if((a.flags&1024)!==0)switch(a.tag){case 0:case 11:case 15:break;case 1:if(q!==null){var M=q.memoizedProps,Ce=q.memoizedState,y=a.stateNode,v=y.getSnapshotBeforeUpdate(a.elementType===a.type?M:ya(a.type,M),Ce);y.__reactInternalSnapshotBeforeUpdate=v}break;case 3:var C=a.stateNode.containerInfo;C.nodeType===1?C.textContent="":C.nodeType===9&&C.documentElement&&C.removeChild(C.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(c(163))}}catch(I){xe(a,a.return,I)}if(e=a.sibling,e!==null){e.return=a.return,L=e;break}L=a.return}return q=Jc,Jc=!1,q}function qo(e,a,r){var t=a.updateQueue;if(t=t!==null?t.lastEffect:null,t!==null){var n=t=t.next;do{if((n.tag&e)===e){var s=n.destroy;n.destroy=void 0,s!==void 0&&Xc(a,r,s)}n=n.next}while(n!==t)}}function _t(e,a){if(a=a.updateQueue,a=a!==null?a.lastEffect:null,a!==null){var r=a=a.next;do{if((r.tag&e)===e){var t=r.create;r.destroy=t()}r=r.next}while(r!==a)}}function Ws(e){var a=e.ref;if(a!==null){var r=e.stateNode;switch(e.tag){case 5:e=r;break;default:e=r}typeof a=="function"?a(e):a.current=e}}function ed(e){var a=e.alternate;a!==null&&(e.alternate=null,ed(a)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(a=e.stateNode,a!==null&&(delete a[wa],delete a[No],delete a[cs],delete a[Mm],delete a[Vm])),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}function ad(e){return e.tag===5||e.tag===3||e.tag===4}function rd(e){e:for(;;){for(;e.sibling===null;){if(e.return===null||ad(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.flags&2||e.child===null||e.tag===4)continue e;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function Gs(e,a,r){var t=e.tag;if(t===5||t===6)e=e.stateNode,a?r.nodeType===8?r.parentNode.insertBefore(e,a):r.insertBefore(e,a):(r.nodeType===8?(a=r.parentNode,a.insertBefore(e,r)):(a=r,a.appendChild(e)),r=r._reactRootContainer,r!=null||a.onclick!==null||(a.onclick=yt));else if(t!==4&&(e=e.child,e!==null))for(Gs(e,a,r),e=e.sibling;e!==null;)Gs(e,a,r),e=e.sibling}function Qs(e,a,r){var t=e.tag;if(t===5||t===6)e=e.stateNode,a?r.insertBefore(e,a):r.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(Qs(e,a,r),e=e.sibling;e!==null;)Qs(e,a,r),e=e.sibling}var Te=null,Ca=!1;function Ja(e,a,r){for(r=r.child;r!==null;)od(e,a,r),r=r.sibling}function od(e,a,r){if(ja&&typeof ja.onCommitFiberUnmount=="function")try{ja.onCommitFiberUnmount(rt,r)}catch{}switch(r.tag){case 5:Me||Qr(r,a);case 6:var t=Te,n=Ca;Te=null,Ja(e,a,r),Te=t,Ca=n,Te!==null&&(Ca?(e=Te,r=r.stateNode,e.nodeType===8?e.parentNode.removeChild(r):e.removeChild(r)):Te.removeChild(r.stateNode));break;case 18:Te!==null&&(Ca?(e=Te,r=r.stateNode,e.nodeType===8?ls(e.parentNode,r):e.nodeType===1&&ls(e,r),go(e)):ls(Te,r.stateNode));break;case 4:t=Te,n=Ca,Te=r.stateNode.containerInfo,Ca=!0,Ja(e,a,r),Te=t,Ca=n;break;case 0:case 11:case 14:case 15:if(!Me&&(t=r.updateQueue,t!==null&&(t=t.lastEffect,t!==null))){n=t=t.next;do{var s=n,d=s.destroy;s=s.tag,d!==void 0&&((s&2)!==0||(s&4)!==0)&&Xc(r,a,d),n=n.next}while(n!==t)}Ja(e,a,r);break;case 1:if(!Me&&(Qr(r,a),t=r.stateNode,typeof t.componentWillUnmount=="function"))try{t.props=r.memoizedProps,t.state=r.memoizedState,t.componentWillUnmount()}catch(p){xe(r,a,p)}Ja(e,a,r);break;case 21:Ja(e,a,r);break;case 22:r.mode&1?(Me=(t=Me)||r.memoizedState!==null,Ja(e,a,r),Me=t):Ja(e,a,r);break;default:Ja(e,a,r)}}function td(e){var a=e.updateQueue;if(a!==null){e.updateQueue=null;var r=e.stateNode;r===null&&(r=e.stateNode=new ap),a.forEach(function(t){var n=up.bind(null,e,t);r.has(t)||(r.add(t),t.then(n,n))})}}function Sa(e,a){var r=a.deletions;if(r!==null)for(var t=0;t<r.length;t++){var n=r[t];try{var s=e,d=a,p=d;e:for(;p!==null;){switch(p.tag){case 5:Te=p.stateNode,Ca=!1;break e;case 3:Te=p.stateNode.containerInfo,Ca=!0;break e;case 4:Te=p.stateNode.containerInfo,Ca=!0;break e}p=p.return}if(Te===null)throw Error(c(160));od(s,d,n),Te=null,Ca=!1;var h=n.alternate;h!==null&&(h.return=null),n.return=null}catch(S){xe(n,a,S)}}if(a.subtreeFlags&12854)for(a=a.child;a!==null;)nd(a,e),a=a.sibling}function nd(e,a){var r=e.alternate,t=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:if(Sa(a,e),Ea(e),t&4){try{qo(3,e,e.return),_t(3,e)}catch(M){xe(e,e.return,M)}try{qo(5,e,e.return)}catch(M){xe(e,e.return,M)}}break;case 1:Sa(a,e),Ea(e),t&512&&r!==null&&Qr(r,r.return);break;case 5:if(Sa(a,e),Ea(e),t&512&&r!==null&&Qr(r,r.return),e.flags&32){var n=e.stateNode;try{oo(n,"")}catch(M){xe(e,e.return,M)}}if(t&4&&(n=e.stateNode,n!=null)){var s=e.memoizedProps,d=r!==null?r.memoizedProps:s,p=e.type,h=e.updateQueue;if(e.updateQueue=null,h!==null)try{p==="input"&&s.type==="radio"&&s.name!=null&&Ti(n,s),Nn(p,d);var S=Nn(p,s);for(d=0;d<h.length;d+=2){var w=h[d],z=h[d+1];w==="style"?Bi(n,z):w==="dangerouslySetInnerHTML"?Mi(n,z):w==="children"?oo(n,z):$e(n,w,z,S)}switch(p){case"input":Cn(n,s);break;case"textarea":Li(n,s);break;case"select":var N=n._wrapperState.wasMultiple;n._wrapperState.wasMultiple=!!s.multiple;var D=s.value;D!=null?jr(n,!!s.multiple,D,!1):N!==!!s.multiple&&(s.defaultValue!=null?jr(n,!!s.multiple,s.defaultValue,!0):jr(n,!!s.multiple,s.multiple?[]:"",!1))}n[No]=s}catch(M){xe(e,e.return,M)}}break;case 6:if(Sa(a,e),Ea(e),t&4){if(e.stateNode===null)throw Error(c(162));n=e.stateNode,s=e.memoizedProps;try{n.nodeValue=s}catch(M){xe(e,e.return,M)}}break;case 3:if(Sa(a,e),Ea(e),t&4&&r!==null&&r.memoizedState.isDehydrated)try{go(a.containerInfo)}catch(M){xe(e,e.return,M)}break;case 4:Sa(a,e),Ea(e);break;case 13:Sa(a,e),Ea(e),n=e.child,n.flags&8192&&(s=n.memoizedState!==null,n.stateNode.isHidden=s,!s||n.alternate!==null&&n.alternate.memoizedState!==null||(Zs=ye())),t&4&&td(e);break;case 22:if(w=r!==null&&r.memoizedState!==null,e.mode&1?(Me=(S=Me)||w,Sa(a,e),Me=S):Sa(a,e),Ea(e),t&8192){if(S=e.memoizedState!==null,(e.stateNode.isHidden=S)&&!w&&(e.mode&1)!==0)for(L=e,w=e.child;w!==null;){for(z=L=w;L!==null;){switch(N=L,D=N.child,N.tag){case 0:case 11:case 14:case 15:qo(4,N,N.return);break;case 1:Qr(N,N.return);var q=N.stateNode;if(typeof q.componentWillUnmount=="function"){t=N,r=N.return;try{a=t,q.props=a.memoizedProps,q.state=a.memoizedState,q.componentWillUnmount()}catch(M){xe(t,r,M)}}break;case 5:Qr(N,N.return);break;case 22:if(N.memoizedState!==null){ld(z);continue}}D!==null?(D.return=N,L=D):ld(z)}w=w.sibling}e:for(w=null,z=e;;){if(z.tag===5){if(w===null){w=z;try{n=z.stateNode,S?(s=n.style,typeof s.setProperty=="function"?s.setProperty("display","none","important"):s.display="none"):(p=z.stateNode,h=z.memoizedProps.style,d=h!=null&&h.hasOwnProperty("display")?h.display:null,p.style.display=Vi("display",d))}catch(M){xe(e,e.return,M)}}}else if(z.tag===6){if(w===null)try{z.stateNode.nodeValue=S?"":z.memoizedProps}catch(M){xe(e,e.return,M)}}else if((z.tag!==22&&z.tag!==23||z.memoizedState===null||z===e)&&z.child!==null){z.child.return=z,z=z.child;continue}if(z===e)break e;for(;z.sibling===null;){if(z.return===null||z.return===e)break e;w===z&&(w=null),z=z.return}w===z&&(w=null),z.sibling.return=z.return,z=z.sibling}}break;case 19:Sa(a,e),Ea(e),t&4&&td(e);break;case 21:break;default:Sa(a,e),Ea(e)}}function Ea(e){var a=e.flags;if(a&2){try{e:{for(var r=e.return;r!==null;){if(ad(r)){var t=r;break e}r=r.return}throw Error(c(160))}switch(t.tag){case 5:var n=t.stateNode;t.flags&32&&(oo(n,""),t.flags&=-33);var s=rd(e);Qs(e,s,n);break;case 3:case 4:var d=t.stateNode.containerInfo,p=rd(e);Gs(e,p,d);break;default:throw Error(c(161))}}catch(h){xe(e,e.return,h)}e.flags&=-3}a&4096&&(e.flags&=-4097)}function op(e,a,r){L=e,sd(e)}function sd(e,a,r){for(var t=(e.mode&1)!==0;L!==null;){var n=L,s=n.child;if(n.tag===22&&t){var d=n.memoizedState!==null||Ht;if(!d){var p=n.alternate,h=p!==null&&p.memoizedState!==null||Me;p=Ht;var S=Me;if(Ht=d,(Me=h)&&!S)for(L=n;L!==null;)d=L,h=d.child,d.tag===22&&d.memoizedState!==null?cd(n):h!==null?(h.return=d,L=h):cd(n);for(;s!==null;)L=s,sd(s),s=s.sibling;L=n,Ht=p,Me=S}id(e)}else(n.subtreeFlags&8772)!==0&&s!==null?(s.return=n,L=s):id(e)}}function id(e){for(;L!==null;){var a=L;if((a.flags&8772)!==0){var r=a.alternate;try{if((a.flags&8772)!==0)switch(a.tag){case 0:case 11:case 15:Me||_t(5,a);break;case 1:var t=a.stateNode;if(a.flags&4&&!Me)if(r===null)t.componentDidMount();else{var n=a.elementType===a.type?r.memoizedProps:ya(a.type,r.memoizedProps);t.componentDidUpdate(n,r.memoizedState,t.__reactInternalSnapshotBeforeUpdate)}var s=a.updateQueue;s!==null&&ic(a,s,t);break;case 3:var d=a.updateQueue;if(d!==null){if(r=null,a.child!==null)switch(a.child.tag){case 5:r=a.child.stateNode;break;case 1:r=a.child.stateNode}ic(a,d,r)}break;case 5:var p=a.stateNode;if(r===null&&a.flags&4){r=p;var h=a.memoizedProps;switch(a.type){case"button":case"input":case"select":case"textarea":h.autoFocus&&r.focus();break;case"img":h.src&&(r.src=h.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(a.memoizedState===null){var S=a.alternate;if(S!==null){var w=S.memoizedState;if(w!==null){var z=w.dehydrated;z!==null&&go(z)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(c(163))}Me||a.flags&512&&Ws(a)}catch(N){xe(a,a.return,N)}}if(a===e){L=null;break}if(r=a.sibling,r!==null){r.return=a.return,L=r;break}L=a.return}}function ld(e){for(;L!==null;){var a=L;if(a===e){L=null;break}var r=a.sibling;if(r!==null){r.return=a.return,L=r;break}L=a.return}}function cd(e){for(;L!==null;){var a=L;try{switch(a.tag){case 0:case 11:case 15:var r=a.return;try{_t(4,a)}catch(h){xe(a,r,h)}break;case 1:var t=a.stateNode;if(typeof t.componentDidMount=="function"){var n=a.return;try{t.componentDidMount()}catch(h){xe(a,n,h)}}var s=a.return;try{Ws(a)}catch(h){xe(a,s,h)}break;case 5:var d=a.return;try{Ws(a)}catch(h){xe(a,d,h)}}}catch(h){xe(a,a.return,h)}if(a===e){L=null;break}var p=a.sibling;if(p!==null){p.return=a.return,L=p;break}L=a.return}}var tp=Math.ceil,Ut=be.ReactCurrentDispatcher,Ys=be.ReactCurrentOwner,ma=be.ReactCurrentBatchConfig,re=0,Ie=null,Pe=null,De=0,ta=0,Yr=Qa(0),je=0,Mo=null,hr=0,Ft=0,Ks=0,Vo=null,Ye=null,Zs=0,Kr=1/0,Ba=null,Wt=!1,Xs=null,er=null,Gt=!1,ar=null,Qt=0,Bo=0,Js=null,Yt=-1,Kt=0;function _e(){return(re&6)!==0?ye():Yt!==-1?Yt:Yt=ye()}function rr(e){return(e.mode&1)===0?1:(re&2)!==0&&De!==0?De&-De:$m.transition!==null?(Kt===0&&(Kt=al()),Kt):(e=le,e!==0||(e=window.event,e=e===void 0?16:dl(e.type)),e)}function Aa(e,a,r,t){if(50<Bo)throw Bo=0,Js=null,Error(c(185));co(e,r,t),((re&2)===0||e!==Ie)&&(e===Ie&&((re&2)===0&&(Ft|=r),je===4&&or(e,De)),Ke(e,t),r===1&&re===0&&(a.mode&1)===0&&(Kr=ye()+500,kt&&Ka()))}function Ke(e,a){var r=e.callbackNode;$u(e,a);var t=nt(e,e===Ie?De:0);if(t===0)r!==null&&Xi(r),e.callbackNode=null,e.callbackPriority=0;else if(a=t&-t,e.callbackPriority!==a){if(r!=null&&Xi(r),a===1)e.tag===0?Bm(ud.bind(null,e)):Yl(ud.bind(null,e)),Om(function(){(re&6)===0&&Ka()}),r=null;else{switch(rl(t)){case 1:r=Dn;break;case 4:r=Ji;break;case 16:r=at;break;case 536870912:r=el;break;default:r=at}r=xd(r,dd.bind(null,e))}e.callbackPriority=a,e.callbackNode=r}}function dd(e,a){if(Yt=-1,Kt=0,(re&6)!==0)throw Error(c(327));var r=e.callbackNode;if(Zr()&&e.callbackNode!==r)return null;var t=nt(e,e===Ie?De:0);if(t===0)return null;if((t&30)!==0||(t&e.expiredLanes)!==0||a)a=Zt(e,t);else{a=t;var n=re;re|=2;var s=pd();(Ie!==e||De!==a)&&(Ba=null,Kr=ye()+500,vr(e,a));do try{ip();break}catch(p){md(e,p)}while(!0);vs(),Ut.current=s,re=n,Pe!==null?a=0:(Ie=null,De=0,a=je)}if(a!==0){if(a===2&&(n=Rn(e),n!==0&&(t=n,a=ei(e,n))),a===1)throw r=Mo,vr(e,0),or(e,t),Ke(e,ye()),r;if(a===6)or(e,t);else{if(n=e.current.alternate,(t&30)===0&&!np(n)&&(a=Zt(e,t),a===2&&(s=Rn(e),s!==0&&(t=s,a=ei(e,s))),a===1))throw r=Mo,vr(e,0),or(e,t),Ke(e,ye()),r;switch(e.finishedWork=n,e.finishedLanes=t,a){case 0:case 1:throw Error(c(345));case 2:xr(e,Ye,Ba);break;case 3:if(or(e,t),(t&130023424)===t&&(a=Zs+500-ye(),10<a)){if(nt(e,0)!==0)break;if(n=e.suspendedLanes,(n&t)!==t){_e(),e.pingedLanes|=e.suspendedLanes&n;break}e.timeoutHandle=is(xr.bind(null,e,Ye,Ba),a);break}xr(e,Ye,Ba);break;case 4:if(or(e,t),(t&4194240)===t)break;for(a=e.eventTimes,n=-1;0<t;){var d=31-ba(t);s=1<<d,d=a[d],d>n&&(n=d),t&=~s}if(t=n,t=ye()-t,t=(120>t?120:480>t?480:1080>t?1080:1920>t?1920:3e3>t?3e3:4320>t?4320:1960*tp(t/1960))-t,10<t){e.timeoutHandle=is(xr.bind(null,e,Ye,Ba),t);break}xr(e,Ye,Ba);break;case 5:xr(e,Ye,Ba);break;default:throw Error(c(329))}}}return Ke(e,ye()),e.callbackNode===r?dd.bind(null,e):null}function ei(e,a){var r=Vo;return e.current.memoizedState.isDehydrated&&(vr(e,a).flags|=256),e=Zt(e,a),e!==2&&(a=Ye,Ye=r,a!==null&&ai(a)),e}function ai(e){Ye===null?Ye=e:Ye.push.apply(Ye,e)}function np(e){for(var a=e;;){if(a.flags&16384){var r=a.updateQueue;if(r!==null&&(r=r.stores,r!==null))for(var t=0;t<r.length;t++){var n=r[t],s=n.getSnapshot;n=n.value;try{if(!va(s(),n))return!1}catch{return!1}}}if(r=a.child,a.subtreeFlags&16384&&r!==null)r.return=a,a=r;else{if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return!0;a=a.return}a.sibling.return=a.return,a=a.sibling}}return!0}function or(e,a){for(a&=~Ks,a&=~Ft,e.suspendedLanes|=a,e.pingedLanes&=~a,e=e.expirationTimes;0<a;){var r=31-ba(a),t=1<<r;e[r]=-1,a&=~t}}function ud(e){if((re&6)!==0)throw Error(c(327));Zr();var a=nt(e,0);if((a&1)===0)return Ke(e,ye()),null;var r=Zt(e,a);if(e.tag!==0&&r===2){var t=Rn(e);t!==0&&(a=t,r=ei(e,t))}if(r===1)throw r=Mo,vr(e,0),or(e,a),Ke(e,ye()),r;if(r===6)throw Error(c(345));return e.finishedWork=e.current.alternate,e.finishedLanes=a,xr(e,Ye,Ba),Ke(e,ye()),null}function ri(e,a){var r=re;re|=1;try{return e(a)}finally{re=r,re===0&&(Kr=ye()+500,kt&&Ka())}}function br(e){ar!==null&&ar.tag===0&&(re&6)===0&&Zr();var a=re;re|=1;var r=ma.transition,t=le;try{if(ma.transition=null,le=1,e)return e()}finally{le=t,ma.transition=r,re=a,(re&6)===0&&Ka()}}function oi(){ta=Yr.current,me(Yr)}function vr(e,a){e.finishedWork=null,e.finishedLanes=0;var r=e.timeoutHandle;if(r!==-1&&(e.timeoutHandle=-1,Lm(r)),Pe!==null)for(r=Pe.return;r!==null;){var t=r;switch(ps(t),t.tag){case 1:t=t.type.childContextTypes,t!=null&&St();break;case 3:Wr(),me(We),me(Le),Ns();break;case 5:ks(t);break;case 4:Wr();break;case 13:me(ge);break;case 19:me(ge);break;case 10:xs(t.type._context);break;case 22:case 23:oi()}r=r.return}if(Ie=e,Pe=e=tr(e.current,null),De=ta=a,je=0,Mo=null,Ks=Ft=hr=0,Ye=Vo=null,pr!==null){for(a=0;a<pr.length;a++)if(r=pr[a],t=r.interleaved,t!==null){r.interleaved=null;var n=t.next,s=r.pending;if(s!==null){var d=s.next;s.next=n,t.next=d}r.pending=t}pr=null}return e}function md(e,a){do{var r=Pe;try{if(vs(),Rt.current=Mt,Lt){for(var t=he.memoizedState;t!==null;){var n=t.queue;n!==null&&(n.pending=null),t=t.next}Lt=!1}if(gr=0,ze=Ne=he=null,To=!1,Do=0,Ys.current=null,r===null||r.return===null){je=1,Mo=a,Pe=null;break}e:{var s=e,d=r.return,p=r,h=a;if(a=De,p.flags|=32768,h!==null&&typeof h=="object"&&typeof h.then=="function"){var S=h,w=p,z=w.tag;if((w.mode&1)===0&&(z===0||z===11||z===15)){var N=w.alternate;N?(w.updateQueue=N.updateQueue,w.memoizedState=N.memoizedState,w.lanes=N.lanes):(w.updateQueue=null,w.memoizedState=null)}var D=Oc(d);if(D!==null){D.flags&=-257,qc(D,d,p,s,a),D.mode&1&&Lc(s,S,a),a=D,h=S;var q=a.updateQueue;if(q===null){var M=new Set;M.add(h),a.updateQueue=M}else q.add(h);break e}else{if((a&1)===0){Lc(s,S,a),ti();break e}h=Error(c(426))}}else if(fe&&p.mode&1){var Ce=Oc(d);if(Ce!==null){(Ce.flags&65536)===0&&(Ce.flags|=256),qc(Ce,d,p,s,a),hs(Gr(h,p));break e}}s=h=Gr(h,p),je!==4&&(je=2),Vo===null?Vo=[s]:Vo.push(s),s=d;do{switch(s.tag){case 3:s.flags|=65536,a&=-a,s.lanes|=a;var y=Dc(s,h,a);sc(s,y);break e;case 1:p=h;var v=s.type,C=s.stateNode;if((s.flags&128)===0&&(typeof v.getDerivedStateFromError=="function"||C!==null&&typeof C.componentDidCatch=="function"&&(er===null||!er.has(C)))){s.flags|=65536,a&=-a,s.lanes|=a;var I=Rc(s,p,a);sc(s,I);break e}}s=s.return}while(s!==null)}gd(r)}catch(B){a=B,Pe===r&&r!==null&&(Pe=r=r.return);continue}break}while(!0)}function pd(){var e=Ut.current;return Ut.current=Mt,e===null?Mt:e}function ti(){(je===0||je===3||je===2)&&(je=4),Ie===null||(hr&268435455)===0&&(Ft&268435455)===0||or(Ie,De)}function Zt(e,a){var r=re;re|=2;var t=pd();(Ie!==e||De!==a)&&(Ba=null,vr(e,a));do try{sp();break}catch(n){md(e,n)}while(!0);if(vs(),re=r,Ut.current=t,Pe!==null)throw Error(c(261));return Ie=null,De=0,je}function sp(){for(;Pe!==null;)fd(Pe)}function ip(){for(;Pe!==null&&!Tu();)fd(Pe)}function fd(e){var a=vd(e.alternate,e,ta);e.memoizedProps=e.pendingProps,a===null?gd(e):Pe=a,Ys.current=null}function gd(e){var a=e;do{var r=a.alternate;if(e=a.return,(a.flags&32768)===0){if(r=Jm(r,a,ta),r!==null){Pe=r;return}}else{if(r=ep(r,a),r!==null){r.flags&=32767,Pe=r;return}if(e!==null)e.flags|=32768,e.subtreeFlags=0,e.deletions=null;else{je=6,Pe=null;return}}if(a=a.sibling,a!==null){Pe=a;return}Pe=a=e}while(a!==null);je===0&&(je=5)}function xr(e,a,r){var t=le,n=ma.transition;try{ma.transition=null,le=1,lp(e,a,r,t)}finally{ma.transition=n,le=t}return null}function lp(e,a,r,t){do Zr();while(ar!==null);if((re&6)!==0)throw Error(c(327));r=e.finishedWork;var n=e.finishedLanes;if(r===null)return null;if(e.finishedWork=null,e.finishedLanes=0,r===e.current)throw Error(c(177));e.callbackNode=null,e.callbackPriority=0;var s=r.lanes|r.childLanes;if(Hu(e,s),e===Ie&&(Pe=Ie=null,De=0),(r.subtreeFlags&2064)===0&&(r.flags&2064)===0||Gt||(Gt=!0,xd(at,function(){return Zr(),null})),s=(r.flags&15990)!==0,(r.subtreeFlags&15990)!==0||s){s=ma.transition,ma.transition=null;var d=le;le=1;var p=re;re|=4,Ys.current=null,rp(e,r),nd(r,e),wm(ns),lt=!!ts,ns=ts=null,e.current=r,op(r),Du(),re=p,le=d,ma.transition=s}else e.current=r;if(Gt&&(Gt=!1,ar=e,Qt=n),s=e.pendingLanes,s===0&&(er=null),Ou(r.stateNode),Ke(e,ye()),a!==null)for(t=e.onRecoverableError,r=0;r<a.length;r++)n=a[r],t(n.value,{componentStack:n.stack,digest:n.digest});if(Wt)throw Wt=!1,e=Xs,Xs=null,e;return(Qt&1)!==0&&e.tag!==0&&Zr(),s=e.pendingLanes,(s&1)!==0?e===Js?Bo++:(Bo=0,Js=e):Bo=0,Ka(),null}function Zr(){if(ar!==null){var e=rl(Qt),a=ma.transition,r=le;try{if(ma.transition=null,le=16>e?16:e,ar===null)var t=!1;else{if(e=ar,ar=null,Qt=0,(re&6)!==0)throw Error(c(331));var n=re;for(re|=4,L=e.current;L!==null;){var s=L,d=s.child;if((L.flags&16)!==0){var p=s.deletions;if(p!==null){for(var h=0;h<p.length;h++){var S=p[h];for(L=S;L!==null;){var w=L;switch(w.tag){case 0:case 11:case 15:qo(8,w,s)}var z=w.child;if(z!==null)z.return=w,L=z;else for(;L!==null;){w=L;var N=w.sibling,D=w.return;if(ed(w),w===S){L=null;break}if(N!==null){N.return=D,L=N;break}L=D}}}var q=s.alternate;if(q!==null){var M=q.child;if(M!==null){q.child=null;do{var Ce=M.sibling;M.sibling=null,M=Ce}while(M!==null)}}L=s}}if((s.subtreeFlags&2064)!==0&&d!==null)d.return=s,L=d;else e:for(;L!==null;){if(s=L,(s.flags&2048)!==0)switch(s.tag){case 0:case 11:case 15:qo(9,s,s.return)}var y=s.sibling;if(y!==null){y.return=s.return,L=y;break e}L=s.return}}var v=e.current;for(L=v;L!==null;){d=L;var C=d.child;if((d.subtreeFlags&2064)!==0&&C!==null)C.return=d,L=C;else e:for(d=v;L!==null;){if(p=L,(p.flags&2048)!==0)try{switch(p.tag){case 0:case 11:case 15:_t(9,p)}}catch(B){xe(p,p.return,B)}if(p===d){L=null;break e}var I=p.sibling;if(I!==null){I.return=p.return,L=I;break e}L=p.return}}if(re=n,Ka(),ja&&typeof ja.onPostCommitFiberRoot=="function")try{ja.onPostCommitFiberRoot(rt,e)}catch{}t=!0}return t}finally{le=r,ma.transition=a}}return!1}function hd(e,a,r){a=Gr(r,a),a=Dc(e,a,1),e=Xa(e,a,1),a=_e(),e!==null&&(co(e,1,a),Ke(e,a))}function xe(e,a,r){if(e.tag===3)hd(e,e,r);else for(;a!==null;){if(a.tag===3){hd(a,e,r);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(er===null||!er.has(t))){e=Gr(r,e),e=Rc(a,e,1),a=Xa(a,e,1),e=_e(),a!==null&&(co(a,1,e),Ke(a,e));break}}a=a.return}}function cp(e,a,r){var t=e.pingCache;t!==null&&t.delete(a),a=_e(),e.pingedLanes|=e.suspendedLanes&r,Ie===e&&(De&r)===r&&(je===4||je===3&&(De&130023424)===De&&500>ye()-Zs?vr(e,0):Ks|=r),Ke(e,a)}function bd(e,a){a===0&&((e.mode&1)===0?a=1:(a=tt,tt<<=1,(tt&130023424)===0&&(tt=4194304)));var r=_e();e=qa(e,a),e!==null&&(co(e,a,r),Ke(e,r))}function dp(e){var a=e.memoizedState,r=0;a!==null&&(r=a.retryLane),bd(e,r)}function up(e,a){var r=0;switch(e.tag){case 13:var t=e.stateNode,n=e.memoizedState;n!==null&&(r=n.retryLane);break;case 19:t=e.stateNode;break;default:throw Error(c(314))}t!==null&&t.delete(a),bd(e,r)}var vd;vd=function(e,a,r){if(e!==null)if(e.memoizedProps!==a.pendingProps||We.current)Qe=!0;else{if((e.lanes&r)===0&&(a.flags&128)===0)return Qe=!1,Xm(e,a,r);Qe=(e.flags&131072)!==0}else Qe=!1,fe&&(a.flags&1048576)!==0&&Kl(a,Nt,a.index);switch(a.lanes=0,a.tag){case 2:var t=a.type;$t(e,a),e=a.pendingProps;var n=Vr(a,Le.current);Fr(a,r),n=zs(null,a,t,e,n,r);var s=Is();return a.flags|=1,typeof n=="object"&&n!==null&&typeof n.render=="function"&&n.$$typeof===void 0?(a.tag=1,a.memoizedState=null,a.updateQueue=null,Ge(t)?(s=!0,At(a)):s=!1,a.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,Ss(a),n.updater=Vt,a.stateNode=n,n._reactInternals=a,Os(a,t,e,r),a=Bs(null,a,t,!0,s,r)):(a.tag=0,fe&&s&&ms(a),He(null,a,n,r),a=a.child),a;case 16:t=a.elementType;e:{switch($t(e,a),e=a.pendingProps,n=t._init,t=n(t._payload),a.type=t,n=a.tag=pp(t),e=ya(t,e),n){case 0:a=Vs(null,a,t,e,r);break e;case 1:a=_c(null,a,t,e,r);break e;case 11:a=Mc(null,a,t,e,r);break e;case 14:a=Vc(null,a,t,ya(t.type,e),r);break e}throw Error(c(306,t,""))}return a;case 0:return t=a.type,n=a.pendingProps,n=a.elementType===t?n:ya(t,n),Vs(e,a,t,n,r);case 1:return t=a.type,n=a.pendingProps,n=a.elementType===t?n:ya(t,n),_c(e,a,t,n,r);case 3:e:{if(Uc(a),e===null)throw Error(c(387));t=a.pendingProps,s=a.memoizedState,n=s.element,nc(e,a),Tt(a,t,null,r);var d=a.memoizedState;if(t=d.element,s.isDehydrated)if(s={element:t,isDehydrated:!1,cache:d.cache,pendingSuspenseBoundaries:d.pendingSuspenseBoundaries,transitions:d.transitions},a.updateQueue.baseState=s,a.memoizedState=s,a.flags&256){n=Gr(Error(c(423)),a),a=Fc(e,a,t,r,n);break e}else if(t!==n){n=Gr(Error(c(424)),a),a=Fc(e,a,t,r,n);break e}else for(oa=Ga(a.stateNode.containerInfo.firstChild),ra=a,fe=!0,xa=null,r=oc(a,null,t,r),a.child=r;r;)r.flags=r.flags&-3|4096,r=r.sibling;else{if(Hr(),t===n){a=Va(e,a,r);break e}He(e,a,t,r)}a=a.child}return a;case 5:return lc(a),e===null&&gs(a),t=a.type,n=a.pendingProps,s=e!==null?e.memoizedProps:null,d=n.children,ss(t,n)?d=null:s!==null&&ss(t,s)&&(a.flags|=32),Hc(e,a),He(e,a,d,r),a.child;case 6:return e===null&&gs(a),null;case 13:return Wc(e,a,r);case 4:return As(a,a.stateNode.containerInfo),t=a.pendingProps,e===null?a.child=_r(a,null,t,r):He(e,a,t,r),a.child;case 11:return t=a.type,n=a.pendingProps,n=a.elementType===t?n:ya(t,n),Mc(e,a,t,n,r);case 7:return He(e,a,a.pendingProps,r),a.child;case 8:return He(e,a,a.pendingProps.children,r),a.child;case 12:return He(e,a,a.pendingProps.children,r),a.child;case 10:e:{if(t=a.type._context,n=a.pendingProps,s=a.memoizedProps,d=n.value,de(zt,t._currentValue),t._currentValue=d,s!==null)if(va(s.value,d)){if(s.children===n.children&&!We.current){a=Va(e,a,r);break e}}else for(s=a.child,s!==null&&(s.return=a);s!==null;){var p=s.dependencies;if(p!==null){d=s.child;for(var h=p.firstContext;h!==null;){if(h.context===t){if(s.tag===1){h=Ma(-1,r&-r),h.tag=2;var S=s.updateQueue;if(S!==null){S=S.shared;var w=S.pending;w===null?h.next=h:(h.next=w.next,w.next=h),S.pending=h}}s.lanes|=r,h=s.alternate,h!==null&&(h.lanes|=r),ys(s.return,r,a),p.lanes|=r;break}h=h.next}}else if(s.tag===10)d=s.type===a.type?null:s.child;else if(s.tag===18){if(d=s.return,d===null)throw Error(c(341));d.lanes|=r,p=d.alternate,p!==null&&(p.lanes|=r),ys(d,r,a),d=s.sibling}else d=s.child;if(d!==null)d.return=s;else for(d=s;d!==null;){if(d===a){d=null;break}if(s=d.sibling,s!==null){s.return=d.return,d=s;break}d=d.return}s=d}He(e,a,n.children,r),a=a.child}return a;case 9:return n=a.type,t=a.pendingProps.children,Fr(a,r),n=da(n),t=t(n),a.flags|=1,He(e,a,t,r),a.child;case 14:return t=a.type,n=ya(t,a.pendingProps),n=ya(t.type,n),Vc(e,a,t,n,r);case 15:return Bc(e,a,a.type,a.pendingProps,r);case 17:return t=a.type,n=a.pendingProps,n=a.elementType===t?n:ya(t,n),$t(e,a),a.tag=1,Ge(t)?(e=!0,At(a)):e=!1,Fr(a,r),Ec(a,t,n),Os(a,t,n,r),Bs(null,a,t,!0,e,r);case 19:return Qc(e,a,r);case 22:return $c(e,a,r)}throw Error(c(156,a.tag))};function xd(e,a){return Zi(e,a)}function mp(e,a,r,t){this.tag=e,this.key=r,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=a,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function pa(e,a,r,t){return new mp(e,a,r,t)}function ni(e){return e=e.prototype,!(!e||!e.isReactComponent)}function pp(e){if(typeof e=="function")return ni(e)?1:0;if(e!=null){if(e=e.$$typeof,e===Xe)return 11;if(e===Na)return 14}return 2}function tr(e,a){var r=e.alternate;return r===null?(r=pa(e.tag,a,e.key,e.mode),r.elementType=e.elementType,r.type=e.type,r.stateNode=e.stateNode,r.alternate=e,e.alternate=r):(r.pendingProps=a,r.type=e.type,r.flags=0,r.subtreeFlags=0,r.deletions=null),r.flags=e.flags&14680064,r.childLanes=e.childLanes,r.lanes=e.lanes,r.child=e.child,r.memoizedProps=e.memoizedProps,r.memoizedState=e.memoizedState,r.updateQueue=e.updateQueue,a=e.dependencies,r.dependencies=a===null?null:{lanes:a.lanes,firstContext:a.firstContext},r.sibling=e.sibling,r.index=e.index,r.ref=e.ref,r}function Xt(e,a,r,t,n,s){var d=2;if(t=e,typeof e=="function")ni(e)&&(d=1);else if(typeof e=="string")d=5;else e:switch(e){case Re:return yr(r.children,n,s,a);case P:d=8,n|=8;break;case W:return e=pa(12,r,a,n|2),e.elementType=W,e.lanes=s,e;case Je:return e=pa(13,r,a,n),e.elementType=Je,e.lanes=s,e;case ha:return e=pa(19,r,a,n),e.elementType=ha,e.lanes=s,e;case ve:return Jt(r,n,s,a);default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case ke:d=10;break e;case ia:d=9;break e;case Xe:d=11;break e;case Na:d=14;break e;case Fe:d=16,t=null;break e}throw Error(c(130,e==null?e:typeof e,""))}return a=pa(d,r,a,n),a.elementType=e,a.type=t,a.lanes=s,a}function yr(e,a,r,t){return e=pa(7,e,t,a),e.lanes=r,e}function Jt(e,a,r,t){return e=pa(22,e,t,a),e.elementType=ve,e.lanes=r,e.stateNode={isHidden:!1},e}function si(e,a,r){return e=pa(6,e,null,a),e.lanes=r,e}function ii(e,a,r){return a=pa(4,e.children!==null?e.children:[],e.key,a),a.lanes=r,a.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},a}function fp(e,a,r,t,n){this.tag=a,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Ln(0),this.expirationTimes=Ln(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Ln(0),this.identifierPrefix=t,this.onRecoverableError=n,this.mutableSourceEagerHydrationData=null}function li(e,a,r,t,n,s,d,p,h){return e=new fp(e,a,r,p,h),a===1?(a=1,s===!0&&(a|=8)):a=0,s=pa(3,null,null,a),e.current=s,s.stateNode=e,s.memoizedState={element:t,isDehydrated:r,cache:null,transitions:null,pendingSuspenseBoundaries:null},Ss(s),e}function gp(e,a,r){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:se,key:t==null?null:""+t,children:e,containerInfo:a,implementation:r}}function yd(e){if(!e)return Ya;e=e._reactInternals;e:{if(lr(e)!==e||e.tag!==1)throw Error(c(170));var a=e;do{switch(a.tag){case 3:a=a.stateNode.context;break e;case 1:if(Ge(a.type)){a=a.stateNode.__reactInternalMemoizedMergedChildContext;break e}}a=a.return}while(a!==null);throw Error(c(171))}if(e.tag===1){var r=e.type;if(Ge(r))return Gl(e,r,a)}return a}function Cd(e,a,r,t,n,s,d,p,h){return e=li(r,t,!0,e,n,s,d,p,h),e.context=yd(null),r=e.current,t=_e(),n=rr(r),s=Ma(t,n),s.callback=a??null,Xa(r,s,n),e.current.lanes=n,co(e,n,t),Ke(e,t),e}function en(e,a,r,t){var n=a.current,s=_e(),d=rr(n);return r=yd(r),a.context===null?a.context=r:a.pendingContext=r,a=Ma(s,d),a.payload={element:e},t=t===void 0?null:t,t!==null&&(a.callback=t),e=Xa(n,a,d),e!==null&&(Aa(e,n,d,s),Et(e,n,d)),d}function an(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Sd(e,a){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var r=e.retryLane;e.retryLane=r!==0&&r<a?r:a}}function ci(e,a){Sd(e,a),(e=e.alternate)&&Sd(e,a)}function hp(){return null}var Ad=typeof reportError=="function"?reportError:function(e){console.error(e)};function di(e){this._internalRoot=e}rn.prototype.render=di.prototype.render=function(e){var a=this._internalRoot;if(a===null)throw Error(c(409));en(e,a,null,null)},rn.prototype.unmount=di.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var a=e.containerInfo;br(function(){en(null,e,null,null)}),a[Da]=null}};function rn(e){this._internalRoot=e}rn.prototype.unstable_scheduleHydration=function(e){if(e){var a=nl();e={blockedOn:null,target:e,priority:a};for(var r=0;r<Ua.length&&a!==0&&a<Ua[r].priority;r++);Ua.splice(r,0,e),r===0&&ll(e)}};function ui(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function on(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function kd(){}function bp(e,a,r,t,n){if(n){if(typeof t=="function"){var s=t;t=function(){var S=an(d);s.call(S)}}var d=Cd(a,t,e,0,null,!1,!1,"",kd);return e._reactRootContainer=d,e[Da]=d.current,ko(e.nodeType===8?e.parentNode:e),br(),d}for(;n=e.lastChild;)e.removeChild(n);if(typeof t=="function"){var p=t;t=function(){var S=an(h);p.call(S)}}var h=li(e,0,!1,null,null,!1,!1,"",kd);return e._reactRootContainer=h,e[Da]=h.current,ko(e.nodeType===8?e.parentNode:e),br(function(){en(a,h,r,t)}),h}function tn(e,a,r,t,n){var s=r._reactRootContainer;if(s){var d=s;if(typeof n=="function"){var p=n;n=function(){var h=an(d);p.call(h)}}en(a,d,e,n)}else d=bp(r,a,e,n,t);return an(d)}ol=function(e){switch(e.tag){case 3:var a=e.stateNode;if(a.current.memoizedState.isDehydrated){var r=lo(a.pendingLanes);r!==0&&(On(a,r|1),Ke(a,ye()),(re&6)===0&&(Kr=ye()+500,Ka()))}break;case 13:br(function(){var t=qa(e,1);if(t!==null){var n=_e();Aa(t,e,1,n)}}),ci(e,1)}},qn=function(e){if(e.tag===13){var a=qa(e,134217728);if(a!==null){var r=_e();Aa(a,e,134217728,r)}ci(e,134217728)}},tl=function(e){if(e.tag===13){var a=rr(e),r=qa(e,a);if(r!==null){var t=_e();Aa(r,e,a,t)}ci(e,a)}},nl=function(){return le},sl=function(e,a){var r=le;try{return le=e,a()}finally{le=r}},zn=function(e,a,r){switch(a){case"input":if(Cn(e,r),a=r.name,r.type==="radio"&&a!=null){for(r=e;r.parentNode;)r=r.parentNode;for(r=r.querySelectorAll("input[name="+JSON.stringify(""+a)+'][type="radio"]'),a=0;a<r.length;a++){var t=r[a];if(t!==e&&t.form===e.form){var n=Ct(t);if(!n)throw Error(c(90));Ii(t),Cn(t,n)}}}break;case"textarea":Li(e,r);break;case"select":a=r.value,a!=null&&jr(e,!!r.multiple,a,!1)}},Ui=ri,Fi=br;var vp={usingClientEntryPoint:!1,Events:[jo,qr,Ct,Hi,_i,ri]},$o={findFiberByHostInstance:cr,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},xp={bundleType:$o.bundleType,version:$o.version,rendererPackageName:$o.rendererPackageName,rendererConfig:$o.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:be.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Yi(e),e===null?null:e.stateNode},findFiberByHostInstance:$o.findFiberByHostInstance||hp,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var nn=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!nn.isDisabled&&nn.supportsFiber)try{rt=nn.inject(xp),ja=nn}catch{}}return Ze.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=vp,Ze.createPortal=function(e,a){var r=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!ui(a))throw Error(c(200));return gp(e,a,null,r)},Ze.createRoot=function(e,a){if(!ui(e))throw Error(c(299));var r=!1,t="",n=Ad;return a!=null&&(a.unstable_strictMode===!0&&(r=!0),a.identifierPrefix!==void 0&&(t=a.identifierPrefix),a.onRecoverableError!==void 0&&(n=a.onRecoverableError)),a=li(e,1,!1,null,null,r,!1,t,n),e[Da]=a.current,ko(e.nodeType===8?e.parentNode:e),new di(a)},Ze.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var a=e._reactInternals;if(a===void 0)throw typeof e.render=="function"?Error(c(188)):(e=Object.keys(e).join(","),Error(c(268,e)));return e=Yi(a),e=e===null?null:e.stateNode,e},Ze.flushSync=function(e){return br(e)},Ze.hydrate=function(e,a,r){if(!on(a))throw Error(c(200));return tn(null,e,a,!0,r)},Ze.hydrateRoot=function(e,a,r){if(!ui(e))throw Error(c(405));var t=r!=null&&r.hydratedSources||null,n=!1,s="",d=Ad;if(r!=null&&(r.unstable_strictMode===!0&&(n=!0),r.identifierPrefix!==void 0&&(s=r.identifierPrefix),r.onRecoverableError!==void 0&&(d=r.onRecoverableError)),a=Cd(a,null,e,1,r??null,n,!1,s,d),e[Da]=a.current,ko(e),t)for(e=0;e<t.length;e++)r=t[e],n=r._getVersion,n=n(r._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[r,n]:a.mutableSourceEagerHydrationData.push(r,n);return new rn(a)},Ze.render=function(e,a,r){if(!on(a))throw Error(c(200));return tn(null,e,a,!1,r)},Ze.unmountComponentAtNode=function(e){if(!on(e))throw Error(c(40));return e._reactRootContainer?(br(function(){tn(null,null,e,!1,function(){e._reactRootContainer=null,e[Da]=null})}),!0):!1},Ze.unstable_batchedUpdates=ri,Ze.unstable_renderSubtreeIntoContainer=function(e,a,r,t){if(!on(r))throw Error(c(200));if(e==null||e._reactInternals===void 0)throw Error(c(38));return tn(e,a,r,!1,t)},Ze.version="18.3.1-next-f1338f8080-20240426",Ze}var Od;function jp(){if(Od)return mi.exports;Od=1;function i(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(i)}catch(l){console.error(l)}}return i(),mi.exports=Np(),mi.exports}var qd;function wp(){if(qd)return sn;qd=1;var i=jp();return sn.createRoot=i.createRoot,sn.hydrateRoot=i.hydrateRoot,sn}var zp=wp(),Ae=vi();function Md(){return Ae.useEffect(()=>{if(!document.getElementById("cristal-css")){const l=document.createElement("link");l.id="cristal-css",l.rel="stylesheet",l.href="/chat/cristal.css",document.head.appendChild(l)}const i=document.createElement("script");return i.src="/chat/cristal-config.js",i.onload=()=>{const l=document.createElement("script");l.src="/chat/cristal.js",document.body.appendChild(l)},document.body.appendChild(i),()=>{const l=document.getElementById("cristal-mount");l&&l.remove()}},[]),null}const sa=({title:i,subtitle:l,ctaLabel:c,onCta:m,overlayOpacity:u=.82,brightness:f=.45})=>o.jsxs("section",{className:"relative min-h-[70vh] flex items-center overflow-hidden",children:[o.jsx("video",{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",poster:"/videos/reels-poster.webp",className:"absolute inset-0 w-full h-full object-cover",style:{filter:`brightness(${f}) contrast(1) saturate(0.8)`},"aria-hidden":"true",children:o.jsx("source",{src:"/videos/reels-10s.mp4",type:"video/mp4"})}),o.jsx("div",{className:"absolute inset-0",style:{backgroundColor:`rgba(0, 0, 0, ${u})`}}),o.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-background/90 via-background/70 to-background/50"}),i&&o.jsxs("div",{className:"relative z-10 max-w-4xl mx-auto px-6 text-center",children:[i&&o.jsx("h1",{className:"font-serif text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 text-foreground",children:i}),l&&o.jsx("p",{className:"text-muted-foreground text-lg leading-relaxed mb-8 max-w-2xl mx-auto",children:l}),c&&m&&o.jsx("button",{onClick:m,className:"bg-accent text-accent-foreground px-8 py-3 rounded-full font-medium hover:opacity-90 transition-opacity inline-flex items-center gap-2",children:c})]})]});function xi(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Nr=xi();function cu(i){Nr=i}var Sr={exec:()=>null};function Xr(i){let l=[];return c=>{let m=Math.max(0,Math.min(3,c-1)),u=l[m];return u||(u=i(m),l[m]=u),u}}function ee(i,l=""){let c=typeof i=="string"?i:i.source,m={replace:(u,f)=>{let g=typeof f=="string"?f:f.source;return g=g.replace(Ve.caret,"$1"),c=c.replace(u,g),m},getRegex:()=>new RegExp(c,l)};return m}var Ip=((i="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+i)}catch{return!1}})(),Ve={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:i=>new RegExp(`^( {0,3}${i})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:Xr(i=>new RegExp(`^ {0,${i}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:Xr(i=>new RegExp(`^ {0,${i}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:Xr(i=>new RegExp(`^ {0,${i}}(?:\`\`\`|~~~)`)),headingBeginRegex:Xr(i=>new RegExp(`^ {0,${i}}#`)),htmlBeginRegex:Xr(i=>new RegExp(`^ {0,${i}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:Xr(i=>new RegExp(`^ {0,${i}}>`))},Ep=/^(?:[ \t]*(?:\n|$))+/,Tp=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Dp=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Qo=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Rp=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,yi=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,du=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,uu=ee(du).replace(/bull/g,yi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Lp=ee(du).replace(/bull/g,yi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}(?:\s|$)/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ci=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table|[ \t]+\n)[^\n]+)*)/,Op=/^[^\n]+/,Si=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,qp=ee(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Si).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Mp=ee(/^(bull)([ \t][^\n]*?)?(?:\n|$)/).replace(/bull/g,yi).getRegex(),hn="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ai=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Vp=ee("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n*|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>[^\\n]*\\n*|$)|<![A-Z][\\s\\S]*?(?:>[^\\n]*\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>[^\\n]*\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Ai).replace("tag",hn).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),mu=i=>ee(Ci).replace("hr",Qo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace("list",i).replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",hn).getRegex(),Bp=mu(/ {0,3}(?:[*+-]|1[.)])[ \t]+[^ \t\n]/),$p=mu(/ {0,3}(?:[*+-]|\d{1,9}[.)])(?:[ \t]|\n|$)/),Hp=ee(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",$p).getRegex(),ki={blockquote:Hp,code:Tp,def:qp,fences:Dp,heading:Rp,hr:Qo,html:Vp,lheading:uu,list:Mp,newline:Ep,paragraph:Bp,table:Sr,text:Op},Vd=ee("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Qo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",hn).getRegex(),_p={...ki,lheading:Lp,table:Vd,paragraph:ee(Ci).replace("hr",Qo).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Vd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~~~)[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",hn).getRegex()},Up={...ki,html:ee(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ai).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Sr,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:ee(Ci).replace("hr",Qo).replace("heading",` *#{1,6} *[^
]`).replace("lheading",uu).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Fp=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Wp=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,pu=/^( {2,}|\\)\n(?!\s*$)/,Gp=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ao=/[\p{P}\p{S}]/u,bn=/[\s\p{P}\p{S}]/u,Pi=/[^\s\p{P}\p{S}]/u,Qp=ee(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,bn).getRegex(),fu=/(?!~)[\p{P}\p{S}]/u,Yp=/(?!~)[\s\p{P}\p{S}]/u,Kp=/(?:[^\s\p{P}\p{S}]|~)/u,Zp=ee(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Ip?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),gu=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Xp=ee(gu,"u").replace(/punct/g,ao).getRegex(),Jp=ee(gu,"u").replace(/punct/g,fu).getRegex(),hu="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",ef=ee(hu,"gu").replace(/notPunctSpace/g,Pi).replace(/punctSpace/g,bn).replace(/punct/g,ao).getRegex(),af=ee(hu,"gu").replace(/notPunctSpace/g,Kp).replace(/punctSpace/g,Yp).replace(/punct/g,fu).getRegex(),rf=ee("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Pi).replace(/punctSpace/g,bn).replace(/punct/g,ao).getRegex(),of=ee(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ao).getRegex(),tf="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",nf=ee(tf,"gu").replace(/notPunctSpace/g,Pi).replace(/punctSpace/g,bn).replace(/punct/g,ao).getRegex(),sf=ee(/\\(punct)/,"gu").replace(/punct/g,ao).getRegex(),lf=ee(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),cf=ee(Ai).replace("(?:-->|$)","-->").getRegex(),df=ee("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",cf).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),un=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,uf=ee(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",un).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]+|(?=\))/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),bu=ee(/^!?\[(label)\]\[(ref)\]/).replace("label",un).replace("ref",Si).getRegex(),vu=ee(/^!?\[(ref)\](?:\[\])?/).replace("ref",Si).getRegex(),mf=ee("reflink|nolink(?!\\()","g").replace("reflink",bu).replace("nolink",vu).getRegex(),Bd=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ni={_backpedal:Sr,anyPunctuation:sf,autolink:lf,blockSkip:Zp,br:pu,code:Wp,del:Sr,delLDelim:Sr,delRDelim:Sr,emStrongLDelim:Xp,emStrongRDelimAst:ef,emStrongRDelimUnd:rf,escape:Fp,link:uf,nolink:vu,punctuation:Qp,reflink:bu,reflinkSearch:mf,tag:df,text:Gp,url:Sr},pf={...Ni,link:ee(/^!?\[(label)\]\((.*?)\)/).replace("label",un).getRegex(),reflink:ee(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",un).getRegex()},fi={...Ni,emStrongRDelimAst:af,emStrongLDelim:Jp,delLDelim:of,delRDelim:nf,url:ee(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Bd).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:ee(/^(`+|~+|[^`~])(?:(?=[`~])|(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Bd).getRegex()},ff={...fi,br:ee(pu).replace("{2,}","*").getRegex(),text:ee(fi.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ln={normal:ki,gfm:_p,pedantic:Up},_o={normal:Ni,gfm:fi,breaks:ff,pedantic:pf},gf={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$d=i=>gf[i];function Ta(i,l){if(l){if(Ve.escapeTest.test(i))return i.replace(Ve.escapeReplace,$d)}else if(Ve.escapeTestNoEncode.test(i))return i.replace(Ve.escapeReplaceNoEncode,$d);return i}function Hd(i){try{i=encodeURI(i).replace(Ve.percentDecode,"%")}catch{return null}return i}function _d(i,l){let c=i.replace(Ve.findPipe,(f,g,b)=>{let k=!1,A=g;for(;--A>=0&&b[A]==="\\";)k=!k;return k?"|":" |"}),m=c.split(Ve.splitPipe),u=0;if(m[0].trim()||m.shift(),m.length>0&&!m.at(-1)?.trim()&&m.pop(),l)if(m.length>l)m.splice(l);else for(;m.length<l;)m.push("");for(;u<m.length;u++)m[u]=m[u].trim().replace(Ve.slashPipe,"|");return m}function sr(i,l,c){let m=i.length;if(m===0)return"";let u=0;for(;u<m&&i.charAt(m-u-1)===l;)u++;return i.slice(0,m-u)}function Ud(i){let l=i.split(`
`),c=l.length-1;for(;c>=0&&Ve.blankLine.test(l[c]);)c--;return l.length-c<=2?i:l.slice(0,c+1).join(`
`)}function hf(i,l){if(i.indexOf(l[1])===-1)return-1;let c=0;for(let m=0;m<i.length;m++)if(i[m]==="\\")m++;else if(i[m]===l[0])c++;else if(i[m]===l[1]&&(c--,c<0))return m;return c>0?-2:-1}function bf(i,l=0){let c=l,m="";for(let u of i)if(u==="	"){let f=4-c%4;m+=" ".repeat(f),c+=f}else m+=u,c++;return m}function Fd(i,l,c,m,u){let f=l.href,g=l.title||null,b=i[1].replace(u.other.outputLinkReplace,"$1");m.state.inLink=!0;let k={type:i[0].charAt(0)==="!"?"image":"link",raw:c,href:f,title:g,text:b,tokens:m.inlineTokens(b)};return m.state.inLink=!1,k}function vf(i,l,c){let m=i.match(c.other.indentCodeCompensation);if(m===null)return l;let u=m[1];return l.split(`
`).map(f=>{let g=f.match(c.other.beginningSpace);if(g===null)return f;let[b]=g;return b.length>=u.length?f.slice(u.length):f}).join(`
`)}var mn=class{options;rules;lexer;constructor(i){this.options=i||Nr}space(i){let l=this.rules.block.newline.exec(i);if(l&&l[0].length>0)return{type:"space",raw:l[0]}}code(i){let l=this.rules.block.code.exec(i);if(l){let c=this.options.pedantic?l[0]:Ud(l[0]),m=c.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:c,codeBlockStyle:"indented",text:m}}}fences(i){let l=this.rules.block.fences.exec(i);if(l){let c=l[0],m=vf(c,l[3]||"",this.rules);return{type:"code",raw:c,lang:l[2]?l[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):l[2],text:m}}}heading(i){let l=this.rules.block.heading.exec(i);if(l){let c=l[2].trim();if(this.rules.other.endingHash.test(c)){let m=sr(c,"#");(this.options.pedantic||!m||this.rules.other.endingSpaceChar.test(m))&&(c=m.trim())}return{type:"heading",raw:sr(l[0],`
...
`).split(`
`),m="",u="",f=[];for(;c.length>0;){let g=!1,b=[],k;for(k=0;k<c.length;k++)if(this.rules.other.blockquoteStart.test(c[k]))b.push(c[k]),g=!0;else if(!g)b.push(c[k]);else break;c=c.slice(k);let A=b.join(`
`),R=A.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");m=m?`${m}
${A}`:A,u=u?`${u}
${R}`:R;let E=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(R,f,!0),this.lexer.state.top=E,c.length===0)break;let V=f.at(-1);if(V?.type==="code")break;if(V?.type==="blockquote"){let ae=V,K=ae.raw+`
`+c.join(`
...
`);continue}}return{type:"blockquote",raw:m,tokens:f,text:u}}}list(i){let l=this.rules.block.list.exec(i);if(l){let c=l[1].trim(),m=c.length>1,u={type:"list",raw:"",ordered:m,start:m?+c.slice(0,-1):"",loose:!1,items:[]};c=m?`\\d{1,9}\\${c.slice(-1)}`:`\\${c}`,this.options.pedantic&&(c=m?c:"[*+-]");let f=this.rules.other.listItemRegex(c),g=!1;for(;i;){let k=!1,A="",R="";if(!(l=f.exec(i))||this.rules.block.hr.test(i))break;A=l[0],i=i.substring(A.length);let E=bf(l[2].split(`
`,1)[0],l[1].length),V=i.split(`
`,1)[0],ae=!E.trim(),K=0;if(this.options.pedantic?(K=2,R=E.trimStart()):ae?K=l[1].length+1:(K=E.search(this.rules.other.nonSpaceChar),K=K>4?1:K,R=E.slice(K),K+=l[1].length),ae&&this.rules.other.blankLine.test(V)&&(A+=V+`
`,i=i.substring(V.length+1),k=!0),!k){let X=this.rules.other.nextBulletRegex(K),J=this.rules.other.hrRegex(K),Ue=this.rules.other.fencesBeginRegex(K),Be=this.rules.other.headingBeginRegex(K),$e=this.rules.other.htmlBeginRegex(K),be=this.rules.other.blockquoteBeginRegex(K);for(;i;){let we=i.split(`
`,1)[0],se;if(V=we,this.options.pedantic?(V=V.replace(this.rules.other.listReplaceNesting,"  "),se=V):se=V.replace(this.rules.other.tabCharGlobal,"    "),Ue.test(V)||Be.test(V)||$e.test(V)||be.test(V)||X.test(V)||J.test(V))break;if(se.search(this.rules.other.nonSpaceChar)>=K||!V.trim())R+=`
`+se.slice(K);else{if(ae||E.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||Ue.test(E)||Be.test(E)||J.test(E))break;R+=`
`+V}ae=!V.trim(),A+=we+`
`,i=i.substring(we.length+1),E=se.slice(K)}}u.loose||(g?u.loose=!0:this.rules.other.doubleBlankLine.test(A)&&(g=!0)),u.items.push({type:"list_item",raw:A,task:!!this.options.gfm&&this.rules.other.listIsTask.test(R),loose:!1,text:R,tokens:[]}),u.raw+=A}let b=u.items.at(-1);if(b)b.raw=b.raw.trimEnd(),b.text=b.text.trimEnd();else return;u.raw=u.raw.trimEnd();for(let k of u.items){this.lexer.state.top=!1,k.tokens=this.lexer.blockTokens(k.text,[]);let A=k.tokens[0];if(k.task&&(A?.type==="text"||A?.type==="paragraph")){k.text=k.text.replace(this.rules.other.listReplaceTask,""),A.raw=A.raw.replace(this.rules.other.listReplaceTask,""),A.text=A.text.replace(this.rules.other.listReplaceTask,"");for(let E=this.lexer.inlineQueue.length-1;E>=0;E--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[E].src)){this.lexer.inlineQueue[E].src=this.lexer.inlineQueue[E].src.replace(this.rules.other.listReplaceTask,"");break}let R=this.rules.other.listTaskCheckbox.exec(k.raw);if(R){let E={type:"checkbox",raw:R[0]+" ",checked:R[0]!=="[ ]"};k.checked=E.checked,u.loose?k.tokens[0]&&["paragraph","text"].includes(k.tokens[0].type)&&"tokens"in k.tokens[0]&&k.tokens[0].tokens?(k.tokens[0].raw=E.raw+k.tokens[0].raw,k.tokens[0].text=E.raw+k.tokens[0].text,k.tokens[0].tokens.unshift(E)):k.tokens.unshift({type:"paragraph",raw:E.raw,text:E.raw,tokens:[E]}):k.tokens.unshift(E)}}else k.task&&(k.task=!1);if(!u.loose){let R=k.tokens.filter(V=>V.type==="space"),E=R.length>0&&R.some(V=>this.rules.other.anyLine.test(V.raw));u.loose=E}}if(u.loose)for(let k of u.items){k.loose=!0;for(let A of k.tokens)A.type==="text"&&(A.type="paragraph")}return u}}html(i){let l=this.rules.block.html.exec(i);if(l){let c=Ud(l[0]);return{type:"html",block:!0,raw:c,pre:l[1]==="pre"||l[1]==="script"||l[1]==="style",text:c}}}def(i){let l=this.rules.block.def.exec(i);if(l){let c=l[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),m=l[2]?l[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",u=l[3]?l[3].substring(1,l[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):l[3];return{type:"def",tag:c,raw:sr(l[0],`
`),href:m,title:u}}}table(i){let l=this.rules.block.table.exec(i);if(!l||!this.rules.other.tableDelimiter.test(l[2]))return;let c=_d(l[1]),m=l[2].replace(this.rules.other.tableAlignChars,"").split("|"),u=l[3]?.trim()?l[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],f={type:"table",raw:sr(l[0],`
`),header:[],align:[],rows:[]};if(c.length===m.length){for(let g of m)this.rules.other.tableAlignRight.test(g)?f.align.push("right"):this.rules.other.tableAlignCenter.test(g)?f.align.push("center"):this.rules.other.tableAlignLeft.test(g)?f.align.push("left"):f.align.push(null);for(let g=0;g<c.length;g++)f.header.push({text:c[g],tokens:this.lexer.inline(c[g]),header:!0,align:f.align[g]});for(let g of u)f.rows.push(_d(g,f.header.length).map((b,k)=>({text:b,tokens:this.lexer.inline(b),header:!1,align:f.align[k]})));return f}}lheading(i){let l=this.rules.block.lheading.exec(i);if(l){let c=l[1].trim();return{type:"heading",raw:sr(l[0],`
...
`?l[1].slice(0,-1):l[1];return{type:"paragraph",raw:l[0],text:c,tokens:this.lexer.inline(c)}}}text(i){let l=this.rules.block.text.exec(i);if(l)return{type:"text",raw:l[0],text:l[0],tokens:this.lexer.inline(l[0])}}escape(i){let l=this.rules.inline.escape.exec(i);if(l)return{type:"escape",raw:l[0],text:l[1]}}tag(i){let l=this.rules.inline.tag.exec(i);if(l)return!this.lexer.state.inLink&&this.rules.other.startATag.test(l[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(l[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(l[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(l[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:l[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:l[0]}}link(i){let l=this.rules.inline.link.exec(i);if(l){let c=l[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(c)){if(!this.rules.other.endAngleBracket.test(c))return;let f=sr(c.slice(0,-1),"\\");if((c.length-f.length)%2===0)return}else{let f=hf(l[2],"()");if(f===-2)return;if(f>-1){let g=(l[0].indexOf("!")===0?5:4)+l[1].length+f;l[2]=l[2].substring(0,f),l[0]=l[0].substring(0,g).trim(),l[3]=""}}let m=l[2],u="";if(this.options.pedantic){let f=this.rules.other.pedanticHrefTitle.exec(m);f&&(m=f[1],u=f[3])}else u=l[3]?l[3].slice(1,-1):"";return m=m.trim(),this.rules.other.startAngleBracket.test(m)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(c)?m=m.slice(1):m=m.slice(1,-1)),Fd(l,{href:m&&m.replace(this.rules.inline.anyPunctuation,"$1"),title:u&&u.replace(this.rules.inline.anyPunctuation,"$1")},l[0],this.lexer,this.rules)}}reflink(i,l){let c;if((c=this.rules.inline.reflink.exec(i))||(c=this.rules.inline.nolink.exec(i))){let m=(c[2]||c[1]).replace(this.rules.other.multipleSpaceGlobal," "),u=l[m.toLowerCase()];if(!u){let f=c[0].charAt(0);return{type:"text",raw:f,text:f}}return Fd(c,u,c[0],this.lexer,this.rules)}}emStrong(i,l,c=""){let m=this.rules.inline.emStrongLDelim.exec(i);if(!(!m||!m[1]&&!m[2]&&!m[3]&&!m[4]||m[4]&&c.match(this.rules.other.unicodeAlphaNumeric))&&(!(m[1]||m[3])||!c||this.rules.inline.punctuation.exec(c))){let u=[...m[0]].length-1,f,g,b=u,k=0,A=m[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(A.lastIndex=0,l=l.slice(-1*i.length+u);(m=A.exec(l))!==null;){if(f=m[1]||m[2]||m[3]||m[4]||m[5]||m[6],!f)continue;if(g=[...f].length,m[3]||m[4]){b+=g;continue}else if((m[5]||m[6])&&u%3&&!((u+g)%3)){k+=g;continue}if(b-=g,b>0)continue;g=Math.min(g,g+b+k);let R=[...m[0]][0].length,E=i.slice(0,u+m.index+R+g);if(Math.min(u,g)%2){let ae=E.slice(1,-1);return{type:"em",raw:E,text:ae,tokens:this.lexer.inlineTokens(ae)}}let V=E.slice(2,-2);return{type:"strong",raw:E,text:V,tokens:this.lexer.inlineTokens(V)}}}}codespan(i){let l=this.rules.inline.code.exec(i);if(l){let c=l[2].replace(this.rules.other.newLineCharGlobal," "),m=this.rules.other.nonSpaceChar.test(c),u=this.rules.other.startingSpaceChar.test(c)&&this.rules.other.endingSpaceChar.test(c);return m&&u&&(c=c.substring(1,c.length-1)),{type:"codespan",raw:l[0],text:c}}}br(i){let l=this.rules.inline.br.exec(i);if(l)return{type:"br",raw:l[0]}}del(i,l,c=""){let m=this.rules.inline.delLDelim.exec(i);if(m&&(!m[1]||!c||this.rules.inline.punctuation.exec(c))){let u=[...m[0]].length-1,f,g,b=u,k=this.rules.inline.delRDelim;for(k.lastIndex=0,l=l.slice(-1*i.length+u);(m=k.exec(l))!==null;){if(f=m[1]||m[2]||m[3]||m[4]||m[5]||m[6],!f||(g=[...f].length,g!==u))continue;if(m[3]||m[4]){b+=g;continue}if(b-=g,b>0)continue;g=Math.min(g,g+b);let A=[...m[0]][0].length,R=i.slice(0,u+m.index+A+g),E=R.slice(u,-u);return{type:"del",raw:R,text:E,tokens:this.lexer.inlineTokens(E)}}}}autolink(i){let l=this.rules.inline.autolink.exec(i);if(l){let c,m;return l[2]==="@"?(c=l[1],m="mailto:"+c):(c=l[1],m=c),{type:"link",raw:l[0],text:c,href:m,tokens:[{type:"text",raw:c,text:c}]}}}url(i){let l;if(l=this.rules.inline.url.exec(i)){let c,m;if(l[2]==="@")c=l[0],m="mailto:"+c;else{let u;do u=l[0],l[0]=this.rules.inline._backpedal.exec(l[0])?.[0]??"";while(u!==l[0]);c=l[0],l[1]==="www."?m="http://"+l[0]:m=l[0]}return{type:"link",raw:l[0],text:c,href:m,tokens:[{type:"text",raw:c,text:c}]}}}inlineText(i){let l=this.rules.inline.text.exec(i);if(l){let c=this.lexer.state.inRawBlock;return{type:"text",raw:l[0],text:l[0],escaped:c}}}},ka=class gi{tokens;options;state;inlineQueue;tokenizer;constructor(l){this.tokens=[],this.tokens.links=Object.create(null),this.options=l||Nr,this.options.tokenizer=this.options.tokenizer||new mn,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let c={other:Ve,block:ln.normal,inline:_o.normal};this.options.pedantic?(c.block=ln.pedantic,c.inline=_o.pedantic):this.options.gfm&&(c.block=ln.gfm,this.options.breaks?c.inline=_o.breaks:c.inline=_o.gfm),this.tokenizer.rules=c}static get rules(){return{block:ln,inline:_o}}static lex(l,c){return new gi(c).lex(l)}static lexInline(l,c){return new gi(c).inlineTokens(l)}lex(l){l=l.replace(Ve.carriageReturn,`
`),this.blockTokens(l,this.tokens);for(let c=0;c<this.inlineQueue.length;c++){let m=this.inlineQueue[c];this.inlineTokens(m.src,m.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(l,c=[],m=!1){this.tokenizer.lexer=this,this.options.pedantic&&(l=l.replace(Ve.tabCharGlobal,"    ").replace(Ve.spaceLine,""));let u=1/0;for(;l;){if(l.length<u)u=l.length;else{this.infiniteLoopError(l.charCodeAt(0));break}let f;if(this.options.extensions?.block?.some(b=>(f=b.call({lexer:this},l,c))?(l=l.substring(f.raw.length),c.push(f),!0):!1))continue;if(f=this.tokenizer.space(l)){l=l.substring(f.raw.length);let b=c.at(-1);f.raw.length===1&&b!==void 0?b.raw+=`
`:c.push(f);continue}if(f=this.tokenizer.code(l)){l=l.substring(f.raw.length);let b=c.at(-1);b?.type==="paragraph"||b?.type==="text"?(b.raw+=(b.raw.endsWith(`
`)?"":`
`)+f.raw,b.text+=`
`+f.text,this.inlineQueue.at(-1).src=b.text):c.push(f);continue}if(f=this.tokenizer.fences(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.heading(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.hr(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.blockquote(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.list(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.html(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.def(l)){l=l.substring(f.raw.length);let b=c.at(-1);b?.type==="paragraph"||b?.type==="text"?(b.raw+=(b.raw.endsWith(`
`)?"":`
`)+f.raw,b.text+=`
`+f.raw,this.inlineQueue.at(-1).src=b.text):this.tokens.links[f.tag]||(this.tokens.links[f.tag]={href:f.href,title:f.title},c.push(f));continue}if(f=this.tokenizer.table(l)){l=l.substring(f.raw.length),c.push(f);continue}if(f=this.tokenizer.lheading(l)){l=l.substring(f.raw.length),c.push(f);continue}let g=l;if(this.options.extensions?.startBlock){let b=1/0,k=l.slice(1),A;this.options.extensions.startBlock.forEach(R=>{A=R.call({lexer:this},k),typeof A=="number"&&A>=0&&(b=Math.min(b,A))}),b<1/0&&b>=0&&(g=l.substring(0,b+1))}if(this.state.top&&(f=this.tokenizer.paragraph(g))){let b=c.at(-1);m&&b?.type==="paragraph"?(b.raw+=(b.raw.endsWith(`
`)?"":`
`)+f.raw,b.text+=`
`+f.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=b.text):c.push(f),m=g.length!==l.length,l=l.substring(f.raw.length);continue}if(f=this.tokenizer.text(l)){l=l.substring(f.raw.length);let b=c.at(-1);b?.type==="text"?(b.raw+=(b.raw.endsWith(`
`)?"":`
`)+f.raw,b.text+=`
`+f.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=b.text):c.push(f);continue}if(l){this.infiniteLoopError(l.charCodeAt(0));break}}return this.state.top=!0,c}inline(l,c=[]){return this.inlineQueue.push({src:l,tokens:c}),c}inlineTokens(l,c=[]){this.tokenizer.lexer=this;let m=l;if(this.tokens.links){let b=Object.keys(this.tokens.links);b.length>0&&(m=m.replace(this.tokenizer.rules.inline.reflinkSearch,k=>b.includes(k.slice(k.lastIndexOf("[")+1,-1))?"["+"a".repeat(k.length-2)+"]":k))}m=m.replace(this.tokenizer.rules.inline.anyPunctuation,"++"),m=m.replace(this.tokenizer.rules.inline.blockSkip,(b,k,A)=>{let R=A?A.length:0;return b.slice(0,R)+"["+"a".repeat(b.length-R-2)+"]"}),m=this.options.hooks?.emStrongMask?.call({lexer:this},m)??m;let u=!1,f="",g=1/0;for(;l;){if(l.length<g)g=l.length;else{this.infiniteLoopError(l.charCodeAt(0));break}u||(f=""),u=!1;let b;if(this.options.extensions?.inline?.some(A=>(b=A.call({lexer:this},l,c))?(l=l.substring(b.raw.length),c.push(b),!0):!1))continue;if(b=this.tokenizer.escape(l)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.tag(l)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.link(l)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.reflink(l,this.tokens.links)){l=l.substring(b.raw.length);let A=c.at(-1);b.type==="text"&&A?.type==="text"?(A.raw+=b.raw,A.text+=b.text):c.push(b);continue}if(b=this.tokenizer.emStrong(l,m,f)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.codespan(l)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.br(l)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.del(l,m,f)){l=l.substring(b.raw.length),c.push(b);continue}if(b=this.tokenizer.autolink(l)){l=l.substring(b.raw.length),c.push(b);continue}if(!this.state.inLink&&(b=this.tokenizer.url(l))){l=l.substring(b.raw.length),c.push(b);continue}let k=l;if(this.options.extensions?.startInline){let A=1/0,R=l.slice(1),E;this.options.extensions.startInline.forEach(V=>{E=V.call({lexer:this},R),typeof E=="number"&&E>=0&&(A=Math.min(A,E))}),A<1/0&&A>=0&&(k=l.substring(0,A+1))}if(b=this.tokenizer.inlineText(k)){l=l.substring(b.raw.length),b.raw.slice(-1)!=="_"&&(f=b.raw.slice(-1)),u=!0;let A=c.at(-1);A?.type==="text"?(A.raw+=b.raw,A.text+=b.text):c.push(b);continue}if(l){this.infiniteLoopError(l.charCodeAt(0));break}}return c}infiniteLoopError(l){let c="Infinite loop on byte: "+l;if(this.options.silent)console.error(c);else throw new Error(c)}},pn=class{options;parser;constructor(i){this.options=i||Nr}space(i){return""}code({text:i,lang:l,escaped:c}){let m=(l||"").match(Ve.notSpaceStart)?.[0],u=i.replace(Ve.endingNewline,"")+`
`;return m?'<pre><code class="language-'+Ta(m)+'">'+(c?u:Ta(u,!0))+`</code></pre>
`:"<pre><code>"+(c?u:Ta(u,!0))+`</code></pre>
`}blockquote({tokens:i}){return`<blockquote>
${this.parser.parse(i)}</blockquote>
`}html({text:i}){return i}def(i){return""}heading({tokens:i,depth:l}){return`<h${l}>${this.parser.parseInline(i)}</h${l}>
`}hr(i){return`<hr>
`}list(i){let l=i.ordered,c=i.start,m="";for(let g=0;g<i.items.length;g++){let b=i.items[g];m+=this.listitem(b)}let u=l?"ol":"ul",f=l&&c!==1?' start="'+c+'"':"";return"<"+u+f+`>
`+m+"</"+u+`>
...
`}strong({tokens:i}){return`<strong>${this.parser.parseInline(i)}</strong>`}em({tokens:i}){return`<em>${this.parser.parseInline(i)}</em>`}codespan({text:i}){return`<code>${Ta(i,!0)}</code>`}br(i){return"<br>"}del({tokens:i}){return`<del>${this.parser.parseInline(i)}</del>`}link({href:i,title:l,tokens:c}){let m=this.parser.parseInline(c),u=Hd(i);if(u===null)return m;i=u;let f='<a href="'+i+'"';return l&&(f+=' title="'+Ta(l)+'"'),f+=">"+m+"</a>",f}image({href:i,title:l,text:c,tokens:m}){m&&(c=this.parser.parseInline(m,this.parser.textRenderer));let u=Hd(i);if(u===null)return Ta(c);i=u;let f=`<img src="${i}" alt="${Ta(c)}"`;return l&&(f+=` title="${Ta(l)}"`),f+=">",f}text(i){return"tokens"in i&&i.tokens?this.parser.parseInline(i.tokens):"escaped"in i&&i.escaped?i.text:Ta(i.text)}},ji=class{strong({text:i}){return i}em({text:i}){return i}codespan({text:i}){return i}del({text:i}){return i}html({text:i}){return i}text({text:i}){return i}link({text:i}){return""+i}image({text:i}){return""+i}br(){return""}checkbox({raw:i}){return i}},Pa=class hi{options;renderer;textRenderer;constructor(l){this.options=l||Nr,this.options.renderer=this.options.renderer||new pn,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new ji}static parse(l,c){return new hi(c).parse(l)}static parseInline(l,c){return new hi(c).parseInline(l)}parse(l){this.renderer.parser=this;let c="";for(let m=0;m<l.length;m++){let u=l[m];if(this.options.extensions?.renderers?.[u.type]){let g=u,b=this.options.extensions.renderers[g.type].call({parser:this},g);if(b!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(g.type)){c+=b||"";continue}}let f=u;switch(f.type){case"space":{c+=this.renderer.space(f);break}case"hr":{c+=this.renderer.hr(f);break}case"heading":{c+=this.renderer.heading(f);break}case"code":{c+=this.renderer.code(f);break}case"table":{c+=this.renderer.table(f);break}case"blockquote":{c+=this.renderer.blockquote(f);break}case"list":{c+=this.renderer.list(f);break}case"checkbox":{c+=this.renderer.checkbox(f);break}case"html":{c+=this.renderer.html(f);break}case"def":{c+=this.renderer.def(f);break}case"paragraph":{c+=this.renderer.paragraph(f);break}case"text":{c+=this.renderer.text(f);break}default:{let g='Token with "'+f.type+'" type was not found.';if(this.options.silent)return console.error(g),"";throw new Error(g)}}}return c}parseInline(l,c=this.renderer){this.renderer.parser=this;let m="";for(let u=0;u<l.length;u++){let f=l[u];if(this.options.extensions?.renderers?.[f.type]){let b=this.options.extensions.renderers[f.type].call({parser:this},f);if(b!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(f.type)){m+=b||"";continue}}let g=f;switch(g.type){case"escape":{m+=c.text(g);break}case"html":{m+=c.html(g);break}case"link":{m+=c.link(g);break}case"image":{m+=c.image(g);break}case"checkbox":{m+=c.checkbox(g);break}case"strong":{m+=c.strong(g);break}case"em":{m+=c.em(g);break}case"codespan":{m+=c.codespan(g);break}case"br":{m+=c.br(g);break}case"del":{m+=c.del(g);break}case"text":{m+=c.text(g);break}default:{let b='Token with "'+g.type+'" type was not found.';if(this.options.silent)return console.error(b),"";throw new Error(b)}}}return m}},Uo=class{options;block;constructor(i){this.options=i||Nr}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(i){return i}postprocess(i){return i}processAllTokens(i){return i}emStrongMask(i){return i}provideLexer(i=this.block){return i?ka.lex:ka.lexInline}provideParser(i=this.block){return i?Pa.parse:Pa.parseInline}},xf=class{defaults=xi();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=Pa;Renderer=pn;TextRenderer=ji;Lexer=ka;Tokenizer=mn;Hooks=Uo;constructor(...i){this.use(...i)}walkTokens(i,l){let c=[];for(let m of i)switch(c=c.concat(l.call(this,m)),m.type){case"table":{let u=m;for(let f of u.header)c=c.concat(this.walkTokens(f.tokens,l));for(let f of u.rows)for(let g of f)c=c.concat(this.walkTokens(g.tokens,l));break}case"list":{let u=m;c=c.concat(this.walkTokens(u.items,l));break}default:{let u=m;this.defaults.extensions?.childTokens?.[u.type]?this.defaults.extensions.childTokens[u.type].forEach(f=>{let g=u[f].flat(1/0);c=c.concat(this.walkTokens(g,l))}):u.tokens&&(c=c.concat(this.walkTokens(u.tokens,l)))}}return c}use(...i){let l=this.defaults.extensions||{renderers:{},childTokens:{}};return i.forEach(c=>{let m={...c};if(m.async=this.defaults.async||m.async||!1,c.extensions&&(c.extensions.forEach(u=>{if(!u.name)throw new Error("extension name required");if("renderer"in u){let f=l.renderers[u.name];f?l.renderers[u.name]=function(...g){let b=u.renderer.apply(this,g);return b===!1&&(b=f.apply(this,g)),b}:l.renderers[u.name]=u.renderer}if("tokenizer"in u){if(!u.level||u.level!=="block"&&u.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let f=l[u.level];f?f.unshift(u.tokenizer):l[u.level]=[u.tokenizer],u.start&&(u.level==="block"?l.startBlock?l.startBlock.push(u.start):l.startBlock=[u.start]:u.level==="inline"&&(l.startInline?l.startInline.push(u.start):l.startInline=[u.start]))}"childTokens"in u&&u.childTokens&&(l.childTokens[u.name]=u.childTokens)}),m.extensions=l),c.renderer){let u=this.defaults.renderer||new pn(this.defaults);for(let f in c.renderer){if(!(f in u))throw new Error(`renderer '${f}' does not exist`);if(["options","parser"].includes(f))continue;let g=f,b=c.renderer[g],k=u[g];u[g]=(...A)=>{let R=b.apply(u,A);return R===!1&&(R=k.apply(u,A)),R||""}}m.renderer=u}if(c.tokenizer){let u=this.defaults.tokenizer||new mn(this.defaults);for(let f in c.tokenizer){if(!(f in u))throw new Error(`tokenizer '${f}' does not exist`);if(["options","rules","lexer"].includes(f))continue;let g=f,b=c.tokenizer[g],k=u[g];u[g]=(...A)=>{let R=b.apply(u,A);return R===!1&&(R=k.apply(u,A)),R}}m.tokenizer=u}if(c.hooks){let u=this.defaults.hooks||new Uo;for(let f in c.hooks){if(!(f in u))throw new Error(`hook '${f}' does not exist`);if(["options","block"].includes(f))continue;let g=f,b=c.hooks[g],k=u[g];Uo.passThroughHooks.has(f)?u[g]=A=>{if(this.defaults.async&&Uo.passThroughHooksRespectAsync.has(f))return(async()=>{let E=await b.call(u,A);return k.call(u,E)})();let R=b.call(u,A);return k.call(u,R)}:u[g]=(...A)=>{if(this.defaults.async)return(async()=>{let E=await b.apply(u,A);return E===!1&&(E=await k.apply(u,A)),E})();let R=b.apply(u,A);return R===!1&&(R=k.apply(u,A)),R}}m.hooks=u}if(c.walkTokens){let u=this.defaults.walkTokens,f=c.walkTokens;m.walkTokens=function(g){let b=[];return b.push(f.call(this,g)),u&&(b=b.concat(u.call(this,g))),b}}this.defaults={...this.defaults,...m}}),this}setOptions(i){return this.defaults={...this.defaults,...i},this}lexer(i,l){return ka.lex(i,l??this.defaults)}parser(i,l){return Pa.parse(i,l??this.defaults)}parseMarkdown(i){return(l,c)=>{let m={...c},u={...this.defaults,...m},f=this.onError(!!u.silent,!!u.async);if(this.defaults.async===!0&&m.async===!1)return f(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof l>"u"||l===null)return f(new Error("marked(): input parameter is undefined or null"));if(typeof l!="string")return f(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(l)+", string expected"));if(u.hooks&&(u.hooks.options=u,u.hooks.block=i),u.async)return(async()=>{let g=u.hooks?await u.hooks.preprocess(l):l,b=await(u.hooks?await u.hooks.provideLexer(i):i?ka.lex:ka.lexInline)(g,u),k=u.hooks?await u.hooks.processAllTokens(b):b;u.walkTokens&&await Promise.all(this.walkTokens(k,u.walkTokens));let A=await(u.hooks?await u.hooks.provideParser(i):i?Pa.parse:Pa.parseInline)(k,u);return u.hooks?await u.hooks.postprocess(A):A})().catch(f);try{u.hooks&&(l=u.hooks.preprocess(l));let g=(u.hooks?u.hooks.provideLexer(i):i?ka.lex:ka.lexInline)(l,u);u.hooks&&(g=u.hooks.processAllTokens(g)),u.walkTokens&&this.walkTokens(g,u.walkTokens);let b=(u.hooks?u.hooks.provideParser(i):i?Pa.parse:Pa.parseInline)(g,u);return u.hooks&&(b=u.hooks.postprocess(b)),b}catch(g){return f(g)}}}onError(i,l){return c=>{if(c.message+=`
Please report this to https://github.com/markedjs/marked.`,i){let m="<p>An error occurred:</p><pre>"+Ta(c.message+"",!0)+"</pre>";return l?Promise.resolve(m):m}if(l)return Promise.reject(c);throw c}}},kr=new xf;function U(i,l){return kr.parse(i,l)}U.options=U.setOptions=function(i){return kr.setOptions(i),U.defaults=kr.defaults,cu(U.defaults),U};U.getDefaults=xi;U.defaults=Nr;U.use=function(...i){return kr.use(...i),U.defaults=kr.defaults,cu(U.defaults),U};U.walkTokens=function(i,l){return kr.walkTokens(i,l)};U.parseInline=kr.parseInline;U.Parser=Pa;U.parser=Pa.parse;U.Renderer=pn;U.TextRenderer=ji;U.Lexer=ka;U.lexer=ka.lex;U.Tokenizer=mn;U.Hooks=Uo;U.parse=U;U.options;U.setOptions;U.use;U.walkTokens;U.parseInline;Pa.parse;ka.lex;/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const yf=i=>i.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),Cf=i=>i.replace(/^([A-Z])|[\s-_]+(\w)/g,(l,c,m)=>m?m.toUpperCase():c.toLowerCase()),Wd=i=>{const l=Cf(i);return l.charAt(0).toUpperCase()+l.slice(1)},xu=(...i)=>i.filter((l,c,m)=>!!l&&l.trim()!==""&&m.indexOf(l)===c).join(" ").trim();/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Af=Ae.forwardRef(({color:i="currentColor",size:l=24,strokeWidth:c=2,absoluteStrokeWidth:m,className:u="",children:f,iconNode:g,...b},k)=>Ae.createElement("svg",{ref:k,...Sf,width:l,height:l,stroke:i,strokeWidth:m?Number(c)*24/Number(l):c,className:xu("lucide",u),...b},[...g.map(([A,R])=>Ae.createElement(A,R)),...Array.isArray(f)?f:[f]]));/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const $=(i,l)=>{const c=Ae.forwardRef(({className:m,...u},f)=>Ae.createElement(Af,{ref:f,iconNode:l,className:xu(`lucide-${yf(Wd(i))}`,`lucide-${i}`,m),...u}));return c.displayName=Wd(i),c};/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const kf=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],Pf=$("arrow-left",kf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Nf=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],Gd=$("arrow-right",Nf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const jf=[["path",{d:"m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z",key:"1fy3hk"}]],wf=$("bookmark",jf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const zf=[["path",{d:"M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5-3-4.03 2.42Z",key:"lc1i9w"}],["path",{d:"m7 16.5-4.74-2.85",key:"1o9zyk"}],["path",{d:"m7 16.5 5-3",key:"va8pkn"}],["path",{d:"M7 16.5v5.17",key:"jnp8gn"}],["path",{d:"M12 13.5V19l3.97 2.38a2 2 0 0 0 2.06 0l3-1.8a2 2 0 0 0 .97-1.71v-3.24a2 2 0 0 0-.97-1.71L17 10.5l-5 3Z",key:"8zsnat"}],["path",{d:"m17 16.5-5-3",key:"8arw3v"}],["path",{d:"m17 16.5 4.74-2.85",key:"8rfmw"}],["path",{d:"M17 16.5v5.17",key:"k6z78m"}],["path",{d:"M7.97 4.42A2 2 0 0 0 7 6.13v4.37l5 3 5-3V6.13a2 2 0 0 0-.97-1.71l-3-1.8a2 2 0 0 0-2.06 0l-3 1.8Z",key:"1xygjf"}],["path",{d:"M12 8 7.26 5.15",key:"1vbdud"}],["path",{d:"m12 8 4.74-2.85",key:"3rx089"}],["path",{d:"M12 13.5V8",key:"1io7kd"}]],If=$("boxes",zf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Ef=[["path",{d:"M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z",key:"l5xja"}],["path",{d:"M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z",key:"ep3f8r"}],["path",{d:"M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4",key:"1p4c4q"}],["path",{d:"M17.599 6.5a3 3 0 0 0 .399-1.375",key:"tmeiqw"}],["path",{d:"M6.003 5.125A3 3 0 0 0 6.401 6.5",key:"105sqy"}],["path",{d:"M3.477 10.896a4 4 0 0 1 .585-.396",key:"ql3yin"}],["path",{d:"M19.938 10.5a4 4 0 0 1 .585.396",key:"1qfode"}],["path",{d:"M6 18a4 4 0 0 1-1.967-.516",key:"2e4loj"}],["path",{d:"M19.967 17.484A4 4 0 0 1 18 18",key:"159ez6"}]],Qd=$("brain",Ef);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Tf=[["path",{d:"M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",key:"jecpp"}],["rect",{width:"20",height:"14",x:"2",y:"6",rx:"2",key:"i6l2r4"}]],Df=$("briefcase",Tf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Rf=[["path",{d:"M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z",key:"1b4qmf"}],["path",{d:"M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2",key:"i71pzd"}],["path",{d:"M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2",key:"10jefs"}],["path",{d:"M10 6h4",key:"1itunk"}],["path",{d:"M10 10h4",key:"tcdvrf"}],["path",{d:"M10 14h4",key:"kelpxr"}],["path",{d:"M10 18h4",key:"1ulq68"}]],Go=$("building-2",Rf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Lf=[["path",{d:"M17 21v-2a1 1 0 0 1-1-1v-1a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1a1 1 0 0 1-1 1",key:"10bnsj"}],["path",{d:"M19 15V6.5a1 1 0 0 0-7 0v11a1 1 0 0 1-7 0V9",key:"1eqmu1"}],["path",{d:"M21 21v-2h-4",key:"14zm7j"}],["path",{d:"M3 5h4V3",key:"z442eg"}],["path",{d:"M7 5a1 1 0 0 1 1 1v1a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a1 1 0 0 1 1-1V3",key:"ebdjd7"}]],bi=$("cable",Lf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Of=[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1tc9qg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]],ga=$("camera",Of);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const qf=[["path",{d:"M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2",key:"5owen"}],["circle",{cx:"7",cy:"17",r:"2",key:"u2ysq9"}],["path",{d:"M9 17h6",key:"r8uit2"}],["circle",{cx:"17",cy:"17",r:"2",key:"axvx0g"}]],Mf=$("car",qf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Vf=[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"c24i48"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]],cn=$("chart-column",Vf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Bf=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Se=$("chevron-right",Bf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const $f=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],fa=$("circle-check",$f);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Hf=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"m9 14 2 2 4-4",key:"df797q"}]],vn=$("clipboard-check",Hf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const _f=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]],Yo=$("clock",_f);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Uf=[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]],Jr=$("external-link",Uf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Ff=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],Wf=$("eye",Ff);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Gf=[["path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z",key:"1jg4f8"}]],Yd=$("facebook",Gf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Qf=[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],Yf=$("file-text",Qf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Kf=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]],xn=$("globe",Kf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Zf=[["path",{d:"M12 2v8",key:"1q4o3n"}],["path",{d:"m16 6-4 4-4-4",key:"6wukr"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",key:"w68u3i"}],["path",{d:"M6 18h.01",key:"uhywen"}],["path",{d:"M10 18h.01",key:"h775k"}]],Xf=$("hard-drive-download",Zf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Jf=[["path",{d:"M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3",key:"1xhozi"}]],fn=$("headphones",Jf);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const eg=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"1d0kgt"}]],yu=$("house",eg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const ag=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]],rg=$("info",ag);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const og=[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]],Kd=$("instagram",og);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const tg=[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]],ng=$("layout-dashboard",tg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const sg=[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]],ig=$("lightbulb",sg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const lg=[["path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z",key:"c2jq9f"}],["rect",{width:"4",height:"12",x:"2",y:"9",key:"mk3on5"}],["circle",{cx:"4",cy:"4",r:"2",key:"bt5ra8"}]],Zd=$("linkedin",lg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const cg=[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]],eo=$("lock",cg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const dg=[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]],ir=$("mail",dg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const ug=[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]],Xd=$("map-pin",ug);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const mg=[["line",{x1:"4",x2:"20",y1:"12",y2:"12",key:"1e0a9i"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6",key:"1owob3"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18",key:"yk5zj1"}]],pg=$("menu",mg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const fg=[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]],Fo=$("message-circle",fg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const gg=[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]],Jd=$("moon",gg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const hg=[["path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z",key:"foiqr5"}]],na=$("phone",hg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const bg=[["path",{d:"M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z",key:"rib7q0"}],["path",{d:"M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z",key:"1ymkrd"}]],vg=$("quote",bg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const xg=[["path",{d:"M3 7V5a2 2 0 0 1 2-2h2",key:"aa7l1z"}],["path",{d:"M17 3h2a2 2 0 0 1 2 2v2",key:"4qcy5o"}],["path",{d:"M21 17v2a2 2 0 0 1-2 2h-2",key:"6vwrx8"}],["path",{d:"M7 21H5a2 2 0 0 1-2-2v-2",key:"ioqczr"}],["path",{d:"M7 12h10",key:"b7w52i"}]],pi=$("scan-line",xg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const yg=[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]],Cg=$("search",yg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Sg=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],Ag=$("send",Sg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const kg=[["rect",{width:"20",height:"8",x:"2",y:"2",rx:"2",ry:"2",key:"ngkwjq"}],["rect",{width:"20",height:"8",x:"2",y:"14",rx:"2",ry:"2",key:"iecqi9"}],["line",{x1:"6",x2:"6.01",y1:"6",y2:"6",key:"16zg32"}],["line",{x1:"6",x2:"6.01",y1:"18",y2:"18",key:"nzw8ys"}]],wi=$("server",kg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Pg=[["path",{d:"M20 7h-9",key:"3s1dr2"}],["path",{d:"M14 17H5",key:"gfn3mx"}],["circle",{cx:"17",cy:"17",r:"3",key:"18b49y"}],["circle",{cx:"7",cy:"7",r:"3",key:"dfmy0x"}]],Ar=$("settings-2",Pg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Ng=[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z",key:"1qme2f"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],jg=$("settings",Ng);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const wg=[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]],zg=$("share-2",wg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Ig=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],Eg=$("shield-check",Ig);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Tg=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}]],Pr=$("shield",Tg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Dg=[["path",{d:"m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7",key:"ztvudi"}],["path",{d:"M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8",key:"1b2hhj"}],["path",{d:"M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4",key:"2ebpfo"}],["path",{d:"M2 7h20",key:"1fcdvo"}],["path",{d:"M22 7v3a2 2 0 0 1-2 2a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 16 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 12 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 8 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 4 12a2 2 0 0 1-2-2V7",key:"6c3vgh"}]],Cu=$("store",Dg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Rg=[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]],Lg=$("trending-up",Rg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Og=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Su=$("triangle-alert",Og);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const qg=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]],Au=$("users",qg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Mg=[["path",{d:"m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8",key:"n7qcjb"}],["path",{d:"M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 2 .7 2.8 0L15 15Zm0 0 7 7",key:"d0u48b"}],["path",{d:"m2.1 21.8 6.4-6.3",key:"yn04lh"}],["path",{d:"m19 5-7 7",key:"194lzd"}]],eu=$("utensils-crossed",Mg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Vg=[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5",key:"ftymec"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2",key:"158x01"}]],ku=$("video",Vg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Bg=[["path",{d:"M22 8.35V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.35A2 2 0 0 1 3.26 6.5l8-3.2a2 2 0 0 1 1.48 0l8 3.2A2 2 0 0 1 22 8.35Z",key:"gksnxg"}],["path",{d:"M6 18h12",key:"9pbo8z"}],["path",{d:"M6 14h12",key:"4cwo0f"}],["rect",{width:"12",height:"12",x:"6",y:"10",key:"apd30q"}]],gn=$("warehouse",Bg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const $g=[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}],["path",{d:"M5 12.859a10 10 0 0 1 5.17-2.69",key:"1dl1wf"}],["path",{d:"M19 12.859a10 10 0 0 0-2.007-1.523",key:"4k23kn"}],["path",{d:"M2 8.82a15 15 0 0 1 4.177-2.643",key:"1grhjp"}],["path",{d:"M22 8.82a15 15 0 0 0-11.288-3.764",key:"z3jwby"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]],Hg=$("wifi-off",$g);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const _g=[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0",key:"dnpr2z"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0",key:"1x1e6c"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}]],Ug=$("wifi",_g);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Fg=[["rect",{width:"8",height:"8",x:"3",y:"3",rx:"2",key:"by2w9f"}],["path",{d:"M7 11v4a2 2 0 0 0 2 2h4",key:"xkn7yn"}],["rect",{width:"8",height:"8",x:"13",y:"13",rx:"2",key:"1cgmvn"}]],dn=$("workflow",Fg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Wg=[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z",key:"cbrjhi"}]],au=$("wrench",Wg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Gg=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Qg=$("x",Gg);/**
* @license lucide-react v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const Yg=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],zi=$("zap",Yg),ru="https://wa.me/573337450634?text=Hola%2C%20necesito%20informaci%C3%B3n%20sobre%20c%C3%A1maras%20de%20seguridad%20para%20mi%20negocio%20en%20Bogot%C3%A1";function Kg({md:i}){return o.jsx("div",{className:"prose prose-lg max-w-none font-sans",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(i)}})}const Zg=[{name:"Básico",cameras:"4 cámaras",price:"$1.800.000",desc:"Ideal para locales pequeños y consultorios",features:["4 cámaras HD 4MP","DVR 4 canales","1 TB almacenamiento","Instalación incluida","Soporte 30 días","App móvil Remotion"],highlight:!1},{name:"Profesional",cameras:"8 cámaras",price:"$3.200.000",desc:"Para negocios medianos con alta rotación",features:["8 cámaras 4MP ColorVu","DVR 8 canales","2 TB almacenamiento","Instalación incluida","Soporte 90 días","Alertas automáticas IA","App móvil + escritorio"],highlight:!0},{name:"Empresarial",cameras:"16 cámaras",price:"$5.600.000",desc:"Cobertura completa para bodegas y franquicias",features:["16 cámaras 4MP","NVR 16 canales PoE","4 TB almacenamiento RAID","Instalación incluida","Soporte 6 meses","Analítica IA completa","Dashboard remoto 24/7","Integración WhatsApp/CRM"],highlight:!1},{name:"IA Total",cameras:"8-16 cámaras + IA",price:"Desde $4.500.000",desc:"Analítica inteligente: aforo, intrusión, PPE, arqueo",features:["Hardware + servidor edge GPU","YOLO v8 detección objetos","PPE detection (EPP obligatorio)","Control de aforo en tiempo real","Arqueo de caja por video","Alertas WhatsApp/CRM automáticas","Dashboard ejecutivo con métricas","Soporte prioritario 12 meses"],highlight:!1}],Xg=[{q:"¿Cuánto cuestan las cámaras de seguridad para un negocio en Bogotá?",a:"El rango va desde $1.800.000 COP para 4 cámaras básicas hasta $5.600.000 para 16 cámaras con NVR. El plan con analítica IA cuesta desde $4.500.000 incluyendo servidor edge. El precio depende del hardware, cantidad de puntos y complejidad de instalación."},{q:"¿Cuánto tarda la instalación?",a:"Un sistema de 4 a 8 cámaras se instala en 1 día hábil. Sistemas de 16+ cámaras con cableado estructurado y servidor IA pueden tomar 2 a 3 días. Siempre coordinamos la instalación en horarios que no interrumpan la operación de su negocio."},{q:"¿Puedo ver las cámaras desde mi celular?",a:"Sí. Todas nuestras instalaciones incluyen configuración de app móvil (Remotion Hik-Connect o HiK-Connect). Puede ver en vivo, recibir alertas, y reproducir grabaciones desde cualquier lugar con internet."},{q:"¿Qué es la analítica de video con IA?",a:"Es software que analiza el video en tiempo real usando inteligencia artificial (YOLO v8). Detecta personas, vehículos, objetos olvidados, controla aforo, verifica uso de EPP, y puede hacer arqueo de caja. Las alertas se envían por WhatsApp o email automáticamente."},{q:"¿Necesito internet para que funcionen las cámaras?",a:"Las cámaras graban localmente al DVR/NVR sin necesidad de internet. El internet se necesita para: ver desde el celular, recibir alertas IA, y acceso remoto. Recomendamos mínimo 10 Mbps simétricos para sistemas con IA."},{q:"¿Ofrecen garantía y soporte?",a:"Sí. Hardware con garantía de fábrica (1-3 años según marca). Soporte técnico incluido según plan: 30 días (Básico) hasta 12 meses (IA Total). Extendemos soporte con contratos mensuales desde $250.000/mes."},{q:"¿Funciona en caso de apagón o corte de luz?",a:"Recomendamos incluir un UPS (no Break) que mantiene el DVR y módem funcionando 30-45 minutos. Si necesita cobertura total, ofrecemos soluciones con baterías de respaldo de hasta 4 horas. Las cámaras IP PoE se alimentan por el cable Ethernet."},{q:"¿En qué zonas de Bogotá instalan?",a:"Cubrimos toda Bogotá y área metropolitana: Centro, Norte (Chicó, Chapinero, Usaquén), Sur (Kennedy, Bosa, Ciudad Bolívar), Occidente (Engativá, Suba, Fontibón), y oriente (Santa Fe, Usme). También atendemos municipalities cercanos."}];function Jg(){return o.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[o.jsx(sa,{title:"Cámaras de Seguridad para Negocio en Bogotá",subtitle:"Instalación profesional de cámaras con inteligencia artificial para locales comerciales, bodegas, restaurantes y oficinas. Hardware Hikvision, analítica YOLO v8, alertas automáticas por WhatsApp.",ctaLabel:"Cotizar Ahora",onCta:()=>{}}),o.jsx("section",{className:"py-12 bg-background border-b border-border",children:o.jsx("div",{className:"max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6",children:[{icon:ga,label:"500+ instalaciones",sub:"en Bogotá"},{icon:Qd,label:"IA en tiempo real",sub:"YOLO v8"},{icon:eo,label:"Garantía 3 años",sub:"hardware Hikvision"},{icon:na,label:"Soporte 24/7",sub:"WhatsApp directo"}].map(i=>o.jsxs("div",{className:"text-center",children:[o.jsx(i.icon,{className:"w-6 h-6 mx-auto mb-2",style:{color:"var(--color-accent)"}}),o.jsx("p",{className:"font-sans font-semibold text-sm",children:i.label}),o.jsx("p",{className:"font-sans text-xs",style:{color:"var(--color-muted-foreground)"},children:i.sub})]},i.label))})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"¿Por qué su negocio necesita cámaras de seguridad?"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Bogotá registra más de 45.000 hurtos al año. El 70% de negocios sin cámaras no logra identificar responsables. Estos son los problemas que resolvemos:"}),o.jsx("div",{className:"space-y-8",children:[{icon:Su,title:"Robos externos sin evidencia",desc:"Asaltos a mano armada, rompimiento de vidrieras, hurtos de mercancía. Sin cámaras, la policía no tiene pistas y el seguro no cubre la pérdida. Con grabaciones en HD, aumentamos las probabilidades de recuperación en un 340%.",stat:"340%",statLabel:"más recuperaciones con video"},{icon:Au,title:"Robo interno y mermas injustificadas",desc:"El 22% de las pérdidas en retail son por robo interno. Nuestros clientes en Kennedy redujeron mermas en 68% al instalar cámaras en cajas, almacenes y zonas de personal. La analítica de IA detecta comportamientos anómalos en tiempo real.",stat:"68%",statLabel:"reducción de mermas reportada"},{icon:eo,title:"Cierres sin evidencia para seguros",desc:"Los aseguradores exigen pruebas de video para cubrir siniestros. Sin cámaras, una inundación o incendio puede costarle millones sin compensación. Guardamos 90 días de grabación en almacenamiento seguro con RAID.",stat:"90 días",statLabel:"de respaldo automático"}].map(i=>o.jsxs("div",{className:"flex flex-col md:flex-row gap-6 p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsx("div",{className:"flex-shrink-0",children:o.jsx("div",{className:"w-12 h-12 rounded-lg flex items-center justify-center",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-6 h-6",style:{color:"var(--color-accent)"}})})}),o.jsxs("div",{className:"flex-1",children:[o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans leading-relaxed mb-4",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsxs("div",{className:"flex items-baseline gap-2",children:[o.jsx("span",{className:"font-sans text-2xl font-bold",style:{color:"var(--color-accent)"},children:i.stat}),o.jsx("span",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:i.statLabel})]})]})]},i.title))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-5xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Soluciones para cada tipo de negocio"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Cada comercio en Bogotá tiene riesgos diferentes. Diseñamos sistemas específicos para su operación:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:[{icon:Go,title:"Local Comercial",desc:"Cobertura de vitrina, caja y área de clientes. Cámaras dome para interior, bullet para fachada. Detección de horarios y alerta fuera de horario.",cameras:"4-8 cámaras",zones:"Fachada · Caja · Almacén"},{icon:gn,title:"Bodega",desc:"Cámaras bullet con alcance largo para pasillos amplios. Visión nocturna ColorVu para patios de carga. Control de acceso por plate recognition.",cameras:"8-16 cámaras",zones:"Accesos · Pasillos · Patio carga"},{icon:eu,title:"Restaurante",desc:"Analítica de cocina, sala y barra. Control de aforo para cumplimiento IDEA. Cámaras resistentes a humedad y grasas industriales.",cameras:"6-12 cámaras",zones:"Cocina · Sala · Barra · Bodega"},{icon:Df,title:"Oficina",desc:"Acceso por人脸识别, control de visitantes, zonas restringidas. Integración con Sistemas de control de acceso existentes. Cámaras discretas tipo mini-dome.",cameras:"4-8 cámaras",zones:"Recepción · Piso · Servidores · Salas"},{icon:Mf,title:"Estacionamiento",desc:"LPR (reconocimiento de placas) para control de acceso. Cámaras ANPR con flash IR para lectura 24/7. Analítica de cajones y control de permanencia.",cameras:"8-16 cámaras",zones:"Entrada · Salida · Pisos · Vigilancia"}].map(i=>o.jsxs("div",{className:"group p-6 rounded-xl border transition-all hover:shadow-lg",style:{borderColor:"var(--color-border)"},children:[o.jsx("div",{className:"w-10 h-10 rounded-lg flex items-center justify-center mb-4",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}})}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed mb-4",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsxs("div",{className:"flex flex-wrap gap-2",children:[o.jsx("span",{className:"text-xs font-sans px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.9},children:i.cameras}),o.jsx("span",{className:"text-xs font-sans px-3 py-1 rounded-full border",style:{borderColor:"var(--color-border)",color:"var(--color-muted-foreground)"},children:i.zones})]})]},i.title))})]})}),o.jsx("section",{id:"precios",className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-6xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Precios reales 2026"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Sin sorpresas. Incluye hardware, instalación y configuración. Los precios son COP e IVA incluido."}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",children:Zg.map(i=>o.jsxs("div",{className:"relative flex flex-col p-6 rounded-xl border-2 transition-all",style:{borderColor:i.highlight?"var(--color-accent)":"var(--color-border)",backgroundColor:i.highlight?"var(--color-accent)":"var(--color-background)",color:i.highlight?"var(--color-background)":"var(--color-foreground)"},children:[i.highlight&&o.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-sans font-bold px-4 py-1 rounded-full",style:{backgroundColor:"var(--color-background)",color:"var(--color-accent)"},children:"Más vendido"}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-1",children:i.name}),o.jsx("p",{className:"font-sans text-sm mb-1",style:{opacity:.8},children:i.cameras}),o.jsx("div",{className:"font-serif text-3xl font-bold my-4",children:i.price}),o.jsx("p",{className:"font-sans text-sm mb-6",style:{opacity:.7},children:i.desc}),o.jsx("ul",{className:"space-y-2 mb-8 flex-1",children:i.features.map(l=>o.jsxs("li",{className:"flex items-start gap-2 text-sm font-sans",children:[o.jsx(fa,{className:"w-4 h-4 mt-0.5 flex-shrink-0",style:{opacity:.7}}),o.jsx("span",{children:l})]},l))}),o.jsxs("a",{href:ru,target:"_blank",rel:"noopener noreferrer",className:"w-full text-center px-6 py-3 rounded-lg font-sans font-semibold text-sm transition-all hover:scale-105 block",style:{backgroundColor:i.highlight?"var(--color-background)":"var(--color-accent)",color:i.highlight?"var(--color-accent)":"var(--color-background)",border:i.highlight?"2px solid var(--color-background)":"none"},children:["Cotizar ",i.name]})]},i.name))}),o.jsx("div",{className:"mt-8 text-center",children:o.jsx("p",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:"* Precios referenciales para Bogotá. El costo final depende de distancias, cantidad de puntos y accesibilidad. Cotización sin compromiso vía WhatsApp."})})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Cómo funciona nuestro servicio"}),o.jsx("p",{className:"font-sans text-lg text-center mb-16 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"De la primera llamada al sistema funcionando en 4 pasos claros:"}),o.jsxs("div",{className:"space-y-12 relative",children:[o.jsx("div",{className:"absolute left-6 md:left-8 top-0 bottom-0 w-0.5",style:{backgroundColor:"var(--color-border)"}}),[{icon:vn,step:"01",title:"Auditoría Gratuita",desc:"Visitamos su negocio en Bogotá, identificamos puntos críticos, medimos distancias, evaluamos infraestructura eléctrica y de red. Le entregamos un plano con ubicación óptima de cada cámara. Sin compromiso.",time:"1-2 horas"},{icon:jg,step:"02",title:"Instalación Profesional",desc:"Nuestro equipo técnico instala el hardware en menos de 24 horas para sistemas de hasta 8 cámaras. Cableado estructurado o inalámbrico según su caso. No dejamos cables expuestos ni destornilladores olvidados.",time:"1-3 días"},{icon:Qd,step:"03",title:"Configuración IA y alertas",desc:"Configuramos la analítica de video (YOLO v8): detección de personas, control de aforo, alertas de intrusión. Conectamos las alertas a su WhatsApp o CRM. Le entrenamos para usar la app Remotion.",time:"2-4 horas"},{icon:fn,step:"04",title:"Soporte Continuo",desc:"Seguimiento remoto del sistema con alertas automáticas. Si una cámara falla, usted recibe un aviso por WhatsApp antes de notar la caída. Soporte técnico vía WhatsApp. Actualizaciones de firmware incluidas. Mantenimiento preventivo cada 6 meses.",time:"24/7"}].map((i,l)=>o.jsxs("div",{className:"relative flex gap-6 md:gap-8",children:[o.jsx("div",{className:"flex-shrink-0 z-10",children:o.jsx("div",{className:"w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center font-serif font-bold text-lg md:text-xl border-4",style:{backgroundColor:"var(--color-background)",borderColor:"var(--color-accent)",color:"var(--color-accent)"},children:i.step})}),o.jsxs("div",{className:"flex-1 pt-2 md:pt-4",children:[o.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}}),o.jsx("h3",{className:"font-serif text-xl md:text-2xl font-bold",children:i.title})]}),o.jsx("p",{className:"font-sans leading-relaxed mb-3",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsxs("span",{className:"inline-block text-xs font-sans font-semibold px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.8},children:["⏱ ",i.time]})]})]},i.step))]})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Casos reales en Bogotá"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Negocios que ya protegemos con cámaras e inteligencia artificial:"}),o.jsx("div",{className:"space-y-8",children:[{business:"Ferretería Los 3 Amigos — Suba",problem:"Pérdidas de $8 millones/mes por mermas no identificadas. Sin cámaras, el dueño no podía saber si eran robos internos o errores de inventario.",solution:"Instalación de 8 cámaras Hikvision ColorVu con analítica IA. Detección de personas en zona de almacén y arqueo de caja por video.",result:"Mermas reducidas en 68% en 3 meses. ROI recuperado en 5 semanas. Ahorro anual estimado: $65 millones.",icon:Go},{business:"Restaurante La Brasa — Chapinero",problem:"Sanciones del IDEA por exceder aforo. El local tenía un sistema de conteo manual que fallaba los fines de semana.",solution:"6 cámaras con control de aforo en tiempo real por IA. Alertas automáticas cuando se alcanza el 80% de capacidad. Dashboard para gerencia.",result:"Cero multas en 12 meses. Mejor control de inventario de comida. Satisfacción de clientes aumentó por evitar esperas.",icon:eu},{business:"Bodega Distribuidora Norte — Kennedy",problem:"2 asaltos en 6 meses. Los ladrones entraban por la noche y no había evidencia para la policía ni para el seguro.",solution:"12 cámaras bullet con IR 80m, sensores de movimiento IA, alertas WhatsApp en 3 segundos. Server edge con grabación 90 días.",result:"Intento de robo capturado en HD. Policía identificó y capturó sospechosos. Prima de seguro redujo un 40% el siguiente año.",icon:gn}].map(i=>o.jsxs("div",{className:"p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}}),o.jsx("h3",{className:"font-serif text-lg font-bold",children:i.business})]}),o.jsxs("div",{className:"grid md:grid-cols-3 gap-4",children:[o.jsxs("div",{children:[o.jsx("p",{className:"font-sans text-xs font-semibold uppercase tracking-wider mb-1",style:{color:"var(--color-accent)"},children:"Problema"}),o.jsx("p",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:i.problem})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-sans text-xs font-semibold uppercase tracking-wider mb-1",style:{color:"var(--color-accent)"},children:"Solución"}),o.jsx("p",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:i.solution})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-sans text-xs font-semibold uppercase tracking-wider mb-1",style:{color:"var(--color-accent)"},children:"Resultado"}),o.jsx("p",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:i.result})]})]})]},i.business))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Preguntas frecuentes"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12",style:{color:"var(--color-muted-foreground)"},children:"Todo lo que necesita saber sobre cámaras de seguridad para su negocio en Bogotá:"}),o.jsx("div",{className:"space-y-4",children:Xg.map(i=>o.jsxs("details",{className:"group border rounded-xl overflow-hidden",style:{borderColor:"var(--color-border)"},children:[o.jsxs("summary",{className:"flex items-center justify-between gap-4 p-5 font-sans font-semibold cursor-pointer select-none list-none",children:[o.jsx("span",{children:i.q}),o.jsx(Se,{className:"w-5 h-5 flex-shrink-0 transition-transform group-open:rotate-90",style:{color:"var(--color-accent)"}})]}),o.jsx("div",{className:"px-5 pb-5 font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)",borderTop:"1px solid var(--color-border)"},children:o.jsx("p",{className:"pt-4",children:i.a})})]},i.q))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto text-center",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4",children:"Proteja su negocio hoy"}),o.jsx("p",{className:"font-sans text-lg mb-8 max-w-xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Cada día sin cámaras es un día sin evidencia. Solicite su auditoría gratuita y reciba un plano personalizado para su negocio en Bogotá."}),o.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-center gap-4 mb-12",children:[o.jsxs("a",{href:ru,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base transition-all hover:scale-105",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx(na,{className:"w-4 h-4"})," WhatsApp: 333 745 0634"]}),o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base border-2 transition-all hover:scale-105",style:{borderColor:"var(--color-border)",color:"var(--color-foreground)"},children:[o.jsx(ir,{className:"w-4 h-4"})," Email Directo"]})]}),o.jsx("div",{className:"text-left",children:o.jsx(Kg,{md:`
...
**Resultado:** Cumplimiento total de normativa MinSalud. Reducción de tiempos de espera en 35% gracias a optimización de aforo. Dos incidentes de caída documentados y resueltos sin litigios. ROI en 4 meses por ahorro en pólizas de responsabilidad civil.
  `,u=[{q:"¿Cuánto cuesta el sistema de aforo para clínicas en Chapinero?",a:"El sistema completo con 8 cámaras, analítica de aforo, detección PPE e instalación cuesta desde $4.200.000 COP. Incluye configuración personalizada por zona y capacitación al personal."},{q:"¿Las cámaras cumplen normativa MinSalud?",a:"Sí, nuestros sistemas generan reportes de cumplimiento PPE y aforo que cumplen con las resoluciones 2020 y 2021 del MinSalud. Incluimos dashboards exportables para auditorías."},{q:"¿Pueden integrarse con nuestro software de gestión?",a:"Sí, ofrecemos integración vía API REST con los principales software de gestión clínica. La integración permite cruzar datos de video con registros de pacientes para auditorías completas."},{q:"¿Instalan en restaurantes de Chicó y Rosales?",a:"Sí, cubrimos toda la localidad de Chapinero. Los restaurantes en Chicó y Rosales suelen requerir analítica de aforo + intrusiones nocturnas. Tenemos packs especializados."},{q:"¿Las cámaras son invasivas para los pacientes?",a:"No. Usamos modelos compactos tipo dome que se integran al diseño interior. Son discretas y no generan incomodidad. En clínicas, colocamos señalización visible según normativa."}],f={"@context":"https://schema.org","@type":"LocalBusiness",name:"Servicios APC - Cámaras de Seguridad en Chapinero",description:"Cámaras de seguridad para clínicas, restaurantes y oficinas en Chapinero, Bogotá. Analítica IA, PPE, aforo. Cobertura Chicó, Rosales, Tintal.",areaServed:{"@type":"City",name:"Chapinero, Bogotá"},telephone:"+573337450634",email:"serviciosapcsoporte@gmail.com"};return o.jsxs("article",{className:"max-w-3xl mx-auto px-6 py-16 font-sans",style:{color:"var(--color-foreground)",background:"var(--color-background)"},children:[o.jsx(sa,{title:"CÃ¡maras de Seguridad en Chapinero",subtitle:"ClÃ­nicas, restaurantes y oficinas en Chapinero protegidas con analÃ­tica de aforo, control de acceso facial y visiÃ³n nocturna ColorVu.",ctaLabel:"Cotizar",onCta:()=>{}}),o.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(f)}}),o.jsxs("header",{className:"mb-12",children:[o.jsx("p",{className:"text-sm uppercase tracking-widest mb-2",style:{color:"var(--color-muted-foreground)"},children:"Servicios APC · Chapinero, Bogotá"}),o.jsx("h1",{className:"font-serif text-4xl md:text-5xl font-bold leading-tight mb-4",style:{color:"var(--color-foreground)"},children:"Cámaras de Seguridad en Chapinero, Bogotá"}),o.jsx("p",{className:"text-lg mb-6",style:{color:"var(--color-muted-foreground)"},children:"Soluciones de video con IA para clínicas, restaurantes y oficinas en Chapinero. Cumplimiento normativo, control de aforo y protección de personal con tecnología de analítica de IA y reconocimiento PPE."}),o.jsx("a",{href:"https://wa.me/573337450634?text=Hola,%20necesito%20información%20sobre%20cámaras%20de%20seguridad%20en%20Chapinero",target:"_blank",rel:"noopener noreferrer",className:"inline-block px-8 py-4 rounded-lg font-semibold text-white transition-opacity hover:opacity-90",style:{background:"var(--color-accent)"},children:"Cotizar por WhatsApp"})]}),o.jsxs("section",{className:"mb-12",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-4 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"Cobertura en Chapinero"}),o.jsx("ul",{className:"grid grid-cols-2 md:grid-cols-3 gap-3",children:i.map(g=>o.jsxs("li",{className:"px-4 py-3 rounded-lg text-sm font-medium",style:{background:"var(--color-secondary)",color:"var(--color-foreground)"},children:["✓ ",g]},g))})]}),o.jsxs("section",{className:"mb-12",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-6 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"Soluciones para negocios en Chapinero"}),o.jsx("div",{className:"grid gap-6 md:grid-cols-3",children:l.map(g=>o.jsxs("div",{className:"rounded-xl p-6",style:{background:"var(--color-secondary)",border:"1px solid var(--color-border)"},children:[o.jsx("span",{className:"text-3xl block mb-3",children:g.icon}),o.jsx("h3",{className:"font-serif font-bold text-lg mb-2",children:g.titulo}),o.jsx("p",{className:"text-sm",style:{color:"var(--color-muted-foreground)"},children:g.desc})]},g.titulo))})]}),o.jsxs("section",{className:"mb-12",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-6 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"¿Por qué elegir Servicios APC en Chapinero?"}),o.jsx("div",{className:"grid gap-6 md:grid-cols-2",children:c.map(g=>o.jsxs("div",{className:"flex gap-4 items-start",children:[o.jsx("span",{className:"text-3xl flex-shrink-0",children:g.icon}),o.jsxs("div",{children:[o.jsx("h3",{className:"font-serif font-bold text-lg",children:g.titulo}),o.jsx("p",{className:"text-sm mt-1",style:{color:"var(--color-muted-foreground)"},children:g.desc})]})]},g.titulo))})]}),o.jsxs("section",{className:"mb-12",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-6 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"Casos reales en Chapinero"}),o.jsx("div",{className:"rounded-xl p-6 md:p-8",style:{background:"var(--color-secondary)",border:"1px solid var(--color-border)"},children:o.jsx("div",{className:"prose prose-sm max-w-none font-sans",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(m)}})})]}),o.jsxs("section",{className:"mb-12",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-6 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"Preguntas frecuentes sobre cámaras en Chapinero"}),o.jsx("div",{className:"space-y-6",children:u.map((g,b)=>o.jsxs("details",{className:"group rounded-xl overflow-hidden",style:{border:"1px solid var(--color-border)"},children:[o.jsxs("summary",{className:"px-6 py-4 cursor-pointer font-serif font-semibold text-base list-none flex justify-between items-center",style:{background:"var(--color-secondary)"},children:[g.q,o.jsx("span",{className:"ml-2 transition-transform group-open:rotate-45 text-xl",children:"+"})]}),o.jsx("div",{className:"px-6 py-4 text-sm",style:{color:"var(--color-muted-foreground)"},children:g.a})]},b))})]}),o.jsxs("section",{className:"mb-12 text-center",children:[o.jsx("h2",{className:"font-serif text-2xl font-bold mb-4",children:"¿Listo para proteger tu clínica u oficina en Chapinero?"}),o.jsx("p",{className:"mb-6",style:{color:"var(--color-muted-foreground)"},children:"Cotización sin compromiso en menos de 2 horas."}),o.jsx("a",{href:"https://wa.me/573337450634?text=Hola,%20quiero%20cotizar%20cámaras%20en%20Chapinero",target:"_blank",rel:"noopener noreferrer",className:"inline-block px-8 py-4 rounded-lg font-semibold text-white transition-opacity hover:opacity-90",style:{background:"var(--color-accent)"},children:"Solicitar cotización ahora"})]}),o.jsxs("section",{className:"rounded-xl p-6 md:p-8",style:{background:"var(--color-secondary)",border:"1px solid var(--color-border)"},children:[o.jsx("h2",{className:"font-serif text-xl font-bold mb-4 pb-2",style:{borderBottom:"2px solid var(--color-border)"},children:"Ecosistema APC: Todo conectado"}),o.jsx("div",{className:"prose prose-sm max-w-none font-sans mb-6",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(`| Línea | Qué hace | Enlace |
|-------|----------|--------|
| **APC Visión AI** | Analítica YOLO, PPE, aforo, arqueo, intrusión | [apcvisionai.site](https://apcvisionai.site) |
| **APC Automatización** | n8n flujos: CCTV → Alerta → WhatsApp/CRM/Dashboard | [apcautomatizacion.site](https://apcautomatizacion.site) |
| **DogWeb** | Web + SEO Local Bogotá → Formulario → WhatsApp Bot → Venta | [dogweb.lat](https://dogweb.lat) |
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`})})]})})]})}const nu="https://wa.me/573337450634?text=Hola%2C%20quiero%20el%20precio%20de%20instalaci%C3%B3n%20de%20c%C3%A1maras%20de%20seguridad%20en%20Bogot%C3%A1";function uh({md:i}){return o.jsx("div",{className:"prose prose-lg max-w-none font-sans",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(i)}})}const mh=[{q:"¿Cuánto cuesta la instalación de un sistema de cámaras de seguridad en Bogotá?",a:"Un sistema de 4 cámaras cuesta desde $1.800.000 COP con instalación y configuración incluida. Uno de 8 cámaras ColorVu ronda los $3.200.000 y uno de 16 con NVR PoE, $5.600.000. La cotización varía por distancia de cableado, número de puntos y accesibilidad."},{q:"¿El precio incluye el valor de la instalación o solo las cámaras?",a:"Nuestros precios incluyen hardware, instalación, configuración y app móvil. No cobramos extra por los técnicos. Solo servicios adicionales (cableado extendido > 40m, acceso especial, servidor IA) se cotizan por separado."},{q:"¿Por qué un sistema de cámaras cuesta $1.800.000 cuando veo cámaras wifi en $150.000?",a:"La diferencia está en la grabación. Una cámara wifi barata graba en SD (que se llena, o se roban), no tiene retención de 90 días ni garantía. Un sistema Hikvision con DVR graba 24/7 en local, con respaldo y visión nocturna. Son cosas diferentes: una es un juguete, la otra es evidencia."},{q:"¿Ofrecen pagos a cuotas o financiación?",a:"Sí. Sistemas desde $1.800.000 se pueden financiar en cuotas con tarjeta de crédito (3, 6 y 12 cuotas) y también recibimos transferencia y efectivo. La cotización detalla las opciones."},{q:"¿La cotización es gratis y sin compromiso?",a:"Sí, completamente gratis. Hacemos diagnóstico por llamada/video o visita: medimos el punto, calculamos cableado y le entregamos precio cerrado antes de que usted se decida."},{q:"¿Qué incluye la garantía?",a:"Hardware con garantía de fábrica de 1 a 3 años. Instalación con respaldo técnico por plan (30 días a 12 meses). Los contratos de soporte mensual desde $250.000 incluyen mantenimiento preventivo cada 6 meses."}];function ph(){return o.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[o.jsx(sa,{title:"Precios de Instalación de Cámaras de Seguridad",subtitle:"Cuánto cuesta realmente instalar cámaras de seguridad en Bogotá en 2026: sin letra pequeña, incluyendo hardware, instalación, configuración y acceso desde el celular.",ctaLabel:"Pedir Cotización",onCta:()=>{}}),o.jsx("section",{className:"py-12 bg-background border-b border-border",children:o.jsx("div",{className:"max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6",children:[{icon:ga,label:"4 cámaras",sub:"desde $1.800.000"},{icon:Yo,label:"Instalación",sub:"incluida en el precio"},{icon:Pr,label:"Garantía",sub:"1 a 3 años"},{icon:fa,label:"Cotización",sub:"gratis y cerrada"}].map(i=>o.jsxs("div",{className:"text-center",children:[o.jsx(i.icon,{className:"w-6 h-6 mx-auto mb-2",style:{color:"var(--color-accent)"}}),o.jsx("p",{className:"font-sans font-semibold text-sm",children:i.label}),o.jsx("p",{className:"font-sans text-xs",style:{color:"var(--color-muted-foreground)"},children:i.sub})]},i.label))})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"¿Qué afecta el precio?"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"El mismo sistema puede costar diferente en dos locales en Bogotá. Estos son los 4 factores que tocan el valor final:"}),o.jsx("div",{className:"space-y-6",children:[{icon:ga,title:"Número de cámaras (puntos)",desc:"Cada punto adicional suma cámara + capacidad del DVR/NVR + tiempo de instalación. De 4 a 8 puntos suele ser 1 día; de 16+ puntos, 2-3 días."},{icon:rg,title:"Tipo de cámara",desc:"Una HD 4MP básica cuesta menos que una ColorVu (color de noche) o una IP con IA. En zonas oscuras recomendamos ColorVu para que la evidencia sea útil."},{icon:Yf,title:"Distancia de cableado",desc:"Los precios incluyen una base de cableado. Pasillos muy largos o techos altos agregan cable y tiempo de trabajo. Por eso la cotización con previa visita es cerrada, no estimada."},{icon:Pr,title:"Tipo de negocio y Cobertura",desc:"Restaurantes con aforo IA, bodegas con LPR (placas), clínicas con requisitos de Normativa 1581: cada operación pide hardware y config distinta. Nuestra cotización la arma sobre eso."}].map(i=>o.jsxs("div",{className:"flex flex-col md:flex-row gap-6 p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsx("div",{className:"flex-shrink-0",children:o.jsx("div",{className:"w-12 h-12 rounded-lg flex items-center justify-center",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-6 h-6",style:{color:"var(--color-accent)"}})})}),o.jsxs("div",{className:"flex-1",children:[o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans leading-relaxed",style:{color:"var(--color-muted-foreground)"},children:i.desc})]})]},i.title))})]})}),o.jsx("section",{id:"tabla",className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-6xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Tabla de precios de instalación de cámaras 2026"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Precios en pesos colombianos, incluyen instalación y configuración. Cotice a su medida vía WhatsApp:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",children:pricingPlans.map(i=>o.jsxs("div",{className:"relative flex flex-col p-6 rounded-xl border-2 transition-all",style:{borderColor:i.highlight?"var(--color-accent)":"var(--color-border)",backgroundColor:i.highlight?"var(--color-accent)":"var(--color-background)",color:i.highlight?"var(--color-background)":"var(--color-foreground)"},children:[i.highlight&&o.jsx("div",{className:"absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-sans font-bold px-4 py-1 rounded-full",style:{backgroundColor:"var(--color-background)",color:"var(--color-accent)"},children:"Más vendido"}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-1",children:i.name}),o.jsx("p",{className:"font-sans text-sm mb-1",style:{opacity:.8},children:i.cameras}),o.jsx("div",{className:"font-serif text-3xl font-bold my-4",children:i.price}),o.jsx("p",{className:"font-sans text-sm mb-6",style:{opacity:.7},children:i.desc}),o.jsx("ul",{className:"space-y-2 mb-8 flex-1",children:i.features.map(l=>o.jsxs("li",{className:"flex items-start gap-2 text-sm font-sans",children:[o.jsx(fa,{className:"w-4 h-4 mt-0.5 flex-shrink-0",style:{opacity:.7}}),o.jsx("span",{children:l})]},l))}),o.jsxs("a",{href:nu,target:"_blank",rel:"noopener noreferrer",className:"w-full text-center px-6 py-3 rounded-lg font-sans font-semibold text-sm transition-all hover:scale-105 block",style:{backgroundColor:i.highlight?"var(--color-background)":"var(--color-accent)",color:i.highlight?"var(--color-accent)":"var(--color-background)",border:i.highlight?"2px solid var(--color-background)":"none"},children:["Cotizar ",i.name]})]},i.name))}),o.jsx("div",{className:"mt-8 text-center",children:o.jsx("p",{className:"font-sans text-sm",style:{color:"var(--color-muted-foreground)"},children:"* Precios referenciales Bogotá. La cotización final es cerrada solo después de la visita técnica. Financiación a 12 cuotas con tarjeta de crédito."})})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Por qué nuestros precios no se 'chotan'"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"No publicamos precio de gancho de $300.000 para luego cobrar $1.800.000 en partes. Esta es de a diferencia:"}),o.jsx("div",{className:"grid md:grid-cols-3 gap-6",children:[{icon:fa,title:"Precio cerrado",desc:"La cotización con los puntos exactos y el cableado real, no una estimación que 'se puede pasar'."},{icon:na,title:"WhatsApp directo, no call center",desc:"Habla directo con el instalador/consultor, no con un operador que solo agenda citas. Las preguntas de precios se responden ahí mismo."},{icon:Se,title:"IVA incluido",desc:"Todos los precios publicados están en COP e incluyen IVA. No le agregan 'detallitos' al final."}].map(i=>o.jsxs("div",{className:"p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsx("div",{className:"w-10 h-10 rounded-lg flex items-center justify-center mb-4",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}})}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)"},children:i.desc})]},i.title))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Preguntas frecuentes sobre precios"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12",style:{color:"var(--color-muted-foreground)"},children:"Las dudas más comunes cuando se compara el precio de instalar cámaras:"}),o.jsx("div",{className:"space-y-4",children:mh.map(i=>o.jsxs("details",{className:"group border rounded-xl overflow-hidden",style:{borderColor:"var(--color-border)"},children:[o.jsxs("summary",{className:"flex items-center justify-between gap-4 p-5 font-sans font-semibold cursor-pointer select-none list-none",children:[o.jsx("span",{children:i.q}),o.jsx(Se,{className:"w-5 h-5 flex-shrink-0 transition-transform group-open:rotate-90",style:{color:"var(--color-accent)"}})]}),o.jsx("div",{className:"px-5 pb-5 font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)",borderTop:"1px solid var(--color-border)"},children:o.jsx("p",{className:"pt-4",children:i.a})})]},i.q))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto text-center",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4",children:"Cotice su sistema hoy"}),o.jsx("p",{className:"font-sans text-lg mb-8 max-w-xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Mándenos WhatsApp cuántas cámaras necesita y el sector: recibe precio indicativo en minutos y cotización cerrada tras la visita técnica."}),o.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-center gap-4 mb-12",children:[o.jsxs("a",{href:nu,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base transition-all hover:scale-105",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx(na,{className:"w-4 h-4"})," WhatsApp: 333 745 0634"]}),o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base border-2 transition-all hover:scale-105",style:{borderColor:"var(--color-border)",color:"var(--color-foreground)"},children:[o.jsx(ir,{className:"w-4 h-4"})," Email Directo"]})]}),o.jsx("div",{className:"text-left",children:o.jsx(uh,{md:`
## Ecosistema APC: Todo conectado
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`})})]})})]})}const su="https://wa.me/573337450634?text=Hola%2C%20necesito%20informaci%C3%B3n%20sobre%20el%20mantenimiento%20de%20c%C3%A1maras%20de%20seguridad%20en%20Bogot%C3%A1";function fh({md:i}){return o.jsx("div",{className:"prose prose-lg max-w-none font-sans",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(i)}})}const gh=[{q:"¿En qué consiste el mantenimiento de cámaras de seguridad?",a:"Es un servicio periódico (preventivo) y de reparación (correctivo) que garantiza que sus cámaras graben siempre con calidad. Incluye limpieza de lentes, revisión de cableado y conexiones, actualización de firmware, verificación de almacenamiento (DVR/NVR) y revisión de configuración de grabación continua por eventos. En Servicios APC añadimos una capa extra: alineamos el sistema para que esté listo para analítica IA y alertas por WhatsApp."},{q:"¿Cada cuánto debo hacer mantenimiento preventivo de cámaras?",a:"Recomendamos una revisión preventiva cada 6 meses. En Bogotá, el polvo, la humedad y las lluvias (cámaras exteriores) degradan lentes y conectores. Un mantenimiento semestral evita que una cámara grabando 'a negro' pase semanas sin notarse. Si su negocio es crítico (caja, bodega), puede optar por supervisión remota mensual de caídas."},{q:"¿Cuánto cuesta el mantenimiento de cámaras en Bogotá?",a:"El mantenimiento preventivo por visita parte de $180.000 COP e incluye la revisión de hasta 4 cámaras (limpieza, firmware, cableado y configuración). Cada cámara adicional suma un costo menor. El mantenimiento correctivo (reemplazo de equipo o reparación) se cotiza según la falla. Ofrecemos planes de supervisión remota mensual desde $250.000 COP."},{q:"¿Revisan y reparaman cámaras de cualquier marca?",a:"Sí. Trabajamos principalmente con Hikvision y Dahua, pero revisamos y optimizamos cámaras de cualquier marca que exponga RTSP/ONVIF: Uniview, Axis, Hanwha, TP-Link VIGI, entre otras. Si su sistema está en mal estado, lo ponemos a grabar correctamente y, si aplica, lo dejamos listo para IA sin comprar hardware nuevo."},{q:"¿Pueden diagnosticar una cámara que no graba o se ve borrosa?",a:"Sí. Ese es uno de los servicios más solicitados. Detectamos si el problema es el lente (sucio o velado), el cableado, la fuente de alimentación, la red o la configuración del DVR. Le entregamos diagnóstico con causa exacta y cotización antes de intervenir. Solo damos solución cuando usted lo aprueba."},{q:"¿El mantenimiento incluye revisión de la grabación y el respaldo?",a:"Sí. Revisamos que el DVR/NVR esté grabando de forma continua o por eventos, que la retención de video sea la correcta (recomendamos 90 días) y que el almacenamiento no esté saturado. Le dejamos configurado el respaldo y las alertas de fallo para que un problema de grabación no pase desapercibido."},{q:"¿En qué zonas de Bogotá realizan mantenimiento de cámaras?",a:"Cubrimos toda Bogotá: Suba, Kennedy, Chapinero, Usaquén, Fontibón, Bosa, Engativá, Centro y sur de la ciudad. También atendemos municipios cercanos de Cundinamarca con visita técnica. También ofrecemos supervisión remota y diagnóstico por video-llamada para el resto de Colombia."}];function hh(){return o.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[o.jsx(sa,{title:"Mantenimiento de CÃ¡maras de Seguridad en BogotÃ¡",subtitle:"Su cÃ¡mara graba a negro, se ve borrosa o dejÃ³ de grabar? Servicio de mantenimiento preventivo y correctivo para sistemas CCTV Hikvision / Dahua en BogotÃ¡: limpieza, firmware, cableado y configuraciÃ³n.",ctaLabel:"Cotizar",onCta:()=>{}}),o.jsx("section",{className:"py-12 bg-background border-b border-border",children:o.jsx("div",{className:"max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6",children:[[{icon:ga,label:"Preventivo",sub:"desde $180.000 / visita"},{icon:Yo,label:"Respuesta",sub:"< 24 horas"},{icon:pi,label:"DiagnÃ³stico",sub:"causa exacta"},{icon:Eg,label:"ReparaciÃ³n",sub:"todas las marcas"}]].map(i=>o.jsxs("div",{className:"text-center",children:[o.jsx(i.icon,{className:"w-6 h-6 mx-auto mb-2",style:{color:"var(--color-accent)"}}),o.jsx("p",{className:"font-sans font-semibold text-sm",children:i.label}),o.jsx("p",{className:"font-sans text-xs",style:{color:"var(--color-muted-foreground)"},children:i.sub})]},i.label))})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"¿Por qué mantener sus cámaras y no esperar a que fallen?"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"La cámara que no graba es un gasto, no un activo. Casi nunca falla 'de golpe': se degrada poco a poco —lente velado, señal intermitente, almacenamiento lleno— hasta que un día necesita justo el video que no tiene. Esto es lo que un mantenimiento profesional previene:"}),o.jsx("div",{className:"space-y-8",children:[{icon:pi,title:"Cámaras que graban con calidad real",desc:"Limpieza de lentes, ajuste de enfoque y balance de color. Sin cámaras que 'se ven grises' o veladas. En exteriores de Bogotá, polvo y lluvia degradan rápido la imagen nocturna."},{icon:Xf,title:"Nunca más 'no estaba grabando'",desc:"Verificamos almacenamiento (DVR/NVR), retención de 90 días, grabación continua o por eventos y respaldo. Detectamos discos saturados o zonas que dejaron de grabar sin avisar."},{icon:bi,title:"Cableado sano y conexiones estables",desc:"Revisamos sujeción, conectores, fuentes de alimentación y signos de corto o interferencia. Un cable flojo en un canal es la causa #1 de cámaras que 'caen' intermitentemente."},{icon:Ar,title:"Firmware y seguridad actualizados",desc:"Actualizamos el firmware de su DVR/NVR y cámaras. Sistemas desactualizados son vulnerables y pierden compatibilidad. Correcta configuración de contraseñas y acceso remoto seguro."},{icon:fa,title:"Dejamos el sistema listo para IA",desc:"Alinear su CCTV para que esté listo para analítica (conteo, aforo, arqueo, alertas por WhatsApp) sin comprar hardware nuevo. Mantenimiento hoy, analítica cuando la necesite."}].map(i=>o.jsxs("div",{className:"flex flex-col md:flex-row gap-6 p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsx("div",{className:"flex-shrink-0",children:o.jsx("div",{className:"w-12 h-12 rounded-lg flex items-center justify-center",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-6 h-6",style:{color:"var(--color-accent)"}})})}),o.jsxs("div",{className:"flex-1",children:[o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans leading-relaxed",style:{color:"var(--color-muted-foreground)"},children:i.desc})]})]},i.title))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-5xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Servicios de mantenimiento de cámaras que ofrecemos"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Desde una revisión puntual hasta contratos de soporte continuo para su negocio:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:[{icon:au,title:"Mantenimiento preventivo",desc:"Revisión programada: limpieza, firmware, cableado y configuración. El mejor costo/beneficio para que su sistema nunca lo deje a ciegas.",bullets:"Visita semestral · desde $180.000"},{icon:Ar,title:"Mantenimiento correctivo",desc:"Reparación de cámaras, DVR/NVR, fuentes y cableado. Reemplazo de equipos defectuosos con diagnóstico y cotización aprobada.",bullets:"Respuesta < 24h · todas las marcas"},{icon:pi,title:"Diagnóstico técnico",desc:"¿Cámara a negro, borrosa, que se cae? Detectamos la causa exacta del fallo (lente, cable, red, configuración) y le entregamos plan de solución.",bullets:"Visita o video-llamada · gratis al contratar"},{icon:fn,title:"Supervisión remota mensual",desc:"Monitoreo de caídas de cámaras, estado de grabación y alertas por WhatsApp/Email. Detectamos problemas antes de que usted los note.",bullets:"Desde $250.000 / mes"},{icon:Go,title:"Mantenimiento empresarial",desc:"Contrato de soporte para oficinas, clínicas, colegios y empresas: visitas periódicas, SLA de respuesta y reporte técnico mensual del estado de su sistema.",bullets:"Multi-site · SLA garantizado"},{icon:ku,title:"Puesta en marcha de IA",desc:"Sobre su CCTV ya mantenido: activamos conteo de personas, control de aforo, arqueo asistido y alertas automáticas. Su cámara pasa de vigilar a auditar.",bullets:"Hikvision/Dahua RTSP/ONVIF"}].map(i=>o.jsxs("div",{className:"group p-6 rounded-xl border transition-all hover:shadow-lg",style:{borderColor:"var(--color-border)"},children:[o.jsx("div",{className:"w-10 h-10 rounded-lg flex items-center justify-center mb-4",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}})}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed mb-4",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsx("span",{className:"text-xs font-sans px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.9},children:i.bullets})]},i.title))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-5xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Negocios de Bogotá que más necesitan mantenimiento de cámaras"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Si depende de sus cámaras para auditar caja, mercancía o el flujo de clientes, un sistema descuidado es un riesgo silencioso:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",children:[{icon:Cu,title:"Tiendas y minimercados",desc:"Arqueo de caja, fachada y bodega. Si la cámara de caja no graba bien, pierde la evidencia de las discrepancias de dinero."},{icon:Restaurant,title:"Restaurantes y cafés",desc:"Control de salón, cocina y barra. Aforo y cumplimiento de normas con analítica opcional."},{icon:Go,title:"Oficinas y servicios",desc:"Accesos, recepción y zonas restringidas. Control de ingreso y respaldo de incidentes."},{icon:gn,title:"Bodegas y talleres",desc:"Patios de carga, perimetrales y zonas de almacenamiento. Cámaras tecnologizadas que graban día y noche."}].map(i=>o.jsxs("div",{className:"p-6 rounded-xl border",style:{borderColor:"var(--color-border)"},children:[o.jsx(i.icon,{className:"w-6 h-6 mb-4",style:{color:"var(--color-accent)"}}),o.jsx("h3",{className:"font-serif text-lg font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)"},children:i.desc})]},i.title))})]})}),o.jsx("section",{id:"proceso",className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Cómo funciona el servicio de mantenimiento"}),o.jsx("p",{className:"font-sans text-lg text-center mb-16 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Del primer mensaje al sistema grabando correctamente en 4 pasos:"}),o.jsxs("div",{className:"space-y-12 relative",children:[o.jsx("div",{className:"absolute left-6 md:left-8 top-0 bottom-0 w-0.5",style:{backgroundColor:"var(--color-border)"}}),[{icon:vn,step:"01",title:"Diagnóstico técnico",desc:"Coordinamos visita o video-llamada. Reportamos el estado de sus cámaras, la causa de cualquier falla y le entregamos cotización cerrada. Sin intervenir hasta que usted apruebe.",time:"mismo día"},{icon:au,step:"02",title:"Mantenimiento preventivo / correctivo",desc:"Limpiamos lentes, revisamos cableado y fuentes, actualizamos firmware, verificamos almacenamiento y reparamos lo aprobado. Dejamos todo limpio y ordenado.",time:"2-4 horas"},{icon:Ar,step:"03",title:"Configuración y reporte",desc:"Dejamos grabación continua correcta, retención de 90 días y acceso remoto. Le entregamos un reporte claro del estado de cada cámara: qué se corrigió y qué se recomienda.",time:"entrega del día"},{icon:fn,step:"04",title:"Seguimiento y soporte",desc:"Según el plan, activamos supervisión remota y alertas por WhatsApp/Email ante caídas. Un problema se detecta en minutos, no en semanas.",time:"24/7 opcional"}].map(i=>o.jsxs("div",{className:"relative flex gap-6 md:gap-8",children:[o.jsx("div",{className:"flex-shrink-0 z-10",children:o.jsx("div",{className:"w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center font-serif font-bold text-lg md:text-xl border-4",style:{backgroundColor:"var(--color-background)",borderColor:"var(--color-accent)",color:"var(--color-accent)"},children:i.step})}),o.jsxs("div",{className:"flex-1 pt-2 md:pt-4",children:[o.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}}),o.jsx("h3",{className:"font-serif text-xl md:text-2xl font-bold",children:i.title})]}),o.jsx("p",{className:"font-sans leading-relaxed mb-3",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsxs("span",{className:"inline-block text-xs font-sans font-semibold px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.8},children:["⏱ ",i.time]})]})]},i.step))]})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto text-center",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4",children:"Precios de mantenimiento de cámaras 2026"}),o.jsx("p",{className:"font-sans text-lg mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Tarifas referenciales en Bogotá para mantenimiento preventivo y correctivo (COP, IVA incluido). Cotización cerrada según su sistema."}),o.jsx("div",{className:"overflow-x-auto mb-8 rounded-xl border",style:{borderColor:"var(--color-border)"},children:o.jsxs("table",{className:"w-full text-sm font-sans",children:[o.jsx("thead",{children:o.jsxs("tr",{style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx("th",{className:"px-4 py-3 text-left font-sans font-semibold",children:"Servicio"}),o.jsx("th",{className:"px-4 py-3 text-left font-sans font-semibold",children:"Alcance"}),o.jsx("th",{className:"px-4 py-3 text-left font-sans font-semibold",children:"Precio desde"})]})}),o.jsx("tbody",{children:[["Mantenimiento preventivo","Hasta 4 cámaras: limpieza, firmware, cableado","$180.000 / visita"],["Cámara adicional","Cada punto extra de revisión","$35.000 / cámara"],["Diagnóstico correctivo","Causa exacta + cotización de reparación","Gratis al contratar"],["Supervisión remota mensual","Monitoreo de caídas + alertas WhatsApp","$250.000 / mes"],["Correctivo (equipo/reparación)","Según falla aprobada","Cotizado por caso"]].map((i,l)=>o.jsx("tr",{style:{borderTop:"1px solid var(--color-border)",backgroundColor:l%2?"var(--color-background)":"transparent"},children:i.map((c,m)=>o.jsx("td",{className:"px-4 py-3",style:{color:m===2?"var(--color-accent)":"var(--color-foreground)",fontWeight:m===2?700:"normal"},children:c},m))},l))})]})}),o.jsx("p",{className:"font-sans text-sm mb-8",style:{color:"var(--color-muted-foreground)"},children:"* El valor final depende del número de puntos, distancia de cableado y el estado del sistema. Diagnóstico y cotización sin costo."}),o.jsxs("a",{href:su,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base transition-all hover:scale-105",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx(na,{className:"w-4 h-4"})," Cotizar ahora por WhatsApp"]})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Preguntas frecuentes sobre mantenimiento de cámaras"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12",style:{color:"var(--color-muted-foreground)"},children:"Todo lo que necesita saber antes de agendar su revisión en Bogotá:"}),o.jsx("div",{className:"space-y-4",children:gh.map(i=>o.jsxs("details",{className:"group border rounded-xl overflow-hidden",style:{borderColor:"var(--color-border)"},children:[o.jsxs("summary",{className:"flex items-center justify-between gap-4 p-5 font-sans font-semibold cursor-pointer select-none list-none",children:[o.jsx("span",{children:i.q}),o.jsx(Se,{className:"w-5 h-5 flex-shrink-0 transition-transform group-open:rotate-90",style:{color:"var(--color-accent)"}})]}),o.jsx("div",{className:"px-5 pb-5 font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)",borderTop:"1px solid var(--color-border)"},children:o.jsx("p",{className:"pt-4",children:i.a})})]},i.q))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto text-center",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4",children:"Agende su revisión de cámaras gratis"}),o.jsx("p",{className:"font-sans text-lg mb-8 max-w-xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Visitamos su negocio o casa en Bogotá, revisamos el estado de sus cámaras y le entregamos diagnóstico y cotización. Sin compromiso."}),o.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-center gap-4 mb-12",children:[o.jsxs("a",{href:su,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base transition-all hover:scale-105",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx(na,{className:"w-4 h-4"})," WhatsApp: 333 745 0634"]}),o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base border-2 transition-all hover:scale-105",style:{borderColor:"var(--color-border)",color:"var(--color-foreground)"},children:[o.jsx(ir,{className:"w-4 h-4"})," Email Directo"]})]}),o.jsx("div",{className:"text-left",children:o.jsx(fh,{md:`
## Ecosistema APC: Todo conectado
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`})})]})})]})}const bh="https://wa.me/573337450634?text=Hola%2C%20necesito%20un%20consultor%20tecnol%C3%B3gico%20para%20mi%20negocio%20en%20Bogot%C3%A1";function vh({md:i}){return o.jsx("div",{className:"prose prose-lg max-w-none font-sans",style:{color:"var(--color-foreground)"},dangerouslySetInnerHTML:{__html:U.parse(i)}})}const xh=[{q:"¿Qué hace exactamente un consultor tecnológico?",a:"Analiza cómo usa su negocio la tecnología, encuentra costos escondidos y flujos manuales que se pueden automatizar, y diseña un plan de implementación con retorno medible. No vendemos tecnología por vender: priorizamos lo que le genera ROI en el corto plazo."},{q:"¿En qué se diferencia de un ingeniero de sistemas tradicional?",a:"Un ingeniero de sistemas suele mantener la infraestructura. Un consultor tecnológico evalúa, decide y estructura: cuántas cámaras necesita realmente, si su CCTV sirve o hay que reprogramarlo, qué procesos se automatizan primero y cómo se conectan con su CRM."},{q:"¿Trabajan solo con empresas o también con negocios pequeños?",a:"Con ambos. Hemos hecho diagnósticos desde una ferretería de barrio en Kennedy hasta bodegas de distribución. Para PYMES el diagnóstico se enfoca en seguridad (cámaras), atención (WhatsApp bot) y automatización básica con retorno rápido."},{q:"¿Cuánto cuesta un diagnóstico tecnológico?",a:"El diagnóstico inicial de diagnóstico de 1 a 2 horas es gratuito cuando se concreta la implementación. Si solo quiere el informe sin ejecutar nada, tiene un costo desde $350.000 COP según el alcance."},{q:"¿Me obligan a comprar hardware nuevo?",a:"No. Nuestra filosofía es reutilizar: si sus cámaras Hikvision/Dahua cumplen RTSP/ONVIF las reprogramamos con IA en lugar de venderle equipos nuevos. Solo proponemos compra cuando el equipo existente no sirve y se lo explicamos con datos."},{q:"¿En qué zonas de Bogotá ofrecen consultoría?",a:"En toda Bogotá: Suba, Kennedy, Chapinero, Usaquén, Fontibón, Centro y sur. El diagnóstico remoto se hace por video-llamada; la visita técnica presencial se agenda dentro de los 2 días hábiles."}];function yh(){return o.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[o.jsx(sa,{title:"Consultor TecnolÃ³gico para Empresas en BogotÃ¡",subtitle:"Convertimos la tecnologÃ­a que ya paga en resultados medibles: seguridad con IA, automatizaciÃ³n de procesos y datos que toman decisiones. DiagnÃ³stico con retorno de inversiÃ³n, sin tecnicismos.",ctaLabel:"Cotizar",onCta:()=>{}}),o.jsx("section",{className:"py-12 bg-background border-b border-border",children:o.jsx("div",{className:"max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6",children:[[{icon:Cg,label:"DiagnÃ³stico",sub:"gratis con implementaciÃ³n"},{icon:cn,label:"ROI",sub:"medido en semanas"},{icon:eo,label:"Reutiliza",sub:"su CCTV actual"},{icon:dn,label:"Procesos",sub:"automatizados con n8n"}]].map(i=>o.jsxs("div",{className:"text-center",children:[o.jsx(i.icon,{className:"w-6 h-6 mx-auto mb-2",style:{color:"var(--color-accent)"}}),o.jsx("p",{className:"font-sans font-semibold text-sm",children:i.label}),o.jsx("p",{className:"font-sans text-xs",style:{color:"var(--color-muted-foreground)"},children:i.sub})]},i.label))})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-5xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"El costo escondido de NO tener consultoría"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"La mayoría de PYMES paga tecnología que no usan o usa tecnología que no funciona. Un consultor detecta esto en semanas:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:[{icon:ga,title:"Cámaras que no graban como deberían",desc:"Equipos instalados sin orientación correcta, SD llena, DVR sin configurar. El dueño cree que está protegido y descubre que no tiene video hasta después del robo.",tag:"Seguridad"},{icon:dn,title:"Tareas repetitivas que nadie mide",desc:"Reportes a mano, confirmaciones por WhatsApp copiadas una a una, inventario en Excel desactualizado. Horas que se convierten en dinero perdido cada mes.",tag:"Automatización"},{icon:cn,title:"Datos que no se usan para decidir",desc:"El negocio tiene datos (ventas, aforo, arqueos) pero la gerencia decide por intuición porque nadie los consolidó en un tablero.",tag:"Datos"}].map(i=>o.jsxs("div",{className:"p-6 md:p-8 rounded-xl border",style:{borderColor:"var(--color-border)",backgroundColor:"var(--color-background)"},children:[o.jsx("div",{className:"w-10 h-10 rounded-lg flex items-center justify-center mb-4",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}})}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed mb-4",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsx("span",{className:"text-xs font-sans px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.9},children:i.tag})]},i.title))})]})}),o.jsx("section",{id:"metodo",className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-4xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Cómo trabaja el consultor"}),o.jsx("p",{className:"font-sans text-lg text-center mb-16 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Un método claro, con entregables en cada etapa y retorno medido:"}),o.jsxs("div",{className:"space-y-12 relative",children:[o.jsx("div",{className:"absolute left-6 md:left-8 top-0 bottom-0 w-0.5",style:{backgroundColor:"var(--color-border)"}}),[{icon:vn,step:"01",title:"Diagnóstico tecnológico",desc:"Auditoría de su infraestructura actual: CCTV, conectividad, herramientas de gestión. Identificamos los 3 problemas que más plata le cuestan y los priorizamos por ROI.",time:"1-2 horas"},{icon:ig,step:"02",title:"Plan de acción con ROI",desc:"Le entregamos un plan concreto: qué se automatiza primero, si sus cámaras se reprograman o se reemplazan, y cuánto cuesta cada paso. Cada recomendación tiene costo y retorno estimado.",time:"2-3 días"},{icon:dn,step:"03",title:"Implementación por fases",desc:"Ejecutamos por fases pequeñas: primero lo que se paga solo (seguridad IA o automatización de WhatsApp), luego lo que agrega control (dashboards y reportes).",time:"Semanas"},{icon:cn,step:"04",title:"Seguimiento y ajuste",desc:"Medimos el resultado real: mermas reducidas, horas ahorradas, respuestas más rápidas. Ajustamos lo que no esté dando el retorno prometido. Usted recibe reportes claros.",time:"Mensual"}].map(i=>o.jsxs("div",{className:"relative flex gap-6 md:gap-8",children:[o.jsx("div",{className:"flex-shrink-0 z-10",children:o.jsx("div",{className:"w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center font-serif font-bold text-lg md:text-xl border-4",style:{backgroundColor:"var(--color-background)",borderColor:"var(--color-accent)",color:"var(--color-accent)"},children:i.step})}),o.jsxs("div",{className:"flex-1 pt-2 md:pt-4",children:[o.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}}),o.jsx("h3",{className:"font-serif text-xl md:text-2xl font-bold",children:i.title})]}),o.jsx("p",{className:"font-sans leading-relaxed mb-3",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsxs("span",{className:"inline-block text-xs font-sans font-semibold px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.8},children:["⏱ ",i.time]})]})]},i.step))]})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-5xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Áreas donde un consultor tecnológico agrega valor"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12 max-w-2xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"Del CCTV a los datos, todo conectado en un solo plan:"}),o.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:[{icon:ga,title:"Seguridad con IA (CCTV)",desc:"¿Sus cámaras Hikvision/Dahua sirven? Las auditamos, reprogramamos con analítica YOLO y conectamos alertas a WhatsApp. Reducción de mermas documentada del 68% en clientes de retail.",tag:"APC Visión AI"},{icon:dn,title:"Automatización de procesos",desc:"n8n + APIs: del dato de la cámara al CRM, del pedido al inventario, de la alerta al WhatsApp del gerente. Flujos que eliminan tareas manuales.",tag:"APC Automatización"},{icon:cn,title:"Datos y tableros ejecutivos",desc:"Centralizamos CCTV + CRM + ventas en dashboards (Looker/Grafana) para que la gerencia decida con datos reales, no con corazonadas.",tag:"APC Core"},{icon:xn,title:"Presencia digital y SEO local",desc:"Su negocio en Google Maps y búsquedas locales de Bogotá, con landing de alta conversión conectada a WhatsApp. CTA web → bot → cita → venta.",tag:"DogWeb"},{icon:wi,title:"Infraestructura y resiliencia",desc:"Servidores edge GPU, redes, bases de datos replicadas y respaldo. Si se cae el internet, su CCTV + IA siguen grabando en local.",tag:"APC Core"},{icon:na,title:"Bots de WhatsApp con IA",desc:"Atención 24/7: responden, agendan, califican leads. Conectado a su CRM y a la analítica de video para alertas automáticas.",tag:"APC Automatización"}].map(i=>o.jsxs("div",{className:"group p-6 rounded-xl border transition-all hover:shadow-lg",style:{borderColor:"var(--color-border)"},children:[o.jsx("div",{className:"w-10 h-10 rounded-lg flex items-center justify-center mb-4",style:{backgroundColor:"var(--color-accent)",opacity:.1},children:o.jsx(i.icon,{className:"w-5 h-5",style:{color:"var(--color-accent)"}})}),o.jsx("h3",{className:"font-serif text-xl font-bold mb-2",children:i.title}),o.jsx("p",{className:"font-sans text-sm leading-relaxed mb-4",style:{color:"var(--color-muted-foreground)"},children:i.desc}),o.jsx("span",{className:"text-xs font-sans px-3 py-1 rounded-full",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)",opacity:.9},children:i.tag})]},i.title))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)",backgroundColor:"var(--color-background)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4 text-center",children:"Preguntas frecuentes sobre consultoría tecnológica"}),o.jsx("p",{className:"font-sans text-lg text-center mb-12",style:{color:"var(--color-muted-foreground)"},children:"Lo que las empresas en Bogotá preguntan antes de empezar:"}),o.jsx("div",{className:"space-y-4",children:xh.map(i=>o.jsxs("details",{className:"group border rounded-xl overflow-hidden",style:{borderColor:"var(--color-border)"},children:[o.jsxs("summary",{className:"flex items-center justify-between gap-4 p-5 font-sans font-semibold cursor-pointer select-none list-none",children:[o.jsx("span",{children:i.q}),o.jsx(Se,{className:"w-5 h-5 flex-shrink-0 transition-transform group-open:rotate-90",style:{color:"var(--color-accent)"}})]}),o.jsx("div",{className:"px-5 pb-5 font-sans text-sm leading-relaxed",style:{color:"var(--color-muted-foreground)",borderTop:"1px solid var(--color-border)"},children:o.jsx("p",{className:"pt-4",children:i.a})})]},i.q))})]})}),o.jsx("section",{className:"py-16 md:py-24 px-6",style:{borderTop:"1px solid var(--color-border)"},children:o.jsxs("div",{className:"max-w-3xl mx-auto text-center",children:[o.jsx("h2",{className:"font-serif text-3xl md:text-4xl font-bold mb-4",children:"Agende su diagnóstico tecnológico"}),o.jsx("p",{className:"font-sans text-lg mb-8 max-w-xl mx-auto",style:{color:"var(--color-muted-foreground)"},children:"En 1-2 horas sabrá si su tecnología está protegiendo su dinero o gastándolo. Diagnóstico gratis si concreta la implementación."}),o.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-center gap-4 mb-12",children:[o.jsxs("a",{href:bh,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base transition-all hover:scale-105",style:{backgroundColor:"var(--color-accent)",color:"var(--color-background)"},children:[o.jsx(na,{className:"w-4 h-4"})," WhatsApp: 333 745 0634"]}),o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"inline-flex items-center gap-2 px-8 py-4 rounded-lg font-sans font-semibold text-base border-2 transition-all hover:scale-105",style:{borderColor:"var(--color-border)",color:"var(--color-foreground)"},children:[o.jsx(ir,{className:"w-4 h-4"})," Email Directo"]})]}),o.jsx("div",{className:"text-left",children:o.jsx(vh,{md:`
## Ecosistema APC: Todo conectado
...
**Servicios APC** — Bogotá, Cra. 52c #39b-22  \r
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  \r
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)`,Ah=`---\r
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  \r
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)\r
`,Bh={"guia-camaras-hikvision-ia-empresas-bogota-2026":Ch,"costo-camaras-seguridad-empresas-2026-hardware-vs-ia":Sh,"que-es-analitica-video-ia-empresas-bogota":Ah,"5-senales-camaras-no-protegen-empresa-bogota":kh,"negocio-camaras-ia-vs-sin-ia-caso-visual-antes-despues":Ph,"analitica-video-ia-ferreterias-bogota-caso-real-suba":Nh,"analitica-video-ia-clinicas-bogota-cumplimiento-seguridad":jh,"hikvision-colorvu-vs-acusense-vs-deepinview-ia-2026":wh,"normativa-videovigilancia-colombia-2026-ley-1581-habeas-data":zh,"automatizacion-n8n-cctv-alerta-whatsapp-crm-dashboard":Ih,"seo-local-google-maps-empresas-seguridad-bogota":Eh,"servidores-edge-gpu-para-ia-video-analitica-bogota":Th,"hikvision-vs-dahua-vs-uniview-comparativa-ia-2026":Dh,"bot-whatsapp-ia-atencion-clientes-seguridad-bogota":Rh,"deteccion-ppe-ia-construccion-fabrica-bogota-cumplimiento":Lh,"cuanto-cuesta-camaras-seguridad-negocio-bogota-2026":Oh,"mejores-camaras-seguridad-local-comercial-bogota":qh,"camaras-seguridad-bodega-bogota-monitoreo-inteligente":Mh,"instalacion-camaras-seguridad-negocio-pequeno-bogota-guia":Vh};function $h(i){const l=i.match(/^---\n([\s\S]*?)\n---/);if(!l)return{fm:{},content:i};const c=l[1],m={};c.split(`
`).forEach(f=>{const g=f.indexOf(":");g>0&&(m[f.slice(0,g).trim()]=f.slice(g+1).trim().replace(/^["']|["']$/g,""))});const u=i.slice(l[0].length).trim();return{fm:m,content:u}}function Hh(){const i=new Date;return Object.entries(Bh).map(([l,c])=>{const{fm:m,content:u}=$h(c),f=m.publishDate||m.date;return f&&new Date(f)>i?null:{slug:l,title:m.title||"Sin título",excerpt:m.excerpt||"",date:m.date||"",publishDate:f,author:m.author||"Servicios APC",category:m.category||"IA & Seguridad",tags:m.tags?m.tags.split(",").map(g=>g.trim()):[],readTime:m.readTime||"5 min",coverImage:m.coverImage,content:U.parse(u),cta:m.cta?JSON.parse(m.cta.replace(/\\"/g,'"')):void 0}}).filter(l=>l!==null).sort((l,c)=>new Date(c.date).getTime()-new Date(l.date).getTime())}function Wo(i){return new Date(i).toLocaleDateString("es-CO",{day:"numeric",month:"long",year:"numeric"})}function _h({post:i,allPosts:l,onBack:c,onSelect:m}){return o.jsx("div",{className:"min-h-screen",children:o.jsxs("div",{className:"max-w-[728px] mx-auto px-5",children:[o.jsxs("button",{onClick:c,className:"flex items-center gap-1.5 text-sm text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)] transition-colors py-8",children:[o.jsx(Pf,{size:14}),o.jsx("span",{children:"Volver al blog"})]}),o.jsxs("article",{children:[o.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[o.jsx("span",{className:"text-sm font-medium text-[var(--color-accent)]",children:i.category}),o.jsx("span",{className:"text-[var(--color-border)]",children:"·"}),o.jsx("time",{className:"text-sm text-[var(--color-muted-foreground)]",dateTime:i.date,children:Wo(i.date)})]}),o.jsx("h1",{className:"font-serif text-[2.5rem] md:text-[3rem] leading-[1.15] font-bold text-[var(--color-foreground)] mb-5",children:i.title}),o.jsx("p",{className:"text-xl text-[var(--color-muted-foreground)] leading-relaxed mb-8",children:i.excerpt}),o.jsxs("div",{className:"flex items-center justify-between py-6 border-t border-b border-[var(--color-border)] mb-10",children:[o.jsxs("div",{className:"flex items-center gap-3",children:[o.jsx("div",{className:"w-10 h-10 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-sm font-bold text-[var(--color-accent)]",children:"SA"}),o.jsxs("div",{children:[o.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:i.author}),o.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[i.readTime," de lectura · ",Wo(i.date)]})]})]}),o.jsxs("div",{className:"flex items-center gap-3 text-[var(--color-muted-foreground)]",children:[o.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:o.jsx(wf,{size:18})}),o.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:o.jsx(zg,{size:18})})]})]}),i.coverImage&&o.jsx("figure",{className:"mb-10",children:o.jsx("img",{src:i.coverImage,alt:i.title,className:"w-full aspect-[16/9] object-cover"})}),o.jsx("div",{className:"blog-content max-w-none",dangerouslySetInnerHTML:{__html:i.content}}),o.jsx("div",{className:"flex flex-wrap gap-2 mt-12 mb-8",children:i.tags.map(u=>o.jsx("span",{className:"px-3 py-1.5 text-xs bg-[var(--color-secondary)] text-[var(--color-muted-foreground)] rounded-full",children:u},u))}),i.cta&&o.jsxs("div",{className:"my-12 p-8 bg-[var(--color-secondary)] rounded-2xl",children:[o.jsx("p",{className:"text-xs uppercase tracking-widest text-[var(--color-accent)] font-medium mb-3",children:"¿Necesitas esto para tu empresa?"}),o.jsx("h3",{className:"font-serif text-2xl font-bold text-[var(--color-foreground)] mb-5",children:i.cta.primary.label}),o.jsxs("div",{className:"flex flex-wrap gap-3",children:[o.jsxs("a",{href:i.cta.primary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-[var(--color-accent)] text-white px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity",children:["Solicitar cotización",o.jsx(Jr,{size:14})]}),i.cta.secondary&&o.jsxs("a",{href:i.cta.secondary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[i.cta.secondary.label,o.jsx(Jr,{size:14})]}),i.cta.tertiary&&o.jsxs("a",{href:i.cta.tertiary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[i.cta.tertiary.label,o.jsx(Jr,{size:14})]})]})]}),o.jsxs("div",{className:"border-t border-[var(--color-border)] pt-10 pb-16",children:[o.jsx("h3",{className:"text-sm uppercase tracking-widest text-[var(--color-muted-foreground)] mb-6",children:"Sigue leyendo"}),o.jsx("div",{className:"space-y-8",children:l.filter(u=>u.slug!==i.slug).slice(0,3).map(u=>o.jsxs("button",{onClick:()=>m(u.slug),className:"flex gap-6 text-left group w-full",children:[o.jsxs("div",{className:"flex-1 min-w-0",children:[o.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)] mb-1",children:u.category}),o.jsx("h4",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug mb-1",children:u.title}),o.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] line-clamp-2",children:u.excerpt}),o.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)] mt-2",children:[u.readTime," · ",Wo(u.date)]})]}),u.coverImage&&o.jsx("img",{src:u.coverImage,alt:"",className:"w-[120px] h-[80px] object-cover rounded-lg flex-shrink-0"})]},u.slug))})]})]})]})})}function iu(){const i=window.location.hash.slice(1);return i.startsWith("blog/")?i.slice(5):null}function Uh({initialSlug:i}){const[l,c]=Ae.useState(i??iu()),m=Hh(),u=m.find(A=>A.slug===l);Ae.useEffect(()=>{u&&(document.title=`${u.title} | Servicios APC Bogotá`)},[u]),Ae.useEffect(()=>{const A=()=>{const R=iu();c(R),R&&window.scrollTo({top:0})};return window.addEventListener("hashchange",A),()=>window.removeEventListener("hashchange",A)},[]);const f=A=>{c(A),window.location.hash=`blog/${A}`,window.scrollTo({top:0,behavior:"smooth"})},g=()=>{c(null),window.location.hash="blog",window.scrollTo({top:0,behavior:"smooth"})};if(u)return o.jsx(_h,{post:u,allPosts:m,onBack:g,onSelect:f});const b=m[0],k=m.slice(1);return o.jsxs("div",{className:"min-h-screen",children:[o.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 pt-12 pb-16",children:[o.jsx("p",{className:"text-xs uppercase tracking-[0.2em] text-[var(--color-accent)] font-medium mb-4",children:"Blog · Servicios APC"}),o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold text-[var(--color-foreground)] leading-tight max-w-3xl",children:"Cámaras Hikvision + IA para empresas"}),o.jsx("p",{className:"text-lg text-[var(--color-muted-foreground)] mt-4 max-w-2xl leading-relaxed",children:"Guías técnicas, comparativas y casos reales sobre CCTV con inteligencia artificial, automatización y seguridad empresarial en Bogotá."})]}),b&&o.jsx("div",{className:"max-w-[1200px] mx-auto px-5 mb-16",children:o.jsxs("button",{onClick:()=>f(b.slug),className:"group grid md:grid-cols-[1fr_1fr] gap-8 items-center text-left w-full",children:[b.coverImage&&o.jsx("div",{className:"overflow-hidden rounded-2xl",children:o.jsx("img",{src:b.coverImage,alt:b.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700"})}),o.jsxs("div",{className:"space-y-4 py-4",children:[o.jsx("p",{className:"text-xs uppercase tracking-[0.15em] text-[var(--color-accent)] font-medium",children:"Destacado"}),o.jsx("h3",{className:"font-serif text-3xl md:text-4xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-[1.15]",children:b.title}),o.jsx("p",{className:"text-[var(--color-muted-foreground)] leading-relaxed text-lg",children:b.excerpt}),o.jsxs("div",{className:"flex items-center gap-3 pt-2",children:[o.jsx("div",{className:"w-8 h-8 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-xs font-bold text-[var(--color-accent)]",children:"SA"}),o.jsxs("div",{children:[o.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:b.author}),o.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[b.readTime," · ",Wo(b.date)]})]})]})]})]})}),o.jsx("div",{className:"max-w-[1200px] mx-auto px-5",children:o.jsx("div",{className:"border-t border-[var(--color-border)]"})}),o.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 py-12",children:[o.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12",children:k.map(A=>o.jsxs("button",{onClick:()=>f(A.slug),className:"group text-left",children:[A.coverImage&&o.jsx("div",{className:"overflow-hidden rounded-xl mb-4",children:o.jsx("img",{src:A.coverImage,alt:A.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700",loading:"lazy"})}),o.jsxs("div",{className:"space-y-2.5",children:[o.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:A.category}),o.jsx("h3",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug",children:A.title}),o.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] leading-relaxed line-clamp-3",children:A.excerpt}),o.jsxs("div",{className:"flex items-center gap-3 pt-1",children:[o.jsx("div",{className:"w-6 h-6 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-[9px] font-bold text-[var(--color-accent)]",children:"SA"}),o.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[A.readTime," · ",Wo(A.date)]})]})]})]},A.slug))}),m.length===0&&o.jsx("div",{className:"text-center py-20 text-[var(--color-muted-foreground)]",children:o.jsx("p",{className:"text-lg",children:"Próximamente más artículos..."})})]})]})}function lu({slug:i}){return o.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[o.jsx(sa,{title:"Blog de Cámaras IA y Automatización",subtitle:"Guías, casos reales y novedades sobre analítica de video con IA, CCTV Hikvision, bots WhatsApp y automatización de procesos para empresas en Bogotá.",ctaLabel:"Ver artículos",onCta:()=>{}}),o.jsx(Uh,{initialSlug:i})]})}const Cr=[{id:"camaras",icon:ga,color:"#c94a0a",title:"Analítica de Video con IA para Hikvision/Dahua",tagline:"Sus cámaras dejan de vigilar y empiezan a auditar.",description:"Reprogramamos sus cámaras Hikvision/Dahua RTSP/ONVIF actuales con módulos YOLO: conteo de personas, mapas de calor, arqueo de caja asistido, detección de intrusión y reportes automáticos. No necesita comprar hardware nuevo: su CCTV existente ya es compatible con la mayoría de modelos Hikvision 2018+. Integración a n8n para alertas en Telegram/Email/WhatsApp.",bullets:["Conteo de personas y control de aforo en tiempo real","Mapas de calor y ocupación por zonas (heatmaps)","Arqueo de caja asistido por IA: video del cajón + monto","Detección de intrusión y alertas 24/7 sin vigilar pantallas","Se integra a su CCTV actual Hikvision/Dahua sin comprar hardware nuevo","Alertas por Telegram, Email y WhatsApp vía n8n"],image:"https://images.unsplash.com/photo-1760553120324-d3d2bf53852b?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Dashboard analítica de video IA sobre cámaras Hikvision"},{id:"cctv",icon:ku,color:"#0ea5e9",title:"Instalación CCTV Inteligente Hikvision en Bogotá",tagline:"Cobertura total, sin puntos ciegos, lista para IA.",description:"Planificamos e instalamos infraestructura CCTV profesional con cámaras Hikvision certificadas ya listas para analítica IA. Cableado estructurado, configuración RTSP/ONVIF, reprogramación de equipos existentes que cumplan estándar, cobertura 100% sin puntos ciegos. Soporte técnico presencial en Bogotá y remoto en toda Colombia. ¿Ya tiene Hikvision? Lo preparamos para IA sin cambiar cámaras.",bullets:["Planificación y tendido de cableado profesional estructurado","Cámaras Hikvision compatibles IA (RTSP/ONVIF) instaladas y configuradas","Reprogramación de hardware existente Hikvision/Dahua que cumpla estándar","Cobertura del 100% de puntos ciegos con mapas de calor","Soporte técnico remoto y presencial en Bogotá","Garantía extendida Hikvision + capa IA incluida"],image:"https://images.unsplash.com/photo-1557597774-9d273605dfa9?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Instalación profesional cámaras Hikvision con analítica IA"},{id:"bots",icon:Fo,color:"#25d366",title:"Bots de WhatsApp con IA",tagline:"Atienda a sus clientes 24/7, sin contratar más personal.",description:"Desarrollamos bots de WhatsApp con identidad propia que responden, agendan citas, procesan pedidos y califican leads de forma automática. Desde un menú interactivo básico hasta ecosistemas con APIs, pagos y agendamiento. Se conectan a su CRM y a la analítica de video: si una cámara detecta aforo lleno, el bot avisa al gerente.",bullets:["Atención automática 24 horas con IA conversacional","Menú interactivo, catálogos y respuestas con IA","Agendamiento de citas y pedidos integrados","Calificación y seguimiento de leads automático","Transferencia a agente humano cuando se necesita","Integración con analítica de video: alertas de aforo → WhatsApp"],image:"https://images.unsplash.com/photo-1636751364472-12bfad09b451?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Bot de WhatsApp para atención automática de clientes"},{id:"automatizacion",icon:zi,color:"#7c3aed",title:"Automatización de Procesos (n8n + APIs)",tagline:"Menos trabajo manual, más resultados.",description:"Diseñamos flujos de trabajo indestructibles que conectan sus herramientas, eliminan tareas repetitivas y entregan reportes programados. Menos errores humanos, menos tiempo perdido, más control. Conectamos su CCTV, CRM, ERP y WhatsApp en un solo cerebro n8n.",bullets:["Flujos automáticos e integraciones API (n8n self-hosted)","Onboarding digital de clientes con validación IA","CRM con seguimiento post-venta automatizado","Reportes programados 24 horas vía Email/Telegram","Notificaciones y alertas automáticas cruzadas","Integración CCTV → Alerta → Acción (WhatsApp, CRM, Dashboard)"],image:"https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Automatización de procesos empresariales con n8n"},{id:"dashboards",icon:ng,color:"#f59e0b",title:"Dashboards e Integración de Datos",tagline:"Todos sus datos CCTV + CRM + ERP, en una sola pantalla.",description:"Centralizamos la información dispersa de su operación en tableros ejecutivos claros. Integramos su software contable, CRM, analítica de video Hikvision y herramientas para que la gerencia tome decisiones con datos, no con corazonadas. Mapas de calor, conteo histórico, arqueos, tickets WhatsApp: todo unificado.",bullets:["Dashboards ejecutivos en tiempo real (Looker Studio / Grafana)","Integración entre CCTV Hikvision, CRM, ERP y WhatsApp","Bases de datos operativas centralizadas y replicadas","Reportería automatizada (Looker / PDF / Telegram)","Control de acceso a la información por roles","Exportación a Excel/CSV para contabilidad"],image:"https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Dashboard ejecutivo con métricas CCTV + CRM + ventas"},{id:"web",icon:xn,color:"#10b981",title:"Desarrollo Web y SEO Local en Bogotá (DogWeb)",tagline:"Presencia digital que atrae clientes reales en Google Maps.",description:"Creamos sitios web resilientes y posicionamos su negocio donde sus clientes en Bogotá lo buscan: Google Maps y búsquedas locales de la ciudad. Desde landings hasta portales corporativos con bases de datos y SEO técnico. Conectamos el sitio a su CRM y WhatsApp: lead web → bot → cita → venta.",bullets:["Sitios web corporativos y landings de alta conversión","Posicionamiento en Google Maps / SEO local Bogotá","Infraestructura web resiliente (Cloudflare + CDN)","Formularios, bases de datos y CRM integrado","Soporte y mantenimiento mensual incluido","CTAs cruzados: Web → WhatsApp Bot → CCTV Demo"],image:"https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=683&h=478&fit=crop&auto=format&fm=webp&q=50",imageAlt:"Desarrollo web y posicionamiento SEO local en Bogotá"}],Fh=[{domain:"apccore.site",name:"APC Core",description:"Sistemas de control, bases de datos operativas y tableros centralizados. El cerebro que une CCTV + IA + CRM.",icon:wi},{domain:"apcautomatizacion.site",name:"APC Automatización",description:"Flujos n8n que conectan su CCTV Hikvision + WhatsApp + CRM + ERP. Alerta de intrusión → WhatsApp al gerente → Ticket en CRM.",icon:zi},{domain:"apcvisionai.site",name:"APC Visión AI",description:"Especialistas en analítica YOLO sobre Hikvision/Dahua: conteo, mapas de calor, arqueo de caja, detección PPE, intrusión perimetral.",icon:ga},{domain:"dogweb.lat",name:"DogWeb",description:"Desarrollo web, SEO local / Google Maps y resiliencia de red. Su web posicionada en Bogotá + formularios → WhatsApp Bot → Venta.",icon:xn}],Wh=[{icon:Hg,title:"Arquitectura resiliente (Offline-First)",description:"Si se corta el internet, su Hikvision + IA sigue grabando y analizando en local (conteo, intrusión, arqueo). Sincroniza al volver la señal. Nada se pierde."},{icon:fa,title:"Cero tecnicismos, solo datos accionables",description:"Reportes diarios limpios vía Email/Telegram/WhatsApp. No necesita saber de IA ni YOLO; solo leer: 'Arqueo OK', 'Aforo 78%', 'Intrusión 0'."},{icon:Pr,title:"Hardware Hikvision reutilizable + IA",description:"No lo obligamos a comprar equipos costosos: reprogramamos su Hikvision/Dahua actual si cumple RTSP/ONVIF. Si necesita nuevo, instalamos Hikvision certificado IA-ready."}],Gh=[{client:"Ferretería El Progreso",sector:"Ferretería · Suba, Bogotá",implementation:"Hikvision 4K ColorVu + IA YOLO: detección de placas vehiculares nocturnas, conteo de clientes, arqueo de caja asistido.",result:"Recuperaron 3 bultos robados en 48h gracias a placa legible a las 2am. Aforo optimizado en horas pico. Cero discrepancias en arqueos mensuales."},{client:"Clínica Dental Sonrisa Viva",sector:"Salud · Chapinero, Bogotá",implementation:"Hikvision 2MP WDR + IA: control de aforo salas de espera, detección de caídas de pacientes, analítica de acceso a zonas restringidas (RX, esterilización).",result:"Cumplimiento normativo HIPAA/Ley 1581. Cero incidentes en zona RX. Alerta automática a enfermería ante caída (tiempo respuesta < 30 seg)."},{client:"Distribuidora Jone",sector:"Distribución · Bogotá",implementation:"Analítica YOLO sobre Hikvision existentes + CCTV nuevo en bodega + SEO local Google Maps + embudos conversión WhatsApp Bot.",result:"Visibilidad 100% puntos ciegos bodega. Aumento 340% cotizaciones orgánicas Bogotá. Bot WhatsApp atiende 80% consultas sin humano."}],Qh=[{q:"¿Tengo que cambiar todas las cámaras Hikvision de mi negocio para tener Inteligencia Artificial?",a:"No. Si sus cámaras Hikvision/Dahua actuales admiten RTSP u ONVIF (la mayoría desde 2018), las reprogramamos para inyectarles módulos YOLO sin gasto extra en hardware. Modelos Hikvision 2MP/4MP/4K ColorVu, AcuSense, DeepinView son 100% compatibles."},{q:"¿Qué pasa si en el local se corta el internet o la luz?",a:"Nuestro ecosistema cuenta con arquitectura Offline-First: el procesamiento IA ocurre en local (edge) en su red. Si el internet se va por horas, el sistema sigue grabando, contando personas, detectando intrusos y arqueando cajas, y sincroniza automáticamente al recuperar la señal. Nada se pierde."},{q:"¿La Inteligencia Artificial escucha conversaciones privadas de empleados o clientes?",a:"No. La IA de audio se activa solo bajo disparador específico (ej. sonido del cajón de la caja al abrirse) durante los segundos necesarios para documentar el monto. El resto de la jornada se protege la privacidad del equipo por diseño (privacy by design)."},{q:"¿Ustedes venden cámaras Hikvision o solo el software de IA?",a:"Ofrecemos ambas opciones: (1) Si ya tiene Hikvision/Dahua RTSP/ONVIF, solo instalamos la capa IA (analítica YOLO, alertas, dashboard). (2) Si necesita infraestructura nueva, instalamos CCTV Hikvision certificado IA-ready (ColorVu, AcuSense, DeepinView) + configuramos la analítica completa. Usted elige según su presupuesto."},{q:"¿Cómo se ve el análisis de video con IA en tiempo real en mi celular?",a:"Recibe alertas por Telegram/Email/WhatsApp con clip de video del evento (intrusión, aforo excedido, arqueo discrepante) y accede a dashboard web con mapas de calor, conteo histórico, arqueos diarios y reportes automáticos. Todo desde su celular, sin apps extra: usa Telegram o WhatsApp."},{q:"¿Qué modelos Hikvision recomiendan para analítica de video con IA?",a:"Para analítica YOLO recomendamos: (1) Hikvision ColorVu 4K/4MP — visión nocturna a color real, ideal para placas y rostros. (2) Hikvision AcuSense 2MP/4MP — filtrado falso positivo (persona/vehículo), costo/beneficio óptimo. (3) Hikvision DeepinView — IA embebida en cámara (conteo, PPE, cola), máxima precisión. Lo asesoramos según su caso y presupuesto."},{q:"¿La analítica de video funciona con Dahua u otras marcas?",a:"Sí. Cualquier cámara que exponga stream RTSP u ONVIF Profile S/T/G es compatible. Dahua, Uniview, Axis, Hanwha, TP-Link VIGI: si tiene stream estándar, le inyectamos YOLO. La diferencia es que Hikvision ColorVu/AcuSense nos da mejor calidad de imagen nocturna para IA."},{q:"¿Ustedes administran mi negocio o mi personal?",a:"No. Diseñamos, instalamos y mantenemos la infraestructura digital que automatiza su control. Le entregamos las herramientas exactas para que usted administre su empresa en minutos desde su celular, con datos claros y decisiones respaldadas. No supervisamos personal ni tomamos decisiones gerenciales."}],Yh=[{icon:Lg,title:"Cámaras Hikvision que auditan, no solo vigilan",description:"YOLO convierte cada frame en dato accionable: conteo, intrusión, aforo, arqueo. Sus cámaras dejan de ser gasto pasivo y se convierten en centro de ganancia."},{icon:Pr,title:"Offline-First: si se va el internet, la IA sigue",description:"Procesamiento edge en su red local. Sin internet, la IA sigue contando, detectando, arqueando. Sincroniza al volver la señal. Cero pérdida de datos."},{icon:Fo,title:"Alertas en Telegram/WhatsApp en segundos",description:"Intrusión, aforo excedido, arqueo discrepante: recibe clip de video + ubicación en Telegram/Email/WhatsApp al instante. Decides desde el celular."},{icon:Yo,title:"Dashboard 24/7 sin vigilar pantallas",description:"Mapas de calor, conteo histórico, arqueos diarios, alertas configurables. Todo en un dashboard web accesible desde el celular. Cero tecnicismos."},{icon:Au,title:"Hikvision ColorVu 4K: vea la placa a las 2 AM",description:"Instalamos ColorVu 4K / AcuSense / DeepinView. Visión nocturna a color real: vea placas, rostros, billetes en oscuridad total. No más 'cámaras borrosas'."},{icon:fa,title:"Su Hikvision actual ya sirve: sin comprar hardware nuevo",description:"RTSP/ONVIF estándar = compatible. La mayoría de Hikvision 2018+ ya sirven. Le inyectamos YOLO por red. Ahorro real: 0€ en cámaras nuevas si ya tiene compatibles."}];function Kh(){const[i,l]=Ae.useState(!1),[c,m]=Ae.useState(!1),[u,f]=Ae.useState({nombre:"",email:"",telefono:"",mensaje:""}),[g,b]=Ae.useState(!1),[k,A]=Ae.useState(!1),[R,E]=Ae.useState(""),[V,ae]=Ae.useState(0),[K,X]=Ae.useState(-1),[J,Ue]=Ae.useState(window.location.hash.slice(1));Ae.useEffect(()=>{const P=()=>m(window.scrollY>40);return window.addEventListener("scroll",P),()=>window.removeEventListener("scroll",P)},[]),Ae.useEffect(()=>{const P=()=>Ue(window.location.hash.slice(1));return window.addEventListener("hashchange",P),()=>window.removeEventListener("hashchange",P)},[]);const Be={negocio:{title:"Cámaras de Seguridad para Negocio en Bogotá | 500+ instalaciones",description:"Instalación de cámaras para negocio en Bogotá con IA. Hikvision ColorVu, analítica YOLO, aforo, arqueo y alertas WhatsApp. Desde $1.800.000. Cotiza gratis."},instalacion:{title:"Instalación de Cámaras de Seguridad en Bogotá | Hikvision Certificado",description:"Instalación profesional de cámaras de seguridad en Bogotá: cableado estructurado sin puntos ciegos, configuración remota y equipos IA-ready. Cotización con visita técnica."},casa:{title:"Cámaras para Instalar en Casa en Bogotá | Instalación el mismo día",description:"Cámaras para casa en Bogotá con visión nocturna a color y acceso desde el celular. Desde $600.000 por cámara, instalación el mismo día en toda la ciudad."},"precios-camaras":{title:"Precios de Instalación de Cámaras de Seguridad en Bogotá 2026",description:"Cuánto cuesta instalar cámaras de seguridad en Bogotá: desde $1.800.000 para 4 cámaras con instalación. Precios cerrados, IVA incluido y cotización gratis."},"mantenimiento-camaras":{title:"Mantenimiento de Cámaras de Seguridad en Bogotá | Preventivo y Correctivo",description:"Mantenimiento de cámaras de seguridad en Bogotá: preventivo, correctivo y supervisión remota para Hikvision/Dahua. Limpieza, firmware, cableado y configuración. Desde $180.000. Diagnóstico gratis."},consultor:{title:"Consultor Tecnológico para Empresas en Bogotá | Diagnóstico con ROI",description:"Consultor tecnológico en Bogotá: auditoría de seguridad CCTV con IA, automatización de procesos y dashboards. Diagnóstico gratis con implementación."},blog:{title:"Blog de Cámaras de Seguridad e IA | Servicios APC Bogotá",description:"Guías, comparativas y casos reales sobre CCTV Hikvision con inteligencia artificial en Bogotá: precios, instalación, analítica IA, automatización y seguridad empresarial."}};Ae.useEffect(()=>{const P=Be[J];if(!P)return;document.title=P.title;let W=document.querySelector('meta[name="description"]');W||(W=document.createElement("meta"),W.setAttribute("name","description"),document.head.appendChild(W)),W.setAttribute("content",P.description)},[J]);const $e={negocio:Jg,suba:eh,kennedy:ah,chapinero:rh,usaquen:oh,fontibon:th,instalacion:ih,casa:dh,"precios-camaras":ph,"mantenimiento-camaras":hh,consultor:yh,blog:lu},be=J.startsWith("blog/")?J.slice(5):null,we=$e[J];if(we||be)return o.jsxs("div",{className:"min-h-screen bg-background text-foreground font-sans",children:[o.jsx("nav",{className:"sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-14",children:[o.jsxs("button",{onClick:()=>{window.location.hash=""},className:"flex items-center gap-2.5",children:[o.jsx("img",{src:"/logo.webp",alt:"Servicios APC",className:"h-8 w-auto"}),o.jsx("span",{className:"text-foreground font-semibold text-sm hidden sm:block",children:"Servicios APC"})]}),o.jsx("a",{href:"https://wa.me/573337450634",target:"_blank",rel:"noopener noreferrer",className:"bg-accent text-white px-4 py-2 rounded-full text-sm font-medium hover:opacity-90 transition-opacity",children:"WhatsApp Gratis"})]})}),be?o.jsx(lu,{slug:be}):o.jsx(we,{}),o.jsx(Md,{})]});const se=P=>{document.getElementById(P)?.scrollIntoView({behavior:"smooth"}),l(!1)},Re=async P=>{P.preventDefault(),A(!0),E("");try{(await(await fetch("https://api.web3forms.com/submit",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:"c5cdb094-a9cd-4e68-9041-2fafe475fff6",subject:"Nuevo mensaje desde serviciosapc.site",from_name:"Servicios APC Website",nombre:u.nombre,email:u.email,telefono:u.telefono,mensaje:u.mensaje})})).json()).success?(b(!0),f({nombre:"",email:"",telefono:"",mensaje:""})):E("No pudimos enviar tu mensaje. Escríbenos por WhatsApp o inténtalo de nuevo.")}catch{E("Error de conexión. Escríbenos por WhatsApp o inténtalo de nuevo.")}finally{A(!1)}};return o.jsxs("div",{className:"min-h-screen bg-background text-foreground font-sans overflow-x-hidden",children:[o.jsxs("nav",{className:`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${c?"bg-background/95 backdrop-blur-sm border-b border-border":""}`,children:[o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-16",children:[o.jsxs("button",{onClick:()=>se("inicio"),className:"flex items-center gap-2.5",children:[o.jsx("img",{src:"/logo.webp",alt:"Servicios APC",className:"h-9 w-auto"}),o.jsx("span",{className:"text-foreground font-semibold text-sm tracking-wide hidden sm:block",children:"Servicios APC"})]}),o.jsxs("div",{className:"hidden md:flex items-center gap-7",children:[[["Servicios","servicios"],["Ecosistema","ecosistema"],["Casos","casos"],["Preguntas","faq"],["Quiénes somos","nosotros"],["Contacto","contacto"]].map(([P,W])=>o.jsx("button",{onClick:()=>se(W),className:"text-sm text-muted-foreground hover:text-foreground transition-colors font-medium",children:P},W)),o.jsx("a",{href:"#blog",className:"text-sm text-muted-foreground hover:text-foreground transition-colors font-medium",children:"Blog"})]}),o.jsx("div",{className:"hidden md:flex items-center gap-3",children:o.jsxs("a",{href:"https://wa.me/573337450634",target:"_blank",rel:"noopener noreferrer",className:"bg-accent text-accent-foreground px-5 py-2 text-sm font-medium hover:bg-accent/90 transition-colors flex items-center gap-2",children:[o.jsx(Fo,{size:14})," WhatsApp"]})}),o.jsx("button",{className:"md:hidden text-foreground p-1",onClick:()=>l(!i),children:i?o.jsx(Qg,{size:20}):o.jsx(pg,{size:20})})]}),i&&o.jsxs("div",{className:"md:hidden bg-background border-b border-border px-6 py-5 space-y-3",children:[[["Servicios","servicios"],["Ecosistema","ecosistema"],["Casos","casos"],["Preguntas","faq"],["Quiénes somos","nosotros"],["Contacto","contacto"]].map(([P,W])=>o.jsx("button",{onClick:()=>se(W),className:"block w-full text-left text-sm text-muted-foreground hover:text-foreground py-1.5",children:P},W)),o.jsx("a",{href:"#blog",onClick:()=>l(!1),className:"block w-full text-left text-sm text-muted-foreground hover:text-foreground py-1.5",children:"Blog"})]})]}),o.jsx(sa,{title:"Cámaras de seguridad para empresas que piensan: Hikvision + IA en tiempo real.",subtitle:"¿Cuánto te costó la última vez que tu cámara Hikvision justo NO grabó? Desde Bogotá, convertimos sus cámaras Hikvision/Dahua actuales en auditores inteligentes 24/7.",ctaLabel:"Descubre cómo podemos ayudarte",onCta:()=>se("servicios")}),o.jsx("section",{id:"inicio-card",className:"py-24 bg-secondary border-y border-border",children:o.jsx("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:o.jsxs("div",{className:"grid lg:grid-cols-2 gap-12 items-center",children:[o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-6",children:"Nuestros servicios"}),Cr.map((P,W)=>{const ke=P.icon;return o.jsxs("button",{onClick:()=>{ae(W),se("servicios")},className:"w-full flex items-center gap-4 p-4 border border-border hover:border-accent/30 hover:bg-secondary transition-all duration-200 text-left group",children:[o.jsx(ke,{size:18,style:{color:P.color},className:"flex-shrink-0"}),o.jsxs("div",{className:"flex-1 min-w-0",children:[o.jsx("p",{className:"text-sm font-semibold text-foreground group-hover:text-accent transition-colors truncate",children:P.title}),o.jsx("p",{className:"text-xs text-muted-foreground truncate",children:P.tagline})]}),o.jsx(Se,{size:14,className:"text-muted-foreground flex-shrink-0"})]},P.id)})]}),o.jsx("div",{className:"hidden lg:block",children:o.jsxs("div",{className:"border border-border bg-card/80 backdrop-blur-sm p-8 space-y-4",children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-6",children:"Nuestros servicios"}),Cr.map((P,W)=>{const ke=P.icon;return o.jsxs("button",{className:"w-full flex items-center gap-4 p-4 border border-border hover:border-accent/30 hover:bg-secondary transition-all text-left group",children:[o.jsx(ke,{size:18,style:{color:P.color},className:"flex-shrink-0"}),o.jsxs("div",{className:"flex-1 min-w-0",children:[o.jsx("p",{className:"text-sm font-semibold text-foreground group-hover:text-accent transition-colors truncate",children:P.title}),o.jsx("p",{className:"text-xs text-muted-foreground truncate",children:P.tagline})]}),o.jsx(Se,{size:14,className:"text-muted-foreground flex-shrink-0"})]},P.id)})]})})]})})}),o.jsx("section",{className:"py-10 bg-background border-b border-border",children:o.jsx("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:o.jsx("div",{className:"flex flex-wrap items-center gap-6",children:[["Control del dinero","Auditoría con IA"],["Offline-First","Nunca se pierde nada"],["Sin tecnicismos","Reportes claros"]].map(([P,W])=>o.jsxs("div",{className:"flex items-center gap-2",children:[o.jsx(fa,{size:14,className:"text-accent flex-shrink-0"}),o.jsxs("div",{children:[o.jsx("p",{className:"text-xs font-semibold text-foreground",children:P}),o.jsx("p",{className:"text-xs text-muted-foreground",children:W})]})]},P))})})}),o.jsx("section",{id:"servicios",className:"py-24 border-t border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid lg:grid-cols-12 gap-8 mb-16",children:[o.jsx("div",{className:"lg:col-span-3",children:o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase",children:"Nuestros Servicios"})}),o.jsxs("div",{className:"lg:col-span-9",children:[o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4",children:"Servicios de tecnología y automatización para empresas"}),o.jsx("p",{className:"text-muted-foreground max-w-xl leading-relaxed",children:"Soluciones tecnológicas diseñadas para empresas en Bogotá y toda Colombia que quieren operar mejor, reducir pérdidas y crecer con inteligencia."})]})]}),o.jsx("div",{className:"border-t border-border",children:Cr.map((P,W)=>{const ke=P.icon,ia=V===W;return o.jsxs("div",{className:"border-b border-border",children:[o.jsxs("button",{onClick:()=>ae(ia?-1:W),"aria-expanded":ia,className:"w-full flex items-center gap-4 py-6 text-left group",children:[o.jsx(ke,{size:22,style:{color:P.color},className:"flex-shrink-0"}),o.jsxs("div",{className:"flex-1 min-w-0",children:[o.jsx("h3",{className:"font-serif text-xl md:text-2xl font-bold group-hover:text-accent transition-colors",children:P.title}),o.jsx("p",{className:"font-mono text-xs tracking-widest uppercase mt-1",style:{color:P.color},children:P.tagline})]}),o.jsx(Se,{size:22,className:`text-muted-foreground flex-shrink-0 transition-transform duration-300 ${ia?"rotate-90":""}`})]}),ia&&o.jsxs("div",{className:"pb-10 grid lg:grid-cols-2 gap-10 items-center",children:[o.jsxs("div",{children:[o.jsx("p",{className:"text-muted-foreground leading-relaxed mb-6",children:P.description}),o.jsx("ul",{className:"space-y-3 mb-8",children:P.bullets.map(Xe=>o.jsxs("li",{className:"flex items-start gap-3 text-sm",children:[o.jsx(fa,{size:15,className:"mt-0.5 flex-shrink-0",style:{color:P.color}}),o.jsx("span",{children:Xe})]},Xe))}),o.jsxs("button",{onClick:()=>se("contacto"),className:"flex items-center gap-2 font-medium text-sm px-6 py-3 border transition-colors hover:opacity-80",style:{borderColor:P.color,color:P.color},children:["Solicitar información ",o.jsx(Gd,{size:14})]})]}),o.jsxs("div",{className:"relative order-first lg:order-last",children:[o.jsx("div",{className:"bg-secondary h-2 w-full absolute -top-2 left-0",style:{backgroundColor:P.color,opacity:.3}}),o.jsx("img",{src:P.image,alt:P.imageAlt,className:"w-full aspect-[4/3] object-cover",width:800,height:560,loading:"lazy",decoding:"async"})]})]})]},P.id)})})]})}),o.jsx("section",{id:"beneficios",className:"py-24 bg-secondary border-y border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid lg:grid-cols-12 gap-8 mb-16",children:[o.jsx("div",{className:"lg:col-span-3",children:o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase",children:"Beneficios"})}),o.jsxs("div",{className:"lg:col-span-9",children:[o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4",children:"Beneficios de automatizar su empresa con Servicios APC"}),o.jsx("p",{className:"text-muted-foreground max-w-xl leading-relaxed",children:"Mejore la eficiencia y competitividad de su empresa con soluciones tecnológicas hechas para la realidad colombiana."})]})]}),o.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border",children:Yh.map(P=>{const W=P.icon;return o.jsxs("div",{className:"bg-secondary p-8 hover:bg-background transition-colors duration-200",children:[o.jsx(W,{size:24,className:"text-accent mb-5"}),o.jsx("h3",{className:"font-serif text-lg font-bold mb-3",children:P.title}),o.jsx("p",{className:"text-muted-foreground text-sm leading-relaxed",children:P.description})]},P.title)})})]})}),o.jsx("section",{id:"nosotros",className:"py-24 border-b border-border",children:o.jsx("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:o.jsxs("div",{className:"grid lg:grid-cols-12 gap-12 items-center",children:[o.jsxs("div",{className:"lg:col-span-5 relative",children:[o.jsx("div",{className:"absolute -top-4 -left-4 w-full h-full border border-accent/30","aria-hidden":"true"}),o.jsxs("picture",{children:[o.jsx("source",{srcSet:"/servicios-apc.webp",type:"image/webp"}),o.jsx("img",{src:"/servicios-apc.jpeg",alt:"Fundador de Servicios APC — experto en soluciones tecnológicas para empresas en Bogotá, Colombia",width:900,height:1200,className:"w-full object-cover aspect-[3/4] relative z-10",loading:"lazy",decoding:"async"})]}),o.jsxs("div",{className:"absolute bottom-0 left-0 right-0 z-20 bg-accent px-6 py-4",children:[o.jsx("p",{className:"text-accent-foreground font-mono text-xs tracking-widest uppercase",children:"Fundador — Servicios APC"}),o.jsx("p",{className:"text-accent-foreground/70 text-xs mt-0.5 font-mono",children:"Bogotá, Colombia"})]})]}),o.jsxs("div",{className:"lg:col-span-7",children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-6",children:"Quiénes somos"}),o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-6 leading-tight",children:"Empresa de tecnología con base en Bogotá."}),o.jsxs("div",{className:"space-y-4 text-muted-foreground leading-relaxed",children:[o.jsxs("p",{children:[o.jsx("strong",{className:"text-foreground",children:"Servicios APC"})," es una empresa de tecnología con sede en Bogotá (Cra. 52c #39b-22). No vendemos tecnología por moda: diseñamos, instalamos y mantenemos la infraestructura digital que le devuelve el control de su dinero, su productividad y su operación."]}),o.jsxs("p",{children:["Nuestra presencia local nos permite ofrecer"," ",o.jsx("strong",{className:"text-foreground",children:"soporte técnico presencial en Bogotá"})," ","con respuesta rápida, y desplegar arquitectura y desarrollo de forma remota para clientes en el resto de Colombia."]}),o.jsx("p",{children:"No administramos su negocio ni supervisamos a su personal. Le entregamos las herramientas exactas para que usted administre su empresa en minutos desde su celular, con datos claros y decisiones respaldadas."})]}),o.jsxs("div",{className:"grid sm:grid-cols-2 gap-6 mt-8",children:[o.jsxs("div",{className:"border border-border p-6",children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-3",children:"Misión"}),o.jsx("p",{className:"text-sm text-muted-foreground leading-relaxed",children:"Blindar la operación de cada negocio con infraestructura digital resiliente y control automatizado, eliminando la pérdida de dinero y el desorden — sin exigir conocimientos técnicos al empresario."})]}),o.jsxs("div",{className:"border border-border p-6",children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-3",children:"Visión"}),o.jsx("p",{className:"text-sm text-muted-foreground leading-relaxed",children:"Ser el estándar de infraestructura digital indestructible en Colombia y la región, donde cada cámara, cada flujo y cada dato trabajan para proteger y hacer crecer el negocio."})]})]}),o.jsx("div",{className:"mt-10 pt-10 border-t border-border space-y-6",children:Wh.map(P=>{const W=P.icon;return o.jsxs("div",{className:"flex items-start gap-4",children:[o.jsx("div",{className:"w-10 h-10 border border-border flex items-center justify-center flex-shrink-0",children:o.jsx(W,{size:16,className:"text-accent"})}),o.jsxs("div",{children:[o.jsx("p",{className:"font-semibold text-foreground text-sm mb-1",children:P.title}),o.jsx("p",{className:"text-xs text-muted-foreground leading-relaxed",children:P.description})]})]},P.title)})})]})]})})}),o.jsx("section",{id:"ecosistema",className:"py-24 bg-secondary border-b border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid lg:grid-cols-12 gap-8 mb-16",children:[o.jsx("div",{className:"lg:col-span-3",children:o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase",children:"Ecosistema APC"})}),o.jsxs("div",{className:"lg:col-span-9",children:[o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4",children:"Un ecosistema, todo bajo control"}),o.jsx("p",{className:"text-muted-foreground max-w-xl leading-relaxed",children:"Servicios APC integra cuatro líneas especializadas que se conectan entre sí para blindar cada frente de su operación."})]})]}),o.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border",children:Fh.map(P=>{const W=P.icon;return o.jsxs("a",{href:`https://${P.domain}`,target:"_blank",rel:"noopener noreferrer",className:"group bg-secondary p-8 hover:bg-background transition-colors duration-200 block",children:[o.jsx(W,{size:24,className:"text-accent mb-5"}),o.jsx("h3",{className:"font-serif text-lg font-bold mb-1 group-hover:text-accent transition-colors",children:P.name}),o.jsxs("p",{className:"font-mono text-xs text-accent mb-3 flex items-center gap-1",children:[o.jsx(Jr,{size:11})," ",P.domain]}),o.jsx("p",{className:"text-muted-foreground text-sm leading-relaxed",children:P.description}),o.jsxs("span",{className:"mt-4 inline-flex items-center gap-1 text-xs font-medium text-accent opacity-0 group-hover:opacity-100 transition-opacity",children:["Visitar sitio ",o.jsx(Gd,{size:12})]})]},P.domain)})})]})}),o.jsx("section",{id:"casos",className:"py-24 border-b border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid lg:grid-cols-12 gap-8 mb-16",children:[o.jsx("div",{className:"lg:col-span-3",children:o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase",children:"Casos de éxito"})}),o.jsxs("div",{className:"lg:col-span-9",children:[o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4",children:"Casos de éxito de clientes en Bogotá"}),o.jsx("p",{className:"text-muted-foreground max-w-xl leading-relaxed",children:"Empresas de Bogotá que ya operan con más control y menos pérdidas gracias a la infraestructura de Servicios APC."})]})]}),o.jsx("div",{className:"grid md:grid-cols-3 gap-px bg-border",children:Gh.map(P=>o.jsxs("div",{className:"bg-background p-8",children:[o.jsx(vg,{size:24,className:"text-accent mb-5"}),o.jsx("h3",{className:"font-serif text-lg font-bold mb-1",children:P.client}),o.jsx("p",{className:"font-mono text-xs text-muted-foreground tracking-widest uppercase mb-5",children:P.sector}),o.jsx("p",{className:"text-xs font-semibold text-foreground mb-1",children:"Implementación"}),o.jsx("p",{className:"text-sm text-muted-foreground leading-relaxed mb-4",children:P.implementation}),o.jsx("p",{className:"text-xs font-semibold text-foreground mb-1",children:"Resultado"}),o.jsx("p",{className:"text-sm text-muted-foreground leading-relaxed",children:P.result})]},P.client))})]})}),o.jsx("section",{id:"faq",className:"py-24 bg-secondary border-b border-border",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid lg:grid-cols-12 gap-8 mb-16",children:[o.jsx("div",{className:"lg:col-span-3",children:o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase",children:"Preguntas frecuentes"})}),o.jsxs("div",{className:"lg:col-span-9",children:[o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4",children:"Preguntas frecuentes"}),o.jsx("p",{className:"text-muted-foreground max-w-xl leading-relaxed",children:"Resolvemos las dudas más comunes sobre nuestra infraestructura, privacidad y funcionamiento sin tecnicismos."})]})]}),o.jsx("div",{className:"max-w-3xl mx-auto border-t border-border",children:Qh.map((P,W)=>{const ke=K===W;return o.jsxs("div",{className:"border-b border-border",children:[o.jsxs("button",{onClick:()=>X(ke?-1:W),"aria-expanded":ke,className:"w-full flex items-center justify-between gap-4 py-6 text-left group",children:[o.jsx("span",{className:"font-serif text-lg font-bold group-hover:text-accent transition-colors",children:P.q}),o.jsx(Se,{size:20,className:`text-muted-foreground flex-shrink-0 transition-transform duration-300 ${ke?"rotate-90":""}`})]}),ke&&o.jsx("p",{className:"text-muted-foreground leading-relaxed pb-6 -mt-1",children:P.a})]},W)})})]})}),o.jsx("section",{id:"contacto",className:"py-24 border-b border-border",children:o.jsx("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:o.jsxs("div",{className:"grid lg:grid-cols-12 gap-12",children:[o.jsxs("div",{className:"lg:col-span-5",children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-6",children:"Contacto"}),o.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold mb-4 leading-tight",children:"Contacte a Servicios APC en Bogotá"}),o.jsx("p",{className:"text-muted-foreground leading-relaxed mb-10",children:"Cuéntanos tu necesidad. Te respondemos en menos de 24 horas hábiles con una propuesta concreta para tu empresa."}),o.jsxs("div",{className:"space-y-5",children:[o.jsxs("a",{href:"https://wa.me/573337450634",target:"_blank",rel:"noopener noreferrer",className:"flex items-start gap-4 group",children:[o.jsx("div",{className:"w-10 h-10 border border-border flex items-center justify-center flex-shrink-0 group-hover:border-accent/40 transition-colors",children:o.jsx(na,{size:15,className:"text-accent"})}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-muted-foreground tracking-widest uppercase mb-0.5",children:"Teléfono / WhatsApp"}),o.jsx("p",{className:"text-sm font-medium text-foreground group-hover:text-accent transition-colors",children:"+57 333 7450634"})]})]}),o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"flex items-start gap-4 group",children:[o.jsx("div",{className:"w-10 h-10 border border-border flex items-center justify-center flex-shrink-0 group-hover:border-accent/40 transition-colors",children:o.jsx(ir,{size:15,className:"text-accent"})}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-muted-foreground tracking-widest uppercase mb-0.5",children:"Correo electrónico"}),o.jsx("p",{className:"text-sm font-medium text-foreground group-hover:text-accent transition-colors",children:"serviciosapcsoporte@gmail.com"})]})]}),o.jsxs("div",{className:"flex items-start gap-4",children:[o.jsx("div",{className:"w-10 h-10 border border-border flex items-center justify-center flex-shrink-0",children:o.jsx(Xd,{size:15,className:"text-accent"})}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-muted-foreground tracking-widest uppercase mb-0.5",children:"Dirección"}),o.jsx("p",{className:"text-sm font-medium text-foreground",children:"Cra. 52c #39b-22, Bogotá"})]})]})]}),o.jsxs("a",{href:"https://wa.me/573337450634?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20sus%20soluciones%20tecnol%C3%B3gicas",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 mt-10 bg-[#25d366] text-white px-6 py-3 font-medium text-sm hover:bg-[#22c55e] transition-colors",children:[o.jsx(Fo,{size:15}),"Escribir por WhatsApp ahora"]})]}),o.jsx("div",{className:"lg:col-span-7",children:g?o.jsxs("div",{className:"h-full flex flex-col items-center justify-center border border-border p-12 text-center",children:[o.jsx(fa,{size:48,className:"text-accent mb-4"}),o.jsx("h3",{className:"font-serif text-2xl font-bold mb-3",children:"¡Mensaje enviado!"}),o.jsx("p",{className:"text-muted-foreground mb-6",children:"Gracias por contactarnos. Te responderemos en menos de 24 horas hábiles."}),o.jsx("button",{onClick:()=>b(!1),className:"text-sm font-medium text-accent underline underline-offset-4",children:"Enviar otro mensaje"})]}):o.jsxs("form",{onSubmit:Re,className:"border border-border p-8 lg:p-10 space-y-6",children:[o.jsxs("div",{className:"grid md:grid-cols-2 gap-6",children:[o.jsxs("div",{children:[o.jsx("label",{htmlFor:"nombre",className:"block font-mono text-xs text-muted-foreground tracking-widest uppercase mb-2",children:"Nombre completo *"}),o.jsx("input",{id:"nombre",type:"text",required:!0,value:u.nombre,onChange:P=>f({...u,nombre:P.target.value}),placeholder:"Tu nombre",className:"w-full bg-background border border-border px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition-colors"})]}),o.jsxs("div",{children:[o.jsx("label",{htmlFor:"email",className:"block font-mono text-xs text-muted-foreground tracking-widest uppercase mb-2",children:"Correo electrónico *"}),o.jsx("input",{id:"email",type:"email",required:!0,value:u.email,onChange:P=>f({...u,email:P.target.value}),placeholder:"tu@empresa.com",className:"w-full bg-background border border-border px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition-colors"})]})]}),o.jsxs("div",{children:[o.jsx("label",{htmlFor:"telefono",className:"block font-mono text-xs text-muted-foreground tracking-widest uppercase mb-2",children:"Teléfono"}),o.jsx("input",{id:"telefono",type:"tel",value:u.telefono,onChange:P=>f({...u,telefono:P.target.value}),placeholder:"+57 333 745 0634",className:"w-full bg-background border border-border px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition-colors"})]}),o.jsxs("div",{children:[o.jsx("label",{htmlFor:"mensaje",className:"block font-mono text-xs text-muted-foreground tracking-widest uppercase mb-2",children:"Mensaje *"}),o.jsx("textarea",{id:"mensaje",required:!0,rows:5,value:u.mensaje,onChange:P=>f({...u,mensaje:P.target.value}),placeholder:"¿Tiene Hikvision? ¿Necesita analítica? Cuéntenos...",className:"w-full bg-background border border-border px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-accent transition-colors resize-none"})]}),R&&o.jsx("p",{className:"text-sm text-red-500 text-center",children:R}),o.jsxs("button",{type:"submit",disabled:k,className:"w-full bg-accent text-accent-foreground py-4 font-semibold hover:bg-accent/90 transition-colors flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed",children:[o.jsx(Ag,{size:15}),k?"Enviando...":"Enviar mensaje"]}),o.jsx("p",{className:"text-xs text-muted-foreground text-center font-mono",children:"Tu información es confidencial y no será compartida con terceros."})]})})]})})}),o.jsx("footer",{className:"py-10 bg-background",children:o.jsxs("div",{className:"max-w-7xl mx-auto px-6 lg:px-12",children:[o.jsxs("div",{className:"grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10 pb-10 border-b border-border",children:[o.jsxs("div",{className:"lg:col-span-2",children:[o.jsxs("div",{className:"flex items-center gap-2.5 mb-4",children:[o.jsx("img",{src:"/logo.webp",alt:"Servicios APC",className:"h-9 w-auto"}),o.jsx("span",{className:"text-foreground font-semibold text-sm",children:"Servicios APC"})]}),o.jsx("p",{className:"text-sm text-muted-foreground leading-relaxed mb-4",children:"Cámaras de seguridad para negocio y empresas con IA Hikvision. Analítica YOLO, CCTV offline-first, bots WhatsApp 24/7 y SEO local en Bogotá."}),o.jsxs("div",{className:"flex flex-wrap gap-2 text-xs",children:[o.jsxs("a",{href:"https://apcvisionai.site",target:"_blank",rel:"noopener noreferrer",className:"text-accent hover:underline flex items-center gap-1",children:[o.jsx(ga,{size:11})," APC Visión AI — Analítica Hikvision"]}),o.jsx("span",{className:"text-muted-foreground",children:"·"}),o.jsxs("a",{href:"https://apcautomatizacion.site",target:"_blank",rel:"noopener noreferrer",className:"text-accent hover:underline flex items-center gap-1",children:[o.jsx(zi,{size:11})," APC Automatización — n8n + IA"]}),o.jsx("span",{className:"text-muted-foreground",children:"·"}),o.jsxs("a",{href:"https://dogweb.lat",target:"_blank",rel:"noopener noreferrer",className:"text-accent hover:underline flex items-center gap-1",children:[o.jsx(xn,{size:11})," DogWeb — Web + SEO Local"]}),o.jsx("span",{className:"text-muted-foreground",children:"·"}),o.jsxs("a",{href:"https://apccore.site",target:"_blank",rel:"noopener noreferrer",className:"text-accent hover:underline flex items-center gap-1",children:[o.jsx(wi,{size:11})," APC Core — Infraestructura"]})]})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-4",children:"Hikvision + IA"}),o.jsxs("ul",{className:"space-y-2",children:[o.jsx("li",{children:o.jsxs("a",{href:"#servicios",onClick:()=>{const P=Cr.findIndex(W=>W.id==="camaras");ae(P),se("servicios")},className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Analítica YOLO para Hikvision"]})}),o.jsx("li",{children:o.jsxs("a",{href:"#servicios",onClick:()=>{const P=Cr.findIndex(W=>W.id==="cctv");ae(P),se("servicios")},className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Instalación Hikvision IA-ready"]})}),o.jsx("li",{children:o.jsxs("a",{href:"https://apcvisionai.site",target:"_blank",rel:"noopener noreferrer",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Jr,{size:11})," Ver APC Visión AI"]})}),o.jsx("li",{children:o.jsxs("a",{href:"https://www.hikvision.com/es/",target:"_blank",rel:"noopener noreferrer",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Jr,{size:11})," Catálogo oficial Hikvision"]})})]})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-4",children:"Servicios"}),o.jsx("ul",{className:"space-y-2",children:Cr.map(P=>o.jsx("li",{children:o.jsxs("button",{onClick:()=>{const W=Cr.indexOf(P);ae(W),se("servicios")},className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," ",P.title]})},P.id))})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-4",children:"Páginas SEO"}),o.jsxs("ul",{className:"space-y-2",children:[o.jsx("li",{children:o.jsxs("a",{href:"#negocio",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Cámaras para Negocio"]})}),o.jsx("li",{children:o.jsxs("a",{href:"#instalacion",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Instalación de Cámaras"]})}),o.jsx("li",{children:o.jsxs("a",{href:"#casa",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Cámaras para Casa"]})}),o.jsx("li",{children:o.jsxs("a",{href:"#precios-camaras",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Precios Instalación"]})}),o.jsx("li",{children:o.jsxs("a",{href:"#consultor",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Consultor Tecnológico"]})}),[["Suba","suba"],["Kennedy","kennedy"],["Chapinero","chapinero"],["Usaquén","usaquen"],["Fontibón","fontibon"]].map(([P,W])=>o.jsx("li",{children:o.jsxs("a",{href:`#${W}`,className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Cámaras ",P]})},W)),o.jsx("li",{children:o.jsxs("a",{href:"#blog",className:"text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5",children:[o.jsx(Se,{size:12})," Blog"]})})]})]}),o.jsxs("div",{children:[o.jsx("p",{className:"font-mono text-xs text-accent tracking-widest uppercase mb-4",children:"Contacto"}),o.jsxs("ul",{className:"space-y-3",children:[o.jsxs("li",{className:"flex items-start gap-2 text-sm text-muted-foreground",children:[o.jsx(Xd,{size:13,className:"text-accent mt-0.5 flex-shrink-0"}),"Cra. 52c #39b-22, Bogotá"]}),o.jsx("li",{children:o.jsxs("a",{href:"mailto:serviciosapcsoporte@gmail.com",className:"flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors",children:[o.jsx(ir,{size:13,className:"text-accent flex-shrink-0"}),"serviciosapcsoporte@gmail.com"]})}),o.jsx("li",{children:o.jsxs("a",{href:"https://wa.me/573337450634",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors",children:[o.jsx(na,{size:13,className:"text-accent flex-shrink-0"}),"+57 333 7450634"]})}),o.jsx("li",{children:o.jsx("a",{href:"https://search.google.com/local/writereview?placeid=ChIJ3YMe_3yfP44R1bbtdfSOqSQ",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 text-sm text-accent hover:text-foreground transition-colors font-medium",children:"⭐ Dejar reseña en Google"})})]}),o.jsxs("div",{className:"flex items-center gap-3 mt-4",children:[o.jsx("a",{href:"https://www.facebook.com/alejandropiraquiveapc",target:"_blank",rel:"noopener noreferrer","aria-label":"Facebook",className:"w-9 h-9 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors",children:o.jsx(Yd,{size:15})}),o.jsx("a",{href:"https://www.instagram.com/serviciosapc",target:"_blank",rel:"noopener noreferrer","aria-label":"Instagram",className:"w-9 h-9 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors",children:o.jsx(Kd,{size:15})}),o.jsx("a",{href:"https://www.linkedin.com/in/alejandropiraquive/",target:"_blank",rel:"noopener noreferrer","aria-label":"LinkedIn",className:"w-9 h-9 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors",children:o.jsx(Zd,{size:15})})]})]})]}),o.jsxs("div",{className:"mb-8 pb-8 border-b border-border space-y-3",children:[o.jsxs("p",{className:"text-xs text-muted-foreground leading-relaxed",children:[o.jsx("strong",{className:"text-foreground",children:"Aviso de privacidad y tratamiento de datos."})," ","En cumplimiento de la Ley 1581 de 2012 (Habeas Data), Servicios APC declara que todo flujo de video y audio capturado en las sedes de sus clientes tiene como única finalidad la auditoría transaccional de seguridad empresarial, excluyendo la difusión pública de material visual de terceros sin consentimiento."]}),o.jsxs("p",{className:"text-xs text-muted-foreground leading-relaxed",children:[o.jsx("strong",{className:"text-foreground",children:"Términos del servicio."})," ","Los módulos lógicos e integraciones en la nube operan bajo el marco de Arrendamiento de Software e Infraestructura Tecnológica como Servicio (SaaS). El control patrimonial, claves de seguridad y marcas pertenecen exclusivamente a Servicios APC y al titular de la infraestructura."]}),o.jsx("a",{href:"/documentos/Politica_Tratamiento_Datos_serviciosapc.pdf",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-1.5 text-xs text-accent hover:underline mt-1",children:"Descargar Política de Tratamiento de Datos Personales (PDF)"})]}),o.jsxs("div",{className:"flex flex-col md:flex-row items-center justify-between gap-4",children:[o.jsx("p",{className:"text-xs text-muted-foreground font-mono",children:"© 2026 Servicios APC — Todos los derechos reservados"}),o.jsx("p",{className:"text-xs text-muted-foreground font-mono",children:"serviciosapc.site · Bogotá, Colombia"})]})]})}),o.jsxs("div",{className:"fixed bottom-6 right-6 z-50 flex flex-col gap-3",children:[o.jsx("a",{href:"https://www.facebook.com/alejandropiraquiveapc",target:"_blank",rel:"noopener noreferrer","aria-label":"Facebook",className:"w-11 h-11 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors shadow-lg",children:o.jsx(Yd,{size:18})}),o.jsx("a",{href:"https://www.instagram.com/serviciosapc",target:"_blank",rel:"noopener noreferrer","aria-label":"Instagram",className:"w-11 h-11 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors shadow-lg",children:o.jsx(Kd,{size:18})}),o.jsx("a",{href:"https://www.linkedin.com/in/alejandropiraquive/",target:"_blank",rel:"noopener noreferrer","aria-label":"LinkedIn",className:"w-11 h-11 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors shadow-lg",children:o.jsx(Zd,{size:18})}),o.jsx("a",{href:"https://wa.me/573337450634",target:"_blank",rel:"noopener noreferrer","aria-label":"WhatsApp",className:"w-11 h-11 rounded-full bg-[#25d366] text-white flex items-center justify-center hover:bg-[#22c55e] transition-colors shadow-lg",children:o.jsx(Fo,{size:18})})]}),o.jsx(Md,{})]})}zp.createRoot(document.getElementById("root")).render(o.jsx(Kh,{}));
