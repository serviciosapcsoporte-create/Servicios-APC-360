import{p as a,O as h,h as d,j as m,k as p,d as g}from"./index-Bn95QMKq.js";import{k as f}from"./marked.esm-DtWisXwg-DeUS1LF_-PCXSmV45-DeUS1LF_-PCXSmV45-DeUS1LF_-PCXSmV45.js";/**
...
📞 +57 333 745 0634 | ✉️ serviciosapcsoporte@gmail.com  
🌐 [apcvisionai.site](https://apcvisionai.site) · [apcautomatizacion.site](https://apcautomatizacion.site) · [dogweb.lat](https://dogweb.lat) · [apccore.site](https://apccore.site)
`,W={"guia-camaras-hikvision-ia-empresas-bogota-2026":R,"costo-camaras-seguridad-empresas-2026-hardware-vs-ia":O,"que-es-analitica-video-ia-empresas-bogota":T,"5-senales-camaras-no-protegen-empresa-bogota":z,"negocio-camaras-ia-vs-sin-ia-caso-visual-antes-despues":V,"analitica-video-ia-ferreterias-bogota-caso-real-suba":L,"analitica-video-ia-clinicas-bogota-cumplimiento-seguridad":j,"hikvision-colorvu-vs-acusense-vs-deepinview-ia-2026":M,"normativa-videovigilancia-colombia-2026-ley-1581-habeas-data":x,"automatizacion-n8n-cctv-alerta-whatsapp-crm-dashboard":q,"seo-local-google-maps-empresas-seguridad-bogota":N,"servidores-edge-gpu-para-ia-video-analitica-bogota":B,"hikvision-vs-dahua-vs-uniview-comparativa-ia-2026":$,"bot-whatsapp-ia-atencion-clientes-seguridad-bogota":w,"deteccion-ppe-ia-construccion-fabrica-bogota-cumplimiento":G,"cuanto-cuesta-camaras-seguridad-negocio-bogota-2026":H,"mejores-camaras-seguridad-local-comercial-bogota":k,"camaras-seguridad-bodega-bogota-monitoreo-inteligente":U,"instalacion-camaras-seguridad-negocio-pequeno-bogota-guia":F};function Y(e){const n=e.replace(/^\uFEFF/,"").replace(/\r\n/g,`
`),t=n.match(/^---\n([\s\S]*?)\n---/);if(!t)return{fm:{},content:n};const i=t[1],o={};i.split(`
`).forEach(l=>{const r=l.indexOf(":");r>0&&(o[l.slice(0,r).trim()]=l.slice(r+1).trim().replace(/^["']|["']$/g,""))});const c=n.slice(t[0].length).trim();return{fm:o,content:c}}function Q(){const e=new Date;return Object.entries(W).map(([n,t])=>{const{fm:i,content:o}=Y(t),c=i.publishDate||i.date;return c&&new Date(c)>e?null:{slug:n,title:i.title||"Sin título",excerpt:i.excerpt||"",date:i.date||"",publishDate:c,author:i.author||"Servicios APC",category:i.category||"IA & Seguridad",tags:i.tags?i.tags.split(",").map(l=>l.trim()):[],readTime:i.readTime||"5 min",coverImage:i.coverImage,content:f.parse(o),cta:i.cta?JSON.parse(i.cta.replace(/\\"/g,'"')):void 0}}).filter(n=>n!==null).sort((n,t)=>new Date(t.date).getTime()-new Date(n.date).getTime())}const u=e=>{if(!e)return"Reciente";const n=new Date(e);return isNaN(n.getTime())?"Reciente":n.toLocaleDateString("es-ES",{day:"numeric",month:"short",year:"numeric"})};function K({post:e,allPosts:n,onBack:t,onSelect:i}){return a.jsx("div",{className:"min-h-screen",children:a.jsxs("div",{className:"max-w-[728px] mx-auto px-5",children:[a.jsxs("button",{onClick:t,className:"flex items-center gap-1.5 text-sm text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)] transition-colors py-8",children:[a.jsx(S,{size:14}),a.jsx("span",{children:"Volver al blog"})]}),a.jsxs("article",{children:[a.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[a.jsx("span",{className:"text-sm font-medium text-[var(--color-accent)]",children:e.category}),a.jsx("span",{className:"text-[var(--color-border)]",children:"·"}),a.jsx("time",{className:"text-sm text-[var(--color-muted-foreground)]",dateTime:e.date,children:u(e.date)})]}),a.jsx("h1",{className:"font-serif text-[2.5rem] md:text-[3rem] leading-[1.15] font-bold text-[var(--color-foreground)] mb-5",children:e.title}),a.jsx("p",{className:"text-xl text-[var(--color-muted-foreground)] leading-relaxed mb-8",children:e.excerpt}),a.jsxs("div",{className:"flex items-center justify-between py-6 border-t border-b border-[var(--color-border)] mb-10",children:[a.jsxs("div",{className:"flex items-center gap-3",children:[a.jsx("div",{className:"w-10 h-10 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-sm font-bold text-[var(--color-accent)]",children:"SA"}),a.jsxs("div",{children:[a.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:e.author}),a.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[e.readTime," de lectura · ",u(e.date)]})]})]}),a.jsxs("div",{className:"flex items-center gap-3 text-[var(--color-muted-foreground)]",children:[a.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:a.jsx(E,{size:18})}),a.jsx("button",{className:"hover:text-[var(--color-foreground)] transition-colors",children:a.jsx(y,{size:18})})]})]}),e.coverImage&&a.jsx("figure",{className:"mb-10",children:a.jsx(m,{src:e.coverImage,alt:e.title,className:"w-full aspect-[16/9] object-cover",decoding:"async"})}),a.jsx("div",{className:"blog-content max-w-none",dangerouslySetInnerHTML:{__html:e.content}}),a.jsx("div",{className:"flex flex-wrap gap-2 mt-12 mb-8",children:e.tags.map(o=>a.jsx("span",{className:"px-3 py-1.5 text-xs bg-[var(--color-secondary)] text-[var(--color-muted-foreground)] rounded-full",children:o},o))}),e.cta&&a.jsxs("div",{className:"my-12 p-8 bg-[var(--color-secondary)] rounded-2xl",children:[a.jsx("p",{className:"text-xs uppercase tracking-widest text-[var(--color-accent)] font-medium mb-3",children:"¿Necesitas esto para tu empresa?"}),a.jsx("h3",{className:"font-serif text-2xl font-bold text-[var(--color-foreground)] mb-5",children:e.cta.primary.label}),a.jsxs("div",{className:"flex flex-wrap gap-3",children:[a.jsxs("a",{href:e.cta.primary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-[var(--color-accent)] text-white px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity",children:["Solicitar cotización",a.jsx(p,{size:14})]}),e.cta.secondary&&a.jsxs("a",{href:e.cta.secondary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[e.cta.secondary.label,a.jsx(p,{size:14})]}),e.cta.tertiary&&a.jsxs("a",{href:e.cta.tertiary.href,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 border border-[var(--color-border)] text-[var(--color-foreground)] px-6 py-3 rounded-full font-medium text-sm hover:bg-[var(--color-secondary)] transition-colors",children:[e.cta.tertiary.label,a.jsx(p,{size:14})]})]})]}),a.jsxs("div",{className:"border-t border-[var(--color-border)] pt-10 pb-16",children:[a.jsx("h3",{className:"text-sm uppercase tracking-widest text-[var(--color-muted-foreground)] mb-6",children:"Sigue leyendo"}),a.jsx("div",{className:"space-y-8",children:n.filter(o=>o.slug!==e.slug).slice(0,3).map(o=>a.jsxs("button",{onClick:()=>i(o.slug),className:"flex gap-6 text-left group w-full",children:[a.jsxs("div",{className:"flex-1 min-w-0",children:[a.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)] mb-1",children:o.category}),a.jsx("h4",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug mb-1",children:o.title}),a.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] line-clamp-2",children:o.excerpt}),a.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)] mt-2",children:[o.readTime," · ",u(o.date)]})]}),o.coverImage&&a.jsx(m,{src:o.coverImage,alt:o.title,className:"w-[120px] h-[80px] object-cover rounded-lg flex-shrink-0"})]},o.slug))})]})]})]})})}function A(){const e=window.location.hash.slice(1);return e.startsWith("blog/")&&e.slice(5)||null}function Z({initialSlug:e}){const[n,t]=d.useState(e??A()),i=Q(),o=i.find(s=>s.slug===n);d.useEffect(()=>{o&&(document.title=`${o.title} | Servicios APC Bogotá`)},[o]),d.useEffect(()=>{let s=!0;const v=()=>{if(!s)return;const b=A();t(b),b&&window.scrollTo({top:0})};return window.addEventListener("hashchange",v),()=>{s=!1,window.removeEventListener("hashchange",v)}},[]);const c=d.useCallback(s=>{t(s),window.location.hash=`blog/${s}`,window.scrollTo({top:0,behavior:"smooth"})},[]),l=d.useCallback(()=>{t(null),window.location.hash==="#blog"?window.scrollTo({top:0,behavior:"smooth"}):window.location.hash="blog",window.scrollTo({top:0,behavior:"smooth"})},[]);if(o)return a.jsx(K,{post:o,allPosts:i,onBack:l,onSelect:c});const r=i[0],C=i.slice(1);return a.jsxs("div",{className:"min-h-screen",children:[a.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 pt-12 pb-16",children:[a.jsx("p",{className:"text-xs uppercase tracking-[0.2em] text-[var(--color-accent)] font-medium mb-4",children:"Blog · Servicios APC"}),a.jsx("h2",{className:"font-serif text-4xl md:text-5xl font-bold text-[var(--color-foreground)] leading-tight max-w-3xl",children:"Cámaras Hikvision + IA para empresas"}),a.jsx("p",{className:"text-lg text-[var(--color-muted-foreground)] mt-4 max-w-2xl leading-relaxed",children:"Guías técnicas, comparativas y casos reales sobre CCTV con inteligencia artificial, automatización y seguridad empresarial en Bogotá."})]}),r&&a.jsx("div",{className:"max-w-[1200px] mx-auto px-5 mb-16",children:a.jsxs("button",{onClick:()=>c(r.slug),className:"group grid md:grid-cols-[1fr_1fr] gap-8 items-center text-left w-full",children:[r.coverImage&&a.jsx("div",{className:"overflow-hidden rounded-2xl",children:a.jsx(m,{src:r.coverImage,alt:r.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700"})}),a.jsxs("div",{className:"space-y-4 py-4",children:[a.jsx("p",{className:"text-xs uppercase tracking-[0.15em] text-[var(--color-accent)] font-medium",children:"Destacado"}),a.jsx("h3",{className:"font-serif text-3xl md:text-4xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-[1.15]",children:r.title}),a.jsx("p",{className:"text-[var(--color-muted-foreground)] leading-relaxed text-lg",children:r.excerpt}),a.jsxs("div",{className:"flex items-center gap-3 pt-2",children:[a.jsx("div",{className:"w-8 h-8 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-xs font-bold text-[var(--color-accent)]",children:"SA"}),a.jsxs("div",{children:[a.jsx("p",{className:"text-sm font-medium text-[var(--color-foreground)]",children:r.author}),a.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[r.readTime," · ",u(r.date)]})]})]})]})]})}),a.jsx("div",{className:"max-w-[1200px] mx-auto px-5",children:a.jsx("div",{className:"border-t border-[var(--color-border)]"})}),a.jsxs("div",{className:"max-w-[1200px] mx-auto px-5 py-12",children:[a.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12",children:C.map(s=>a.jsxs("button",{onClick:()=>c(s.slug),className:"group text-left",children:[s.coverImage&&a.jsx("div",{className:"overflow-hidden rounded-xl mb-4",children:a.jsx(m,{src:s.coverImage,alt:s.title,className:"w-full aspect-[16/10] object-cover group-hover:scale-[1.02] transition-transform duration-700",loading:"lazy",decoding:"async"})}),a.jsxs("div",{className:"space-y-2.5",children:[a.jsx("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:s.category}),a.jsx("h3",{className:"font-serif text-xl font-bold text-[var(--color-foreground)] group-hover:text-[var(--color-accent)] transition-colors leading-snug",children:s.title}),a.jsx("p",{className:"text-sm text-[var(--color-muted-foreground)] leading-relaxed line-clamp-3",children:s.excerpt}),a.jsxs("div",{className:"flex items-center gap-3 pt-1",children:[a.jsx("div",{className:"w-6 h-6 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-[9px] font-bold text-[var(--color-accent)]",children:"SA"}),a.jsxs("p",{className:"text-xs text-[var(--color-muted-foreground)]",children:[s.readTime," · ",u(s.date)]})]})]})]},s.slug))}),i.length===0&&a.jsx("div",{className:"text-center py-20 text-[var(--color-muted-foreground)]",children:a.jsx("p",{className:"text-lg",children:"Próximamente más artículos..."})})]})]})}function _({slug:e}){return a.jsxs("div",{className:"min-h-screen",style:{color:"var(--color-foreground)"},children:[a.jsx(h,{title:"Blog de Cámaras IA y Automatización",subtitle:"Guías, casos reales y novedades sobre analítica de video con IA, CCTV Hikvision, bots WhatsApp y automatización de procesos para empresas en Bogotá.",ctaLabel:"Ver artículos",onCta:()=>{}}),a.jsx(Z,{initialSlug:e})]})}export{_ as BlogLanding};
